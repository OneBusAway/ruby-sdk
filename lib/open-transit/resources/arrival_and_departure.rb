...
module OpenTransit
  module Resources
    class ArrivalAndDeparture
      ...
      #
      # @param params [OpenTransit::Models::ArrivalAndDepartureRetrieveParams, Hash{Symbol=>Object}] .
      #
      ...
      def retrieve(stop_id, params)
        parsed, options = OpenTransit::Models::ArrivalAndDepartureRetrieveParams.dump_request(params)
        @client.request(
          method: :get,
      ...
      # @param stop_id [String]
      #
      # @param params [OpenTransit::Models::ArrivalAndDepartureListParams, Hash{Symbol=>Object}] .
      #
      ...
      def list(stop_id, params = {})
        parsed, options = OpenTransit::Models::ArrivalAndDepartureListParams.dump_request(params)
        @client.request(
          method: :get,
