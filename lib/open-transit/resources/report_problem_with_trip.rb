...
module OpenTransit
  module Resources
    class ReportProblemWithTrip
      ...
      #
      # @param params [OpenTransit::Models::ReportProblemWithTripRetrieveParams, Hash{Symbol=>Object}] .
      #
      #   @option params [Symbol, OpenTransit::Models::ReportProblemWithTripRetrieveParams::Code] :code A string code identifying the nature of the problem
      #
      ...
      def retrieve(trip_id, params = {})
        parsed, options = OpenTransit::Models::ReportProblemWithTripRetrieveParams.dump_request(params)
        @client.request(
          method: :get,
