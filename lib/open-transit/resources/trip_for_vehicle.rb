...
module OpenTransit
  module Resources
    class TripForVehicle
      ...
      #
      # @param params [OpenTransit::Models::TripForVehicleRetrieveParams, Hash{Symbol=>Object}] .
      #
      ...
      def retrieve(vehicle_id, params = {})
        parsed, options = OpenTransit::Models::TripForVehicleRetrieveParams.dump_request(params)
        @client.request(
          method: :get,
