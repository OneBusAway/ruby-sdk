...
module OpenTransit
  module Models
    class ArrivalAndDepartureRetrieveResponse < OpenTransit::Models::ResponseWrapper
      ...
      # ```ruby
      # data => {
      #   entry: OpenTransit::Models::ArrivalAndDepartureRetrieveResponse::Data::Entry,
      ...
      class Data < OpenTransit::BaseModel
        ...
        class Entry < OpenTransit::BaseModel
          ...
          # @!parse
          #   # @return [OpenTransit::Models::ArrivalAndDepartureRetrieveResponse::Data::Entry::TripStatus]
          ...
          #   # @param status [String]
          #   # @param trip_status [OpenTransit::Models::ArrivalAndDepartureRetrieveResponse::Data::Entry::TripStatus]
          #   #
          #   def initialize(
          #     arrival_enabled:,
          #     block_trip_sequence:,
          ...
          class TripStatus < OpenTransit::BaseModel
            ...
            # @!parse
            #   # @return [OpenTransit::Models::ArrivalAndDepartureRetrieveResponse::Data::Entry::TripStatus::LastKnownLocation]
            ...
            # @!parse
            #   # @return [OpenTransit::Models::ArrivalAndDepartureRetrieveResponse::Data::Entry::TripStatus::Position]
            ...
            #   # @param frequency [String]
            #   # @param last_known_location [OpenTransit::Models::ArrivalAndDepartureRetrieveResponse::Data::Entry::TripStatus::LastKnownLocation]
            #   # @param last_known_orientation [Float]
            #   # @param next_stop [String]
            #   # @param next_stop_time_offset [Integer]
            #   # @param orientation [Float]
            #   # @param position [OpenTransit::Models::ArrivalAndDepartureRetrieveResponse::Data::Entry::TripStatus::Position]
