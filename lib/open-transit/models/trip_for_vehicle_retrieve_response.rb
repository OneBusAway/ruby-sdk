...
module OpenTransit
  module Models
    class TripForVehicleRetrieveResponse < OpenTransit::Models::ResponseWrapper
      # @!attribute data
      #
      #   @return [OpenTransit::Models::TripForVehicleRetrieveResponse::Data]
      required :data, -> { OpenTransit::Models::TripForVehicleRetrieveResponse::Data }

      # @!parse
      #   # @param data [OpenTransit::Models::TripForVehicleRetrieveResponse::Data]
      #   #
      ...
      # ```ruby
      # data => {
      #   entry: OpenTransit::Models::TripForVehicleRetrieveResponse::Data::Entry,
      ...
      class Data < OpenTransit::BaseModel
        # @!attribute entry
        #
        #   @return [OpenTransit::Models::TripForVehicleRetrieveResponse::Data::Entry]
        required :entry, -> { OpenTransit::Models::TripForVehicleRetrieveResponse::Data::Entry }
        ...
        # @!parse
        #   # @param entry [OpenTransit::Models::TripForVehicleRetrieveResponse::Data::Entry]
        ...
        #   trip_id: String,
        #   frequency: String,
        #   schedule: OpenTransit::Models::TripForVehicleRetrieveResponse::Data::Entry::Schedule,
        #   service_date: Integer,
        #   situation_ids: -> { OpenTransit::ArrayOf[String] === _1 }
        # }
        # ```
        class Entry < OpenTransit::BaseModel
          ...
          #
          #   @return [OpenTransit::Models::TripForVehicleRetrieveResponse::Data::Entry::Schedule, nil]
          optional :schedule,
                   -> {
                     OpenTransit::Models::TripForVehicleRetrieveResponse::Data::Entry::Schedule
                   }

          # @!parse
          #   # @return [OpenTransit::Models::TripForVehicleRetrieveResponse::Data::Entry::Schedule]
          ...
          optional :situation_ids, OpenTransit::ArrayOf[String], api_name: :situationIds
          ...
          # @!attribute [r] status
          #
          #   @return [OpenTransit::Models::TripForVehicleRetrieveResponse::Data::Entry::Status, nil]
          optional :status, -> { OpenTransit::Models::TripForVehicleRetrieveResponse::Data::Entry::Status }

          # @!parse
          #   # @return [OpenTransit::Models::TripForVehicleRetrieveResponse::Data::Entry::Status]
          #   attr_writer :status

          # @!parse
          #   # @param trip_id [String]
          #   # @param frequency [String, nil]
          #   # @param schedule [OpenTransit::Models::TripForVehicleRetrieveResponse::Data::Entry::Schedule]
          #   # @param service_date [Integer]
          #   # @param situation_ids [Array<String>]
          #   # @param status [OpenTransit::Models::TripForVehicleRetrieveResponse::Data::Entry::Status]
          #   #
          ...
          #   stop_times: -> { OpenTransit::ArrayOf[OpenTransit::Models::TripForVehicleRetrieveResponse::Data::Entry::Schedule::StopTime] === _1 },
          #   time_zone: String,
          #   frequency: String
          # }
          # ```
          class Schedule < OpenTransit::BaseModel
            ...
            #
            #   @return [Array<OpenTransit::Models::TripForVehicleRetrieveResponse::Data::Entry::Schedule::StopTime>]
            required :stop_times,
                     -> {
                       OpenTransit::ArrayOf[OpenTransit::Models::TripForVehicleRetrieveResponse::Data::Entry::Schedule::StopTime]
                     },
                     api_name: :stopTimes
            ...
            #   # @param stop_times [Array<OpenTransit::Models::TripForVehicleRetrieveResponse::Data::Entry::Schedule::StopTime>]
          ...
          # }
          # ```
          class Status < OpenTransit::BaseModel
            ...
            #
            #   @return [Boolean]
            required :predicted, OpenTransit::BooleanModel
            ...
            #
            #   @return [OpenTransit::Models::TripForVehicleRetrieveResponse::Data::Entry::Status::LastKnownLocation, nil]
            optional :last_known_location,
                     -> {
                       OpenTransit::Models::TripForVehicleRetrieveResponse::Data::Entry::Status::LastKnownLocation
                     },
                     api_name: :lastKnownLocation

            # @!parse
            #   # @return [OpenTransit::Models::TripForVehicleRetrieveResponse::Data::Entry::Status::LastKnownLocation]
            ...
            #
            #   @return [OpenTransit::Models::TripForVehicleRetrieveResponse::Data::Entry::Status::Position, nil]
            optional :position,
                     -> { OpenTransit::Models::TripForVehicleRetrieveResponse::Data::Entry::Status::Position }

            # @!parse
            #   # @return [OpenTransit::Models::TripForVehicleRetrieveResponse::Data::Entry::Status::Position]
            ...
            #   # @param last_known_location [OpenTransit::Models::TripForVehicleRetrieveResponse::Data::Entry::Status::LastKnownLocation]
            #   # @param last_known_orientation [Float]
            #   # @param next_stop [String]
            #   # @param next_stop_time_offset [Integer]
            #   # @param orientation [Float]
            #   # @param position [OpenTransit::Models::TripForVehicleRetrieveResponse::Data::Entry::Status::Position]
            ...
            # }
            # ```
            class LastKnownLocation < OpenTransit::BaseModel
              # @!attribute [r] lat
            ...
            # }
            # ```
            class Position < OpenTransit::BaseModel
              # @!attribute [r] lat
