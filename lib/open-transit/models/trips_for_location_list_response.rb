...
module OpenTransit
  module Models
    class TripsForLocationListResponse < OpenTransit::Models::ResponseWrapper
      # @!attribute data
      #
      #   @return [OpenTransit::Models::TripsForLocationListResponse::Data]
      required :data, -> { OpenTransit::Models::TripsForLocationListResponse::Data }

      # @!parse
      #   # @param data [OpenTransit::Models::TripsForLocationListResponse::Data]
      #   #
      ...
      #   list: -> { OpenTransit::ArrayOf[OpenTransit::Models::TripsForLocationListResponse::Data::List] === _1 },
      ...
      class Data < OpenTransit::BaseModel
        ...
        # @!attribute list
        #
        #   @return [Array<OpenTransit::Models::TripsForLocationListResponse::Data::List>]
        required :list,
                 -> {
                   OpenTransit::ArrayOf[OpenTransit::Models::TripsForLocationListResponse::Data::List]
                 }
        ...
        #
        #   @return [Boolean, nil]
        optional :out_of_range, OpenTransit::BooleanModel, api_name: :outOfRange
        ...
        #   # @param list [Array<OpenTransit::Models::TripsForLocationListResponse::Data::List>]
        ...
        # ```ruby
        # list => {
        #   schedule: OpenTransit::Models::TripsForLocationListResponse::Data::List::Schedule,
        #   status: OpenTransit::Models::TripsForLocationListResponse::Data::List::Status,
        #   trip_id: String,
        #   frequency: String,
        ...
        class List < OpenTransit::BaseModel
          # @!attribute schedule
          #
          #   @return [OpenTransit::Models::TripsForLocationListResponse::Data::List::Schedule]
          required :schedule, -> { OpenTransit::Models::TripsForLocationListResponse::Data::List::Schedule }

          # @!attribute status
          #
          #   @return [OpenTransit::Models::TripsForLocationListResponse::Data::List::Status]
          required :status, -> { OpenTransit::Models::TripsForLocationListResponse::Data::List::Status }
          ...
          # @!parse
          #   # @param schedule [OpenTransit::Models::TripsForLocationListResponse::Data::List::Schedule]
          #   # @param status [OpenTransit::Models::TripsForLocationListResponse::Data::List::Status]
          ...
          #   stop_times: -> { OpenTransit::ArrayOf[OpenTransit::Models::TripsForLocationListResponse::Data::List::Schedule::StopTime] === _1 },
          #   time_zone: String,
          #   frequency: String
          # }
          # ```
          class Schedule < OpenTransit::BaseModel
            ...
            #
            #   @return [Array<OpenTransit::Models::TripsForLocationListResponse::Data::List::Schedule::StopTime>]
            required :stop_times,
                     -> {
                       OpenTransit::ArrayOf[OpenTransit::Models::TripsForLocationListResponse::Data::List::Schedule::StopTime]
                     },
                     api_name: :stopTimes
            ...
            #   # @param stop_times [Array<OpenTransit::Models::TripsForLocationListResponse::Data::List::Schedule::StopTime>]
          ...
          class Status < OpenTransit::BaseModel
            ...
            #
            #   @return [OpenTransit::Models::TripsForLocationListResponse::Data::List::Status::LastKnownLocation, nil]
            optional :last_known_location,
                     -> {
                       OpenTransit::Models::TripsForLocationListResponse::Data::List::Status::LastKnownLocation
                     },
                     api_name: :lastKnownLocation

            # @!parse
            #   # @return [OpenTransit::Models::TripsForLocationListResponse::Data::List::Status::LastKnownLocation]
            ...
            #
            #   @return [OpenTransit::Models::TripsForLocationListResponse::Data::List::Status::Position, nil]
            optional :position,
                     -> {
                       OpenTransit::Models::TripsForLocationListResponse::Data::List::Status::Position
                     }

            # @!parse
            #   # @return [OpenTransit::Models::TripsForLocationListResponse::Data::List::Status::Position]
            ...
            #   # @param last_known_location [OpenTransit::Models::TripsForLocationListResponse::Data::List::Status::LastKnownLocation]
            #   # @param last_known_orientation [Float]
            #   # @param next_stop [String]
            #   # @param next_stop_time_offset [Integer]
            #   # @param orientation [Float]
            #   # @param position [OpenTransit::Models::TripsForLocationListResponse::Data::List::Status::Position]
