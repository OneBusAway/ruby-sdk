    ...
    class TripDetailRetrieveResponse < OpenTransit::Models::ResponseWrapper
      ...
      class Data < OpenTransit::BaseModel
        ...
        class Entry < OpenTransit::BaseModel
          ...
          # @!parse
          #   # @return [OpenTransit::Models::TripDetailRetrieveResponse::Data::Entry::Schedule]
          ...
          # @!parse
          #   # @return [OpenTransit::Models::TripDetailRetrieveResponse::Data::Entry::Status]
          #   attr_writer :status
          ...
          #   stop_times: -> { OpenTransit::ArrayOf[OpenTransit::Models::TripDetailRetrieveResponse::Data::Entry::Schedule::StopTime] === _1 },
          #   time_zone: String,
          #   frequency: String
          # }
          # ```
          class Schedule < OpenTransit::BaseModel
            ...
            required :stop_times,
                     -> {
                       OpenTransit::ArrayOf[OpenTransit::Models::TripDetailRetrieveResponse::Data::Entry::Schedule::StopTime]
                     },
                     api_name: :stopTimes
          ...
          class Status < OpenTransit::BaseModel
            ...
            # @!parse
            #   # @return [OpenTransit::Models::TripDetailRetrieveResponse::Data::Entry::Status::LastKnownLocation]
            ...
            # @!parse
            #   # @return [OpenTransit::Models::TripDetailRetrieveResponse::Data::Entry::Status::Position]
            ...
            #   # @param last_known_location [OpenTransit::Models::TripDetailRetrieveResponse::Data::Entry::Status::LastKnownLocation]
            #   # @param last_known_orientation [Float]
            #   # @param next_stop [String]
            #   # @param next_stop_time_offset [Integer]
            #   # @param orientation [Float]
            #   # @param position [OpenTransit::Models::TripDetailRetrieveResponse::Data::Entry::Status::Position]
