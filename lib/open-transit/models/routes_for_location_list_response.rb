...
module OpenTransit
  module Models
    class RoutesForLocationListResponse < OpenTransit::Models::ResponseWrapper
      # @!attribute data
      #
      #   @return [OpenTransit::Models::RoutesForLocationListResponse::Data]
      required :data, -> { OpenTransit::Models::RoutesForLocationListResponse::Data }

      # @!parse
      #   # @param data [OpenTransit::Models::RoutesForLocationListResponse::Data]
      #   #
      ...
      #   list: -> { OpenTransit::ArrayOf[OpenTransit::Models::RoutesForLocationListResponse::Data::List] === _1 },
      ...
      class Data < OpenTransit::BaseModel
        ...
        # @!attribute list
        #
        #   @return [Array<OpenTransit::Models::RoutesForLocationListResponse::Data::List>]
        required :list,
                 -> { OpenTransit::ArrayOf[OpenTransit::Models::RoutesForLocationListResponse::Data::List] }
        ...
        #   # @param list [Array<OpenTransit::Models::RoutesForLocationListResponse::Data::List>]
