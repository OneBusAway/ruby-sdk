...
module OpenTransit
  module Models
    class VehiclesForAgencyListResponse < OpenTransit::Models::ResponseWrapper
      # @!attribute data
      #
      #   @return [OpenTransit::Models::VehiclesForAgencyListResponse::Data]
      required :data, -> { OpenTransit::Models::VehiclesForAgencyListResponse::Data }

      # @!parse
      #   # @param data [OpenTransit::Models::VehiclesForAgencyListResponse::Data]
      #   #
      ...
      #   list: -> { OpenTransit::ArrayOf[OpenTransit::Models::VehiclesForAgencyListResponse::Data::List] === _1 },
      ...
      class Data < OpenTransit::BaseModel
        ...
        # @!attribute list
        #
        #   @return [Array<OpenTransit::Models::VehiclesForAgencyListResponse::Data::List>]
        required :list,
                 -> { OpenTransit::ArrayOf[OpenTransit::Models::VehiclesForAgencyListResponse::Data::List] }
        ...
        #   # @param list [Array<OpenTransit::Models::VehiclesForAgencyListResponse::Data::List>]
        ...
        #   location: OpenTransit::Models::VehiclesForAgencyListResponse::Data::List::Location,
        #   trip_id: String,
        #   trip_status: OpenTransit::Models::VehiclesForAgencyListResponse::Data::List::TripStatus,
        #   **_
        # }
        # ```
        class List < OpenTransit::BaseModel
          ...
          # @!attribute location
          #
          #   @return [OpenTransit::Models::VehiclesForAgencyListResponse::Data::List::Location]
          required :location, -> { OpenTransit::Models::VehiclesForAgencyListResponse::Data::List::Location }
          ...
          #
          #   @return [OpenTransit::Models::VehiclesForAgencyListResponse::Data::List::TripStatus]
          required :trip_status,
                   -> { OpenTransit::Models::VehiclesForAgencyListResponse::Data::List::TripStatus },
                   api_name: :tripStatus
          ...
          #   # @param location [OpenTransit::Models::VehiclesForAgencyListResponse::Data::List::Location]
          #   # @param trip_id [String]
          #   # @param trip_status [OpenTransit::Models::VehiclesForAgencyListResponse::Data::List::TripStatus]
          ...
          # }
          # ```
          class Location < OpenTransit::BaseModel
            # @!attribute [r] lat
            #
            #   @return [Float, nil]
            optional :lat, Float
          ...
          class TripStatus < OpenTransit::BaseModel
            ...
            #
            #   @return [OpenTransit::Models::VehiclesForAgencyListResponse::Data::List::TripStatus::LastKnownLocation, nil]
            optional :last_known_location,
                     -> {
                       OpenTransit::Models::VehiclesForAgencyListResponse::Data::List::TripStatus::LastKnownLocation
                     },
                     api_name: :lastKnownLocation

            # @!parse
            #   # @return [OpenTransit::Models::VehiclesForAgencyListResponse::Data::List::TripStatus::LastKnownLocation]
            ...
            #
            #   @return [OpenTransit::Models::VehiclesForAgencyListResponse::Data::List::TripStatus::Position, nil]
            optional :position,
                     -> { OpenTransit::Models::VehiclesForAgencyListResponse::Data::List::TripStatus::Position }

            # @!parse
            #   # @return [OpenTransit::Models::VehiclesForAgencyListResponse::Data::List::TripStatus::Position]
            ...
            #   # @param last_known_location [OpenTransit::Models::VehiclesForAgencyListResponse::Data::List::TripStatus::LastKnownLocation]
            #   # @param last_known_orientation [Float]
            #   # @param next_stop [String]
            #   # @param next_stop_time_offset [Integer]
            #   # @param orientation [Float]
            #   # @param position [OpenTransit::Models::VehiclesForAgencyListResponse::Data::List::TripStatus::Position]
