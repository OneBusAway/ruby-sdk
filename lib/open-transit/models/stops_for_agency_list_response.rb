...
module OpenTransit
  module Models
    class StopsForAgencyListResponse < OpenTransit::Models::ResponseWrapper
      ...
      # @!attribute list
      #
      #   @return [Array<OpenTransit::Models::StopsForAgencyListResponse::List>]
      required :list, -> { OpenTransit::ArrayOf[OpenTransit::Models::StopsForAgencyListResponse::List] }
      ...
      #   # @param list [Array<OpenTransit::Models::StopsForAgencyListResponse::List>]
