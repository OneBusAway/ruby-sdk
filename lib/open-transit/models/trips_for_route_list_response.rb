...
module OpenTransit
  module Models
    class TripsForRouteListResponse < OpenTransit::Models::ResponseWrapper
      # @!attribute data
      #
      #   @return [OpenTransit::Models::TripsForRouteListResponse::Data]
      required :data, -> { OpenTransit::Models::TripsForRouteListResponse::Data }

      # @!parse
      #   # @param data [OpenTransit::Models::TripsForRouteListResponse::Data]
      #   #
      ...
      #   list: -> { OpenTransit::ArrayOf[OpenTransit::Models::TripsForRouteListResponse::Data::List] === _1 },
      ...
      class Data < OpenTransit::BaseModel
        ...
        # @!attribute list
        #
        #   @return [Array<OpenTransit::Models::TripsForRouteListResponse::Data::List>]
        required :list,
                 -> {
                   OpenTransit::ArrayOf[OpenTransit::Models::TripsForRouteListResponse::Data::List]
                 }
        ...
        #   # @param list [Array<OpenTransit::Models::TripsForRouteListResponse::Data::List>]
        ...
        # ```ruby
        # list => {
        #   schedule: OpenTransit::Models::TripsForRouteListResponse::Data::List::Schedule,
        #   status: OpenTransit::Models::TripsForRouteListResponse::Data::List::Status,
        #   trip_id: String,
        #   frequency: String,
        ...
        class List < OpenTransit::BaseModel
          # @!attribute schedule
          #
          #   @return [OpenTransit::Models::TripsForRouteListResponse::Data::List::Schedule]
          required :schedule, -> { OpenTransit::Models::TripsForRouteListResponse::Data::List::Schedule }

          # @!attribute status
          #
          #   @return [OpenTransit::Models::TripsForRouteListResponse::Data::List::Status]
          required :status, -> { OpenTransit::Models::TripsForRouteListResponse::Data::List::Status }
          ...
          # @!parse
          #   # @param schedule [OpenTransit::Models::TripsForRouteListResponse::Data::List::Schedule]
          #   # @param status [OpenTransit::Models::TripsForRouteListResponse::Data::List::Status]
          ...
          #   stop_times: -> { OpenTransit::ArrayOf[OpenTransit::Models::TripsForRouteListResponse::Data::List::Schedule::StopTime] === _1 },
          #   time_zone: String,
          #   frequency: String
          # }
          # ```
          class Schedule < OpenTransit::BaseModel
            ...
            #
            #   @return [Array<OpenTransit::Models::TripsForRouteListResponse::Data::List::Schedule::StopTime>]
            required :stop_times,
                     -> {
                       OpenTransit::ArrayOf[OpenTransit::Models::TripsForRouteListResponse::Data::List::Schedule::StopTime]
                     },
                     api_name: :stopTimes
            ...
            #   # @param stop_times [Array<OpenTransit::Models::TripsForRouteListResponse::Data::List::Schedule::StopTime>]
          ...
          class Status < OpenTransit::BaseModel
            ...
            #
            #   @return [OpenTransit::Models::TripsForRouteListResponse::Data::List::Status::LastKnownLocation, nil]
            optional :last_known_location,
                     -> {
                       OpenTransit::Models::TripsForRouteListResponse::Data::List::Status::LastKnownLocation
                     },
                     api_name: :lastKnownLocation

            # @!parse
            #   # @return [OpenTransit::Models::TripsForRouteListResponse::Data::List::Status::LastKnownLocation]
            ...
            #
            #   @return [OpenTransit::Models::TripsForRouteListResponse::Data::List::Status::Position, nil]
            optional :position,
                     -> {
                       OpenTransit::Models::TripsForRouteListResponse::Data::List::Status::Position
                     }

            # @!parse
            #   # @return [OpenTransit::Models::TripsForRouteListResponse::Data::List::Status::Position]
            ...
            #   # @param last_known_location [OpenTransit::Models::TripsForRouteListResponse::Data::List::Status::LastKnownLocation]
            #   # @param last_known_orientation [Float]
            #   # @param next_stop [String]
            #   # @param next_stop_time_offset [Integer]
            #   # @param orientation [Float]
            #   # @param position [OpenTransit::Models::TripsForRouteListResponse::Data::List::Status::Position]
