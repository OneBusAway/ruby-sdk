...
module OpenTransit
  module Models
    class ReportProblemWithTripRetrieveParams < OpenTransit::BaseModel
      # @!parse
      ...
      #
      #   @return [Symbol, OpenTransit::Models::ReportProblemWithTripRetrieveParams::Code, nil]
      optional :code, enum: -> { OpenTransit::Models::ReportProblemWithTripRetrieveParams::Code }

      # @!parse
      #   # @return [Symbol, OpenTransit::Models::ReportProblemWithTripRetrieveParams::Code]
      #   attr_writer :code
      ...
      #
      #   @return [Boolean, nil]
      optional :user_on_vehicle, OpenTransit::BooleanModel, api_name: :userOnVehicle
      ...
      # @!parse
      #   # @param code [Symbol, OpenTransit::Models::ReportProblemWithTripRetrieveParams::Code]
