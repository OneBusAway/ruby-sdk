  ...
  module Models
    class ArrivalAndDepartureListResponse < OpenTransit::Models::ResponseWrapper
      ...
      class Data < OpenTransit::BaseModel
        ...
        # ```ruby
        # entry => {
        #   arrivals_and_departures: -> { OpenTransit::ArrayOf[OpenTransit::Models::ArrivalAndDepartureListResponse::Data::Entry::ArrivalsAndDeparture] === _1 }
        # }
        # ```
        class Entry < OpenTransit::BaseModel
          ...
          required :arrivals_and_departures,
                   -> {
                     OpenTransit::ArrayOf[OpenTransit::Models::ArrivalAndDepartureListResponse::Data::Entry::ArrivalsAndDeparture]
                   },
          ...
          # }
          # ```
          class ArrivalsAndDeparture < OpenTransit::BaseModel
            ...
            #
            #   @return [Boolean, nil]
            optional :predicted, OpenTransit::BooleanModel
            ...
            # @!parse
            #   # @return [OpenTransit::Models::ArrivalAndDepartureListResponse::Data::Entry::ArrivalsAndDeparture::TripStatus]
            ...
            #   # @param status [String]
            #   # @param trip_status [OpenTransit::Models::ArrivalAndDepartureListResponse::Data::Entry::ArrivalsAndDeparture::TripStatus]
            #   #
            #   def initialize(
            #     arrival_enabled:,
            #     block_trip_sequence:,
            ...
            # }
            # ```
            class TripStatus < OpenTransit::BaseModel
              ...
              # @!parse
              #   # @return [OpenTransit::Models::ArrivalAndDepartureListResponse::Data::Entry::ArrivalsAndDeparture::TripStatus::LastKnownLocation]
              ...
              # @!parse
              #   # @return [OpenTransit::Models::ArrivalAndDepartureListResponse::Data::Entry::ArrivalsAndDeparture::TripStatus::Position]
              ...
              #   # @param frequency [String]
              #   # @param last_known_location [OpenTransit::Models::ArrivalAndDepartureListResponse::Data::Entry::ArrivalsAndDeparture::TripStatus::LastKnownLocation]
              #   # @param last_known_orientation [Float]
              #   # @param next_stop [String]
              #   # @param next_stop_time_offset [Integer]
              #   # @param orientation [Float]
              #   # @param position [OpenTransit::Models::ArrivalAndDepartureListResponse::Data::Entry::ArrivalsAndDeparture::TripStatus::Position]
