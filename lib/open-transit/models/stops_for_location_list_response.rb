...
module OpenTransit
  module Models
    class StopsForLocationListResponse < OpenTransit::Models::ResponseWrapper
      ...
      #   list: -> { OpenTransit::ArrayOf[OpenTransit::Models::StopsForLocationListResponse::Data::List] === _1 },
      ...
      class Data < OpenTransit::BaseModel
        ...
        required :list,
                 -> {
                   OpenTransit::ArrayOf[OpenTransit::Models::StopsForLocationListResponse::Data::List]
                 }
