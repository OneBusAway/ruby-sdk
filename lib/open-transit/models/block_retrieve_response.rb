  ...
  module Models
    class BlockRetrieveResponse < OpenTransit::Models::ResponseWrapper
      ...
      class Data < OpenTransit::BaseModel
        ...
        # entry => {
        #   id: String,
        #   configurations: -> { OpenTransit::ArrayOf[OpenTransit::Models::BlockRetrieveResponse::Data::Entry::Configuration] === _1 }
        # }
        # ```
        class Entry < OpenTransit::BaseModel
          ...
          required :configurations,
                   -> {
                     OpenTransit::ArrayOf[OpenTransit::Models::BlockRetrieveResponse::Data::Entry::Configuration]
                   }
          ...
          # ```ruby
          # configuration => {
          #   active_service_ids: -> { OpenTransit::ArrayOf[String] === _1 },
          #   trips: -> { OpenTransit::ArrayOf[OpenTransit::Models::BlockRetrieveResponse::Data::Entry::Configuration::Trip] === _1 },
          #   inactive_service_ids: -> { OpenTransit::ArrayOf[String] === _1 }
          # }
          # ```
          class Configuration < OpenTransit::BaseModel
            ...
            #
            #   @return [Array<String>]
            required :active_service_ids, OpenTransit::ArrayOf[String], api_name: :activeServiceIds
            ...
            required :trips,
                     -> {
                       OpenTransit::ArrayOf[OpenTransit::Models::BlockRetrieveResponse::Data::Entry::Configuration::Trip]
                     }

            # @!attribute [r] inactive_service_ids
            #
            #   @return [Array<String>, nil]
            optional :inactive_service_ids, OpenTransit::ArrayOf[String], api_name: :inactiveServiceIds
            ...
            #   block_stop_times: -> { OpenTransit::ArrayOf[OpenTransit::Models::BlockRetrieveResponse::Data::Entry::Configuration::Trip::BlockStopTime] === _1 },
            ...
            class Trip < OpenTransit::BaseModel
              ...
              required :block_stop_times,
                       -> {
                         OpenTransit::ArrayOf[OpenTransit::Models::BlockRetrieveResponse::Data::Entry::Configuration::Trip::BlockStopTime]
                       },
