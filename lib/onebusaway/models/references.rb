...
module Onebusaway
  module Models
    ...
    # ```ruby
    # references => {
    #   agencies: -> { Onebusaway::ArrayOf[Onebusaway::Models::References::Agency] === _1 },
    #   routes: -> { Onebusaway::ArrayOf[Onebusaway::Models::References::Route] === _1 },
    #   situations: -> { Onebusaway::ArrayOf[Onebusaway::Models::References::Situation] === _1 },
    #   stops: -> { Onebusaway::ArrayOf[Onebusaway::Models::References::Stop] === _1 },
    #   stop_times: -> { Onebusaway::ArrayOf[Onebusaway::Models::References::StopTime] === _1 }
    # }
    # ```
    class References < Onebusaway::BaseModel
      # @!attribute agencies
      #
      #   @return [Array<Onebusaway::Models::References::Agency>]
      required :agencies, -> { Onebusaway::ArrayOf[Onebusaway::Models::References::Agency] }

      # @!attribute routes
      #
      #   @return [Array<Onebusaway::Models::References::Route>]
      required :routes, -> { Onebusaway::ArrayOf[Onebusaway::Models::References::Route] }

      # @!attribute situations
      #
      #   @return [Array<Onebusaway::Models::References::Situation>]
      required :situations, -> { Onebusaway::ArrayOf[Onebusaway::Models::References::Situation] }

      # @!attribute stops
      #
      #   @return [Array<Onebusaway::Models::References::Stop>]
      required :stops, -> { Onebusaway::ArrayOf[Onebusaway::Models::References::Stop] }

      # @!attribute stop_times
      #
      #   @return [Array<Onebusaway::Models::References::StopTime>]
      required :stop_times,
               -> { Onebusaway::ArrayOf[Onebusaway::Models::References::StopTime] },
               api_name: :stopTimes

      # @!attribute trips
      #
      #   @return [Array<Onebusaway::Models::References::Trip>]
      required :trips, -> { Onebusaway::ArrayOf[Onebusaway::Models::References::Trip] }

      # @!parse
      #   # @param agencies [Array<Onebusaway::Models::References::Agency>]
      #   # @param routes [Array<Onebusaway::Models::References::Route>]
      #   # @param situations [Array<Onebusaway::Models::References::Situation>]
      #   # @param stops [Array<Onebusaway::Models::References::Stop>]
      #   # @param stop_times [Array<Onebusaway::Models::References::StopTime>]
      #   # @param trips [Array<Onebusaway::Models::References::Trip>]
      #   #
      ...
      #   active_windows: -> { Onebusaway::ArrayOf[Onebusaway::Models::References::Situation::ActiveWindow] === _1 },
      #   all_affects: -> { Onebusaway::ArrayOf[Onebusaway::Models::References::Situation::AllAffect] === _1 },
      ...
      class Situation < Onebusaway::BaseModel
        ...
        #
        #   @return [Array<Onebusaway::Models::References::Situation::ActiveWindow>, nil]
        optional :active_windows,
                 -> { Onebusaway::ArrayOf[Onebusaway::Models::References::Situation::ActiveWindow] },
                 api_name: :activeWindows

        # @!parse
        #   # @return [Array<Onebusaway::Models::References::Situation::ActiveWindow>]
        #   attr_writer :active_windows

        # @!attribute [r] all_affects
        #
        #   @return [Array<Onebusaway::Models::References::Situation::AllAffect>, nil]
        optional :all_affects,
                 -> { Onebusaway::ArrayOf[Onebusaway::Models::References::Situation::AllAffect] },
                 api_name: :allAffects

        # @!parse
        #   # @return [Array<Onebusaway::Models::References::Situation::AllAffect>]
        ...
        #
        #   @return [Array<Onebusaway::Models::References::Situation::Consequence>, nil]
        optional :consequences,
                 -> {
                   Onebusaway::ArrayOf[Onebusaway::Models::References::Situation::Consequence]
                 }

        # @!parse
        #   # @return [Array<Onebusaway::Models::References::Situation::Consequence>]
        #   attr_writer :consequences

        # @!attribute [r] description
        #
        #   @return [Onebusaway::Models::References::Situation::Description, nil]
        optional :description, -> { Onebusaway::Models::References::Situation::Description }

        # @!parse
        #   # @return [Onebusaway::Models::References::Situation::Description]
        #   attr_writer :description

        # @!attribute [r] publication_windows
        #
        #   @return [Array<Onebusaway::Models::References::Situation::PublicationWindow>, nil]
        optional :publication_windows,
                 -> { Onebusaway::ArrayOf[Onebusaway::Models::References::Situation::PublicationWindow] },
                 api_name: :publicationWindows

        # @!parse
        #   # @return [Array<Onebusaway::Models::References::Situation::PublicationWindow>]
        #   attr_writer :publication_windows

        # @!attribute [r] reason
        #   Reason for the service alert, taken from TPEG codes.
        #
        #   @return [Symbol, Onebusaway::Models::References::Situation::Reason, nil]
        optional :reason, enum: -> { Onebusaway::Models::References::Situation::Reason }

        # @!parse
        #   # @return [Symbol, Onebusaway::Models::References::Situation::Reason]
        #   attr_writer :reason
        ...
        # @!attribute [r] summary
        #
        #   @return [Onebusaway::Models::References::Situation::Summary, nil]
        optional :summary, -> { Onebusaway::Models::References::Situation::Summary }

        # @!parse
        #   # @return [Onebusaway::Models::References::Situation::Summary]
        #   attr_writer :summary

        # @!attribute [r] url
        #
        #   @return [Onebusaway::Models::References::Situation::URL, nil]
        optional :url, -> { Onebusaway::Models::References::Situation::URL }

        # @!parse
        #   # @return [Onebusaway::Models::References::Situation::URL]
        #   attr_writer :url

        # @!parse
        #   # @param id [String]
        #   # @param creation_time [Integer]
        #   # @param active_windows [Array<Onebusaway::Models::References::Situation::ActiveWindow>]
        #   # @param all_affects [Array<Onebusaway::Models::References::Situation::AllAffect>]
        #   # @param consequence_message [String]
        #   # @param consequences [Array<Onebusaway::Models::References::Situation::Consequence>]
        #   # @param description [Onebusaway::Models::References::Situation::Description]
        #   # @param publication_windows [Array<Onebusaway::Models::References::Situation::PublicationWindow>]
        #   # @param reason [Symbol, Onebusaway::Models::References::Situation::Reason]
        #   # @param severity [String]
        #   # @param summary [Onebusaway::Models::References::Situation::Summary]
        #   # @param url [Onebusaway::Models::References::Situation::URL]
        #   #
        #   def initialize(
        #     id:,
        #     creation_time:,
        ...
        class Consequence < Onebusaway::BaseModel
          ...
          #
          #   @return [Onebusaway::Models::References::Situation::Consequence::ConditionDetails, nil]
          optional :condition_details,
                   -> { Onebusaway::Models::References::Situation::Consequence::ConditionDetails },
                   api_name: :conditionDetails

          # @!parse
          #   # @return [Onebusaway::Models::References::Situation::Consequence::ConditionDetails]
          #   attr_writer :condition_details

          # @!parse
          #   # @param condition [String]
          #   # @param condition_details [Onebusaway::Models::References::Situation::Consequence::ConditionDetails]
          #   #
          ...
          #   diversion_stop_ids: -> { Onebusaway::ArrayOf[String] === _1 }
          # }
          # ```
          class ConditionDetails < Onebusaway::BaseModel
            # @!attribute [r] diversion_path
            #
            #   @return [Onebusaway::Models::References::Situation::Consequence::ConditionDetails::DiversionPath, nil]
            ...
            # @!parse
            #   # @return [Onebusaway::Models::References::Situation::Consequence::ConditionDetails::DiversionPath]
            #   attr_writer :diversion_path

            # @!attribute [r] diversion_stop_ids
            #
            #   @return [Array<String>, nil]
            optional :diversion_stop_ids, Onebusaway::ArrayOf[String], api_name: :diversionStopIds
            ...
            # @!parse
            #   # @param diversion_path [Onebusaway::Models::References::Situation::Consequence::ConditionDetails::DiversionPath]
