...
module Onebusaway
  module Models
    class RoutesForLocationListResponse < Onebusaway::Models::ResponseWrapper
      # @!attribute data
      #
      #   @return [Onebusaway::Models::RoutesForLocationListResponse::Data]
      required :data, -> { Onebusaway::Models::RoutesForLocationListResponse::Data }

      # @!parse
      #   # @param data [Onebusaway::Models::RoutesForLocationListResponse::Data]
      #   #
      ...
      #   list: -> { Onebusaway::ArrayOf[Onebusaway::Models::RoutesForLocationListResponse::Data::List] === _1 },
      ...
      class Data < Onebusaway::BaseModel
        ...
        # @!attribute list
        #
        #   @return [Array<Onebusaway::Models::RoutesForLocationListResponse::Data::List>]
        required :list,
                 -> {
                   Onebusaway::ArrayOf[Onebusaway::Models::RoutesForLocationListResponse::Data::List]
                 }
        ...
        #   # @param list [Array<Onebusaway::Models::RoutesForLocationListResponse::Data::List>]
