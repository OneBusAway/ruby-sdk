...
module Onebusaway
  module Models
    class TripForVehicleRetrieveResponse < Onebusaway::Models::ResponseWrapper
      # @!attribute data
      #
      #   @return [Onebusaway::Models::TripForVehicleRetrieveResponse::Data]
      required :data, -> { Onebusaway::Models::TripForVehicleRetrieveResponse::Data }

      # @!parse
      #   # @param data [Onebusaway::Models::TripForVehicleRetrieveResponse::Data]
      #   #
      ...
      # ```ruby
      # data => {
      #   entry: Onebusaway::Models::TripForVehicleRetrieveResponse::Data::Entry,
      ...
      class Data < Onebusaway::BaseModel
        # @!attribute entry
        #
        #   @return [Onebusaway::Models::TripForVehicleRetrieveResponse::Data::Entry]
        required :entry, -> { Onebusaway::Models::TripForVehicleRetrieveResponse::Data::Entry }
        ...
        # @!parse
        #   # @param entry [Onebusaway::Models::TripForVehicleRetrieveResponse::Data::Entry]
        ...
        #   trip_id: String,
        #   frequency: String,
        #   schedule: Onebusaway::Models::TripForVehicleRetrieveResponse::Data::Entry::Schedule,
        #   service_date: Integer,
        #   situation_ids: -> { Onebusaway::ArrayOf[String] === _1 }
        # }
        # ```
        class Entry < Onebusaway::BaseModel
          ...
          #
          #   @return [Onebusaway::Models::TripForVehicleRetrieveResponse::Data::Entry::Schedule, nil]
          optional :schedule, -> { Onebusaway::Models::TripForVehicleRetrieveResponse::Data::Entry::Schedule }

          # @!parse
          #   # @return [Onebusaway::Models::TripForVehicleRetrieveResponse::Data::Entry::Schedule]
          ...
          # @!attribute [r] status
          #
          #   @return [Onebusaway::Models::TripForVehicleRetrieveResponse::Data::Entry::Status, nil]
          optional :status, -> { Onebusaway::Models::TripForVehicleRetrieveResponse::Data::Entry::Status }

          # @!parse
          #   # @return [Onebusaway::Models::TripForVehicleRetrieveResponse::Data::Entry::Status]
          #   attr_writer :status

          # @!parse
          #   # @param trip_id [String]
          #   # @param frequency [String, nil]
          #   # @param schedule [Onebusaway::Models::TripForVehicleRetrieveResponse::Data::Entry::Schedule]
          #   # @param service_date [Integer]
          #   # @param situation_ids [Array<String>]
          #   # @param status [Onebusaway::Models::TripForVehicleRetrieveResponse::Data::Entry::Status]
          #   #
          ...
          #   stop_times: -> { Onebusaway::ArrayOf[Onebusaway::Models::TripForVehicleRetrieveResponse::Data::Entry::Schedule::StopTime] === _1 },
          #   time_zone: String,
          #   frequency: String
          # }
          # ```
          class Schedule < Onebusaway::BaseModel
            ...
            #
            #   @return [Array<Onebusaway::Models::TripForVehicleRetrieveResponse::Data::Entry::Schedule::StopTime>]
            required :stop_times,
                     -> {
                       Onebusaway::ArrayOf[Onebusaway::Models::TripForVehicleRetrieveResponse::Data::Entry::Schedule::StopTime]
                     },
                     api_name: :stopTimes
            ...
            #   # @param stop_times [Array<Onebusaway::Models::TripForVehicleRetrieveResponse::Data::Entry::Schedule::StopTime>]
          ...
          class Status < Onebusaway::BaseModel
            ...
            #
            #   @return [Onebusaway::Models::TripForVehicleRetrieveResponse::Data::Entry::Status::LastKnownLocation, nil]
            optional :last_known_location,
                     -> {
                       Onebusaway::Models::TripForVehicleRetrieveResponse::Data::Entry::Status::LastKnownLocation
                     },
                     api_name: :lastKnownLocation

            # @!parse
            #   # @return [Onebusaway::Models::TripForVehicleRetrieveResponse::Data::Entry::Status::LastKnownLocation]
            ...
            #
            #   @return [Onebusaway::Models::TripForVehicleRetrieveResponse::Data::Entry::Status::Position, nil]
            optional :position,
                     -> { Onebusaway::Models::TripForVehicleRetrieveResponse::Data::Entry::Status::Position }

            # @!parse
            #   # @return [Onebusaway::Models::TripForVehicleRetrieveResponse::Data::Entry::Status::Position]
            ...
            #   # @param last_known_location [Onebusaway::Models::TripForVehicleRetrieveResponse::Data::Entry::Status::LastKnownLocation]
            #   # @param last_known_orientation [Float]
            #   # @param next_stop [String]
            #   # @param next_stop_time_offset [Integer]
            #   # @param orientation [Float]
            #   # @param position [Onebusaway::Models::TripForVehicleRetrieveResponse::Data::Entry::Status::Position]
