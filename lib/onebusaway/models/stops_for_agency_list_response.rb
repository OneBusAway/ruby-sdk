...
module Onebusaway
  module Models
    class StopsForAgencyListResponse < Onebusaway::Models::ResponseWrapper
      ...
      # @!attribute list
      #
      #   @return [Array<Onebusaway::Models::StopsForAgencyListResponse::List>]
      required :list, -> { Onebusaway::ArrayOf[Onebusaway::Models::StopsForAgencyListResponse::List] }
      ...
      #   # @param list [Array<Onebusaway::Models::StopsForAgencyListResponse::List>]
