...
module Onebusaway
  module Models
    class TripDetailRetrieveResponse < Onebusaway::Models::ResponseWrapper
      # @!attribute data
      #
      #   @return [Onebusaway::Models::TripDetailRetrieveResponse::Data]
      required :data, -> { Onebusaway::Models::TripDetailRetrieveResponse::Data }

      # @!parse
      #   # @param data [Onebusaway::Models::TripDetailRetrieveResponse::Data]
      #   #
      ...
      # ```ruby
      # data => {
      #   entry: Onebusaway::Models::TripDetailRetrieveResponse::Data::Entry,
      ...
      class Data < Onebusaway::BaseModel
        # @!attribute entry
        #
        #   @return [Onebusaway::Models::TripDetailRetrieveResponse::Data::Entry]
        required :entry, -> { Onebusaway::Models::TripDetailRetrieveResponse::Data::Entry }
        ...
        # @!parse
        #   # @param entry [Onebusaway::Models::TripDetailRetrieveResponse::Data::Entry]
        ...
        #   trip_id: String,
        #   frequency: String,
        #   schedule: Onebusaway::Models::TripDetailRetrieveResponse::Data::Entry::Schedule,
        ...
        class Entry < Onebusaway::BaseModel
          ...
          #
          #   @return [Onebusaway::Models::TripDetailRetrieveResponse::Data::Entry::Schedule, nil]
          optional :schedule, -> { Onebusaway::Models::TripDetailRetrieveResponse::Data::Entry::Schedule }

          # @!parse
          #   # @return [Onebusaway::Models::TripDetailRetrieveResponse::Data::Entry::Schedule]
          ...
          # @!attribute [r] status
          #
          #   @return [Onebusaway::Models::TripDetailRetrieveResponse::Data::Entry::Status, nil]
          optional :status, -> { Onebusaway::Models::TripDetailRetrieveResponse::Data::Entry::Status }

          # @!parse
          #   # @return [Onebusaway::Models::TripDetailRetrieveResponse::Data::Entry::Status]
          #   attr_writer :status

          # @!parse
          #   # @param trip_id [String]
          #   # @param frequency [String, nil]
          #   # @param schedule [Onebusaway::Models::TripDetailRetrieveResponse::Data::Entry::Schedule]
          #   # @param service_date [Integer]
          #   # @param situation_ids [Array<String>]
          #   # @param status [Onebusaway::Models::TripDetailRetrieveResponse::Data::Entry::Status]
          #   #
          ...
          #   stop_times: -> { Onebusaway::ArrayOf[Onebusaway::Models::TripDetailRetrieveResponse::Data::Entry::Schedule::StopTime] === _1 },
          #   time_zone: String,
          #   frequency: String
          # }
          # ```
          class Schedule < Onebusaway::BaseModel
            ...
            #
            #   @return [Array<Onebusaway::Models::TripDetailRetrieveResponse::Data::Entry::Schedule::StopTime>]
            required :stop_times,
                     -> {
                       Onebusaway::ArrayOf[Onebusaway::Models::TripDetailRetrieveResponse::Data::Entry::Schedule::StopTime]
                     },
                     api_name: :stopTimes
            ...
            #   # @param stop_times [Array<Onebusaway::Models::TripDetailRetrieveResponse::Data::Entry::Schedule::StopTime>]
          ...
          class Status < Onebusaway::BaseModel
            ...
            #
            #   @return [Onebusaway::Models::TripDetailRetrieveResponse::Data::Entry::Status::LastKnownLocation, nil]
            optional :last_known_location,
                     -> {
                       Onebusaway::Models::TripDetailRetrieveResponse::Data::Entry::Status::LastKnownLocation
                     },
                     api_name: :lastKnownLocation

            # @!parse
            #   # @return [Onebusaway::Models::TripDetailRetrieveResponse::Data::Entry::Status::LastKnownLocation]
            ...
            #
            #   @return [Onebusaway::Models::TripDetailRetrieveResponse::Data::Entry::Status::Position, nil]
            optional :position,
                     -> {
                       Onebusaway::Models::TripDetailRetrieveResponse::Data::Entry::Status::Position
                     }

            # @!parse
            #   # @return [Onebusaway::Models::TripDetailRetrieveResponse::Data::Entry::Status::Position]
            ...
            #   # @param last_known_location [Onebusaway::Models::TripDetailRetrieveResponse::Data::Entry::Status::LastKnownLocation]
            #   # @param last_known_orientation [Float]
            #   # @param next_stop [String]
            #   # @param next_stop_time_offset [Integer]
            #   # @param orientation [Float]
            #   # @param position [Onebusaway::Models::TripDetailRetrieveResponse::Data::Entry::Status::Position]
