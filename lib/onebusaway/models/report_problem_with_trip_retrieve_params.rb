...
module Onebusaway
  module Models
    class ReportProblemWithTripRetrieveParams < Onebusaway::BaseModel
      # @!parse
      ...
      #
      #   @return [Symbol, Onebusaway::Models::ReportProblemWithTripRetrieveParams::Code, nil]
      optional :code, enum: -> { Onebusaway::Models::ReportProblemWithTripRetrieveParams::Code }

      # @!parse
      #   # @return [Symbol, Onebusaway::Models::ReportProblemWithTripRetrieveParams::Code]
      #   attr_writer :code
      ...
      #
      #   @return [Boolean, nil]
      optional :user_on_vehicle, Onebusaway::BooleanModel, api_name: :userOnVehicle
      ...
      # @!parse
      #   # @param code [Symbol, Onebusaway::Models::ReportProblemWithTripRetrieveParams::Code]
