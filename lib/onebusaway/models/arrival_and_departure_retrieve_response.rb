...
module Onebusaway
  module Models
    class ArrivalAndDepartureRetrieveResponse < Onebusaway::Models::ResponseWrapper
      # @!attribute data
      #
      #   @return [Onebusaway::Models::ArrivalAndDepartureRetrieveResponse::Data]
      required :data, -> { Onebusaway::Models::ArrivalAndDepartureRetrieveResponse::Data }

      # @!parse
      #   # @param data [Onebusaway::Models::ArrivalAndDepartureRetrieveResponse::Data]
      #   #
      ...
      # ```ruby
      # data => {
      #   entry: Onebusaway::Models::ArrivalAndDepartureRetrieveResponse::Data::Entry,
      ...
      class Data < Onebusaway::BaseModel
        # @!attribute entry
        #
        #   @return [Onebusaway::Models::ArrivalAndDepartureRetrieveResponse::Data::Entry]
        required :entry, -> { Onebusaway::Models::ArrivalAndDepartureRetrieveResponse::Data::Entry }
        ...
        # @!parse
        #   # @param entry [Onebusaway::Models::ArrivalAndDepartureRetrieveResponse::Data::Entry]
        ...
        class Entry < Onebusaway::BaseModel
          ...
          #
          #   @return [Onebusaway::Models::ArrivalAndDepartureRetrieveResponse::Data::Entry::TripStatus, nil]
          optional :trip_status,
                   -> { Onebusaway::Models::ArrivalAndDepartureRetrieveResponse::Data::Entry::TripStatus },
                   api_name: :tripStatus

          # @!parse
          #   # @return [Onebusaway::Models::ArrivalAndDepartureRetrieveResponse::Data::Entry::TripStatus]
          ...
          #   # @param status [String]
          #   # @param trip_status [Onebusaway::Models::ArrivalAndDepartureRetrieveResponse::Data::Entry::TripStatus]
          #   #
          #   def initialize(
          #     arrival_enabled:,
          #     block_trip_sequence:,
          ...
          class TripStatus < Onebusaway::BaseModel
            ...
            #
            #   @return [Onebusaway::Models::ArrivalAndDepartureRetrieveResponse::Data::Entry::TripStatus::LastKnownLocation, nil]
            optional :last_known_location,
                     -> {
                       Onebusaway::Models::ArrivalAndDepartureRetrieveResponse::Data::Entry::TripStatus::LastKnownLocation
                     },
                     api_name: :lastKnownLocation

            # @!parse
            #   # @return [Onebusaway::Models::ArrivalAndDepartureRetrieveResponse::Data::Entry::TripStatus::LastKnownLocation]
            ...
            #
            #   @return [Onebusaway::Models::ArrivalAndDepartureRetrieveResponse::Data::Entry::TripStatus::Position, nil]
            optional :position,
                     -> { Onebusaway::Models::ArrivalAndDepartureRetrieveResponse::Data::Entry::TripStatus::Position }

            # @!parse
            #   # @return [Onebusaway::Models::ArrivalAndDepartureRetrieveResponse::Data::Entry::TripStatus::Position]
            ...
            #   # @param frequency [String]
            #   # @param last_known_location [Onebusaway::Models::ArrivalAndDepartureRetrieveResponse::Data::Entry::TripStatus::LastKnownLocation]
            #   # @param last_known_orientation [Float]
            #   # @param next_stop [String]
            #   # @param next_stop_time_offset [Integer]
            #   # @param orientation [Float]
            #   # @param position [Onebusaway::Models::ArrivalAndDepartureRetrieveResponse::Data::Entry::TripStatus::Position]
