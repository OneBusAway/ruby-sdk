...
module Onebusaway
  module Models
    class ArrivalAndDepartureListResponse < Onebusaway::Models::ResponseWrapper
      # @!attribute data
      #
      #   @return [Onebusaway::Models::ArrivalAndDepartureListResponse::Data]
      required :data, -> { Onebusaway::Models::ArrivalAndDepartureListResponse::Data }

      # @!parse
      #   # @param data [Onebusaway::Models::ArrivalAndDepartureListResponse::Data]
      #   #
      ...
      # ```ruby
      # data => {
      #   entry: Onebusaway::Models::ArrivalAndDepartureListResponse::Data::Entry,
      ...
      class Data < Onebusaway::BaseModel
        # @!attribute entry
        #
        #   @return [Onebusaway::Models::ArrivalAndDepartureListResponse::Data::Entry]
        required :entry, -> { Onebusaway::Models::ArrivalAndDepartureListResponse::Data::Entry }
        ...
        # @!parse
        #   # @param entry [Onebusaway::Models::ArrivalAndDepartureListResponse::Data::Entry]
        ...
        # ```ruby
        # entry => {
        #   arrivals_and_departures: -> { Onebusaway::ArrayOf[Onebusaway::Models::ArrivalAndDepartureListResponse::Data::Entry::ArrivalsAndDeparture] === _1 }
        # }
        # ```
        class Entry < Onebusaway::BaseModel
          # @!attribute arrivals_and_departures
          #
          #   @return [Array<Onebusaway::Models::ArrivalAndDepartureListResponse::Data::Entry::ArrivalsAndDeparture>]
          required :arrivals_and_departures,
                   -> {
                     Onebusaway::ArrayOf[Onebusaway::Models::ArrivalAndDepartureListResponse::Data::Entry::ArrivalsAndDeparture]
                   },
                   api_name: :arrivalsAndDepartures

          # @!parse
          #   # @param arrivals_and_departures [Array<Onebusaway::Models::ArrivalAndDepartureListResponse::Data::Entry::ArrivalsAndDeparture>]
          #   #
          ...
          # }
          # ```
          class ArrivalsAndDeparture < Onebusaway::BaseModel
            ...
            #
            #   @return [Boolean, nil]
            optional :predicted, Onebusaway::BooleanModel
            ...
            optional :situation_ids, Onebusaway::ArrayOf[String], api_name: :situationIds
            ...
            #
            #   @return [Onebusaway::Models::ArrivalAndDepartureListResponse::Data::Entry::ArrivalsAndDeparture::TripStatus, nil]
            optional :trip_status,
                     -> {
                       Onebusaway::Models::ArrivalAndDepartureListResponse::Data::Entry::ArrivalsAndDeparture::TripStatus
                     },
                     api_name: :tripStatus

            # @!parse
            #   # @return [Onebusaway::Models::ArrivalAndDepartureListResponse::Data::Entry::ArrivalsAndDeparture::TripStatus]
            ...
            #   # @param status [String]
            #   # @param trip_status [Onebusaway::Models::ArrivalAndDepartureListResponse::Data::Entry::ArrivalsAndDeparture::TripStatus]
            #   #
            #   def initialize(
            #     arrival_enabled:,
            #     block_trip_sequence:,
            ...
            class TripStatus < Onebusaway::BaseModel
              ...
              #
              #   @return [Boolean]
              required :predicted, Onebusaway::BooleanModel
              ...
              #
              #   @return [Onebusaway::Models::ArrivalAndDepartureListResponse::Data::Entry::ArrivalsAndDeparture::TripStatus::LastKnownLocation, nil]
              optional :last_known_location,
                       -> {
                         Onebusaway::Models::ArrivalAndDepartureListResponse::Data::Entry::ArrivalsAndDeparture::TripStatus::LastKnownLocation
                       },
                       api_name: :lastKnownLocation

              # @!parse
              #   # @return [Onebusaway::Models::ArrivalAndDepartureListResponse::Data::Entry::ArrivalsAndDeparture::TripStatus::LastKnownLocation]
              ...
              #
              #   @return [Onebusaway::Models::ArrivalAndDepartureListResponse::Data::Entry::ArrivalsAndDeparture::TripStatus::Position, nil]
              optional :position,
                       -> { Onebusaway::Models::ArrivalAndDepartureListResponse::Data::Entry::ArrivalsAndDeparture::TripStatus::Position }

              # @!parse
              #   # @return [Onebusaway::Models::ArrivalAndDepartureListResponse::Data::Entry::ArrivalsAndDeparture::TripStatus::Position]
              ...
              #   # @param frequency [String]
              #   # @param last_known_location [Onebusaway::Models::ArrivalAndDepartureListResponse::Data::Entry::ArrivalsAndDeparture::TripStatus::LastKnownLocation]
              #   # @param last_known_orientation [Float]
              #   # @param next_stop [String]
              #   # @param next_stop_time_offset [Integer]
              #   # @param orientation [Float]
              #   # @param position [Onebusaway::Models::ArrivalAndDepartureListResponse::Data::Entry::ArrivalsAndDeparture::TripStatus::Position]
