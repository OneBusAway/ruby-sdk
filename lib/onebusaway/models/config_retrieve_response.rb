...
module Onebusaway
  module Models
    class ConfigRetrieveResponse < Onebusaway::Models::ResponseWrapper
      # @!attribute data
      #
      #   @return [Onebusaway::Models::ConfigRetrieveResponse::Data]
      required :data, -> { Onebusaway::Models::ConfigRetrieveResponse::Data }

      # @!parse
      #   # @param data [Onebusaway::Models::ConfigRetrieveResponse::Data]
      #   #
      ...
      # ```ruby
      # data => {
      #   entry: Onebusaway::Models::ConfigRetrieveResponse::Data::Entry,
      ...
      class Data < Onebusaway::BaseModel
        # @!attribute entry
        #
        #   @return [Onebusaway::Models::ConfigRetrieveResponse::Data::Entry]
        required :entry, -> { Onebusaway::Models::ConfigRetrieveResponse::Data::Entry }
        ...
        # @!parse
        #   # @param entry [Onebusaway::Models::ConfigRetrieveResponse::Data::Entry]
        ...
        # entry => {
        #   id: String,
        #   git_properties: Onebusaway::Models::ConfigRetrieveResponse::Data::Entry::GitProperties,
        #   name: String,
        ...
        class Entry < Onebusaway::BaseModel
          ...
          #
          #   @return [Onebusaway::Models::ConfigRetrieveResponse::Data::Entry::GitProperties, nil]
          optional :git_properties,
                   -> { Onebusaway::Models::ConfigRetrieveResponse::Data::Entry::GitProperties },
                   api_name: :gitProperties

          # @!parse
          #   # @return [Onebusaway::Models::ConfigRetrieveResponse::Data::Entry::GitProperties]
          ...
          # @!parse
          #   # @param id [String]
          #   # @param git_properties [Onebusaway::Models::ConfigRetrieveResponse::Data::Entry::GitProperties]
          #   # @param name [String]
          ...
          # }
          # ```
          class GitProperties < Onebusaway::BaseModel
