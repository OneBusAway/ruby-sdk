...
module Onebusaway
  module Models
    class TripsForLocationListResponse < Onebusaway::Models::ResponseWrapper
      # @!attribute data
      #
      #   @return [Onebusaway::Models::TripsForLocationListResponse::Data]
      required :data, -> { Onebusaway::Models::TripsForLocationListResponse::Data }

      # @!parse
      #   # @param data [Onebusaway::Models::TripsForLocationListResponse::Data]
      #   #
      ...
      #   list: -> { Onebusaway::ArrayOf[Onebusaway::Models::TripsForLocationListResponse::Data::List] === _1 },
      ...
      class Data < Onebusaway::BaseModel
        ...
        # @!attribute list
        #
        #   @return [Array<Onebusaway::Models::TripsForLocationListResponse::Data::List>]
        required :list,
                 -> {
                   Onebusaway::ArrayOf[Onebusaway::Models::TripsForLocationListResponse::Data::List]
                 }
        ...
        #   # @param list [Array<Onebusaway::Models::TripsForLocationListResponse::Data::List>]
        ...
        class List < Onebusaway::BaseModel
          # @!attribute schedule
          #
          #   @return [Onebusaway::Models::TripsForLocationListResponse::Data::List::Schedule]
          required :schedule, -> { Onebusaway::Models::TripsForLocationListResponse::Data::List::Schedule }

          # @!attribute status
          #
          #   @return [Onebusaway::Models::TripsForLocationListResponse::Data::List::Status]
          required :status, -> { Onebusaway::Models::TripsForLocationListResponse::Data::List::Status }
          ...
          # @!parse
          #   # @param schedule [Onebusaway::Models::TripsForLocationListResponse::Data::List::Schedule]
          #   # @param status [Onebusaway::Models::TripsForLocationListResponse::Data::List::Status]
          ...
          #   stop_times: -> { Onebusaway::ArrayOf[Onebusaway::Models::TripsForLocationListResponse::Data::List::Schedule::StopTime] === _1 },
          #   time_zone: String,
          #   frequency: String
          # }
          # ```
          class Schedule < Onebusaway::BaseModel
            ...
            #
            #   @return [Array<Onebusaway::Models::TripsForLocationListResponse::Data::List::Schedule::StopTime>]
            required :stop_times,
                     -> {
                       Onebusaway::ArrayOf[Onebusaway::Models::TripsForLocationListResponse::Data::List::Schedule::StopTime]
                     },
                     api_name: :stopTimes
            ...
            #   # @param stop_times [Array<Onebusaway::Models::TripsForLocationListResponse::Data::List::Schedule::StopTime>]
          ...
          class Status < Onebusaway::BaseModel
            ...
            #
            #   @return [Onebusaway::Models::TripsForLocationListResponse::Data::List::Status::LastKnownLocation, nil]
            optional :last_known_location,
                     -> {
                       Onebusaway::Models::TripsForLocationListResponse::Data::List::Status::LastKnownLocation
                     },
                     api_name: :lastKnownLocation

            # @!parse
            #   # @return [Onebusaway::Models::TripsForLocationListResponse::Data::List::Status::LastKnownLocation]
            ...
            #
            #   @return [Onebusaway::Models::TripsForLocationListResponse::Data::List::Status::Position, nil]
            optional :position,
                     -> {
                       Onebusaway::Models::TripsForLocationListResponse::Data::List::Status::Position
                     }

            # @!parse
            #   # @return [Onebusaway::Models::TripsForLocationListResponse::Data::List::Status::Position]
            ...
            #   # @param last_known_location [Onebusaway::Models::TripsForLocationListResponse::Data::List::Status::LastKnownLocation]
            #   # @param last_known_orientation [Float]
            #   # @param next_stop [String]
            #   # @param next_stop_time_offset [Integer]
            #   # @param orientation [Float]
            #   # @param position [Onebusaway::Models::TripsForLocationListResponse::Data::List::Status::Position]
