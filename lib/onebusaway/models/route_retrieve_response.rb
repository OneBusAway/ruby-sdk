...
module Onebusaway
  module Models
    class RouteRetrieveResponse < Onebusaway::Models::ResponseWrapper
      # @!attribute data
      #
      #   @return [Onebusaway::Models::RouteRetrieveResponse::Data]
      required :data, -> { Onebusaway::Models::RouteRetrieveResponse::Data }

      # @!parse
      #   # @param data [Onebusaway::Models::RouteRetrieveResponse::Data]
      #   #
      ...
      # ```ruby
      # data => {
      #   entry: Onebusaway::Models::RouteRetrieveResponse::Data::Entry,
      ...
      class Data < Onebusaway::BaseModel
        # @!attribute entry
        #
        #   @return [Onebusaway::Models::RouteRetrieveResponse::Data::Entry]
        required :entry, -> { Onebusaway::Models::RouteRetrieveResponse::Data::Entry }
        ...
        # @!parse
        #   # @param entry [Onebusaway::Models::RouteRetrieveResponse::Data::Entry]
