...
module Onebusaway
  module Models
    class ReportProblemWithStopRetrieveParams < Onebusaway::BaseModel
      # @!parse
      ...
      #
      #   @return [Symbol, Onebusaway::Models::ReportProblemWithStopRetrieveParams::Code, nil]
      optional :code, enum: -> { Onebusaway::Models::ReportProblemWithStopRetrieveParams::Code }

      # @!parse
      #   # @return [Symbol, Onebusaway::Models::ReportProblemWithStopRetrieveParams::Code]
      #   attr_writer :code
      ...
      # @!parse
      #   # @param code [Symbol, Onebusaway::Models::ReportProblemWithStopRetrieveParams::Code]
