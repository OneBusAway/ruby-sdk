...
module Onebusaway
  module Models
    class VehiclesForAgencyListResponse < Onebusaway::Models::ResponseWrapper
      # @!attribute data
      #
      #   @return [Onebusaway::Models::VehiclesForAgencyListResponse::Data]
      required :data, -> { Onebusaway::Models::VehiclesForAgencyListResponse::Data }

      # @!parse
      #   # @param data [Onebusaway::Models::VehiclesForAgencyListResponse::Data]
      #   #
      ...
      #   list: -> { Onebusaway::ArrayOf[Onebusaway::Models::VehiclesForAgencyListResponse::Data::List] === _1 },
      ...
      class Data < Onebusaway::BaseModel
        ...
        # @!attribute list
        #
        #   @return [Array<Onebusaway::Models::VehiclesForAgencyListResponse::Data::List>]
        required :list,
                 -> {
                   Onebusaway::ArrayOf[Onebusaway::Models::VehiclesForAgencyListResponse::Data::List]
                 }
        ...
        #   # @param list [Array<Onebusaway::Models::VehiclesForAgencyListResponse::Data::List>]
        ...
        class List < Onebusaway::BaseModel
          ...
          # @!attribute location
          #
          #   @return [Onebusaway::Models::VehiclesForAgencyListResponse::Data::List::Location]
          required :location, -> { Onebusaway::Models::VehiclesForAgencyListResponse::Data::List::Location }
          ...
          #
          #   @return [Onebusaway::Models::VehiclesForAgencyListResponse::Data::List::TripStatus]
          required :trip_status,
                   -> { Onebusaway::Models::VehiclesForAgencyListResponse::Data::List::TripStatus },
                   api_name: :tripStatus
          ...
          #   # @param location [Onebusaway::Models::VehiclesForAgencyListResponse::Data::List::Location]
          #   # @param trip_id [String]
          #   # @param trip_status [Onebusaway::Models::VehiclesForAgencyListResponse::Data::List::TripStatus]
          ...
          class TripStatus < Onebusaway::BaseModel
            ...
            #
            #   @return [Onebusaway::Models::VehiclesForAgencyListResponse::Data::List::TripStatus::LastKnownLocation, nil]
            optional :last_known_location,
                     -> {
                       Onebusaway::Models::VehiclesForAgencyListResponse::Data::List::TripStatus::LastKnownLocation
                     },
                     api_name: :lastKnownLocation

            # @!parse
            #   # @return [Onebusaway::Models::VehiclesForAgencyListResponse::Data::List::TripStatus::LastKnownLocation]
            ...
            #
            #   @return [Onebusaway::Models::VehiclesForAgencyListResponse::Data::List::TripStatus::Position, nil]
            optional :position,
                     -> { Onebusaway::Models::VehiclesForAgencyListResponse::Data::List::TripStatus::Position }

            # @!parse
            #   # @return [Onebusaway::Models::VehiclesForAgencyListResponse::Data::List::TripStatus::Position]
            ...
            #   # @param last_known_location [Onebusaway::Models::VehiclesForAgencyListResponse::Data::List::TripStatus::LastKnownLocation]
            #   # @param last_known_orientation [Float]
            #   # @param next_stop [String]
            #   # @param next_stop_time_offset [Integer]
            #   # @param orientation [Float]
            #   # @param position [Onebusaway::Models::VehiclesForAgencyListResponse::Data::List::TripStatus::Position]
