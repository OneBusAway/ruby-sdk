...
module Onebusaway
  module Models
    class TripForVehicleRetrieveParams < Onebusaway::BaseModel
      # @!parse
      ...
      #
      #   @return [Boolean, nil]
      optional :include_schedule, Onebusaway::BooleanModel, api_name: :includeSchedule
      ...
      #
      #   @return [Boolean, nil]
      optional :include_status, Onebusaway::BooleanModel, api_name: :includeStatus
      ...
      #
      #   @return [Boolean, nil]
      optional :include_trip, Onebusaway::BooleanModel, api_name: :includeTrip
