...
module Onebusaway
  module Models
    class SearchForRouteListResponse < Onebusaway::Models::ResponseWrapper
      # @!attribute [r] data
      #
      #   @return [Onebusaway::Models::SearchForRouteListResponse::Data, nil]
      optional :data, -> { Onebusaway::Models::SearchForRouteListResponse::Data }

      # @!parse
      #   # @return [Onebusaway::Models::SearchForRouteListResponse::Data]
      #   attr_writer :data

      # @!parse
      #   # @param data [Onebusaway::Models::SearchForRouteListResponse::Data]
      #   #
      ...
      #   list: -> { Onebusaway::ArrayOf[Onebusaway::Models::SearchForRouteListResponse::Data::List] === _1 },
      ...
      class Data < Onebusaway::BaseModel
        ...
        # @!attribute list
        #
        #   @return [Array<Onebusaway::Models::SearchForRouteListResponse::Data::List>]
        required :list, -> { Onebusaway::ArrayOf[Onebusaway::Models::SearchForRouteListResponse::Data::List] }
        ...
        #   # @param list [Array<Onebusaway::Models::SearchForRouteListResponse::Data::List>]
