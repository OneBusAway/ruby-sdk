...
module Onebusaway
  ...
  module Converter
    ...
    class << self
      # @private
      #
      # @param spec [Hash{Symbol=>Object}, Proc, Onebusaway::Converter, Class] .
      #
      ...
      def type_info(spec)
        ...
        in Proc
          spec
        in Onebusaway::Converter | Class
          -> { spec }
        in true | false
          -> { Onebusaway::BooleanModel }
      ...
      #
      # @param target [Onebusaway::Converter, Class]
      # @param value [Object]
      #
      # @return [Object]
      #
      ...
      def try_strict_coerce(target, value)
        ...
        in Class
          ...
          in [-> { _1 <= Date || _1 <= Time }, String]
            Onebusaway::Util.suppress(ArgumentError, Date::Error) do
  ...
  class Unknown
    ...
    # @return [Boolean]
    #
    def self.==(other) = other.is_a?(Class) && other <= Onebusaway::Unknown
  ...
  class BooleanModel
    ...
    # @return [Boolean]
    #
    def self.==(other) = other.is_a?(Class) && other <= Onebusaway::BooleanModel
  ...
  class Enum
    ...
    #
    def self.==(other)
      other.is_a?(Class) && other <= Onebusaway::Enum && other.values.to_set == values.to_set
    end
  ...
  class Union
    ...
    # @private
    #
    # @param key [Symbol, Hash{Symbol=>Object}, Proc, Onebusaway::Converter, Class]
    #
    # @param spec [Hash{Symbol=>Object}, Proc, Onebusaway::Converter, Class] .
    #
    #   @option spec [NilClass, TrueClass, FalseClass, Integer, Float, Symbol] :const
    ...
    private_class_method def self.variant(key, spec = nil)
      variant_info =
        case key
        in Symbol
          [key, Onebusaway::Converter.type_info(spec)]
        in Proc | Onebusaway::Converter | Class | Hash
          [nil, Onebusaway::Converter.type_info(key)]
        end
    ...
    # @param value [Object]
    #
    # @return [Onebusaway::Converter, Class, nil]
    #
    private_class_method def self.resolve_variant(value)
      case [@discriminator, value]
      in [_, Onebusaway::BaseModel]
        value.class
      in [Symbol, Hash]
        key =
        ...
        resolved.nil? ? Onebusaway::Unknown : resolved.call
      else
        nil
      end
    end
    ...
    #
    def self.==(other)
      other.is_a?(Class) && other <= Onebusaway::Union && other.variants == variants
    end
    ...
    def self.coerce(value)
      if (variant = resolve_variant(value))
        return Onebusaway::Converter.coerce(variant, value)
      end
      ...
      known_variants.each do |_, variant_fn|
        ...
        case Onebusaway::Converter.try_strict_coerce(variant, value)
        in [true, coerced, _]
          return coerced
        in [false, true, score]
      ...
      variant.nil? ? value : Onebusaway::Converter.coerce(variant, value)
    end
    ...
    def self.dump(value)
      if (variant = resolve_variant(value))
        return Onebusaway::Converter.dump(variant, value)
      end
  ...
  class ArrayOf
    ...
    # @return [Boolean]
    #
    def ==(other) = other.is_a?(Onebusaway::ArrayOf) && other.item_type == item_type
    ...
    def coerce(value)
      ...
      in Enumerable unless value.is_a?(Hash)
        value.map { |item| Onebusaway::Converter.coerce(type, item) }
      else
        value
      end
    end
    ...
    def dump(value)
      ...
      case value
      in Enumerable unless value.is_a?(Hash)
        value.map { |item| Onebusaway::Converter.dump(type, item) }.to_a
      else
        value
      end
    end
    ...
    def try_strict_coerce(value)
      ...
      in Array
        ...
        mapped =
          value.map do |item|
            case Onebusaway::Converter.try_strict_coerce(type, item)
            in [true, coerced, score]
              tally += score
              coerced
            in [false, true, score]
    ...
    # @private
    #
    # @return [Onebusaway::Converter, Class]
    #
    protected def item_type = @item_type_fn.call

    # @private
    #
    # @param type_info [Hash{Symbol=>Object}, Proc, Onebusaway::Converter, Class]
    #
    ...
    def initialize(type_info, spec = {})
      @item_type_fn = Onebusaway::Converter.type_info(type_info || spec)
    end
  end
  ...
  class HashOf
    ...
    # @return [Boolean]
    #
    def ==(other) = other.is_a?(Onebusaway::HashOf) && other.item_type == item_type
    ...
    def coerce(value)
      ...
      in Hash
        value.to_h do |key, val|
          coerced = Onebusaway::Converter.coerce(type, val)
    ...
    def dump(value)
      ...
      in Hash
        value.transform_values do |val|
          Onebusaway::Converter.dump(type, val)
        end
      else
        value
      end
    ...
    def try_strict_coerce(value)
      ...
      in Hash
        ...
        mapped =
          value.transform_values do |val|
            case Onebusaway::Converter.try_strict_coerce(type, val)
            in [true, coerced, score]
              tally += score
              coerced
            in [false, true, score]
  ...
  class BaseModel
    ...
    def self.known_fields
      @known_fields ||= (self < Onebusaway::BaseModel ? superclass.known_fields.dup : {})
    end
    ...
    private_class_method def self.add_field(name_sym, required:, type_info:, spec:)
      type_fn, info =
        case type_info
        in Proc | Class | Onebusaway::Converter
          [Onebusaway::Converter.type_info({**spec, union: type_info}), spec]
        in Hash
          [Onebusaway::Converter.type_info(type_info), type_info]
        end
      ...
      define_method(name_sym) do
        ...
        Onebusaway::Converter.coerce(field_type, value)
      rescue StandardError
        name = self.class.name.split("::").last
        raise Onebusaway::ConversionError.new(
    ...
    # @private
    #
    # @param value [Onebusaway::BaseModel, Hash{Object=>Object}, Object]
    #
    # @return [Onebusaway::BaseModel, Object]
    #
    def self.coerce(value)
      case (coerced = Onebusaway::Util.coerce_hash(value))
      in Hash
        new(coerced)
      else
        value
    ...
    # @private
    #
    # @param value [Onebusaway::BaseModel, Object]
    #
    # @return [Hash{Object=>Object}, Object]
    #
    def self.dump(value)
      unless (coerced = Onebusaway::Util.coerce_hash(value)).is_a?(Hash)
        return value
      end
      ...
      values = coerced.filter_map do |key, val|
        ...
        in nil
          ...
          in :coerce
            ...
            target = type_fn.call
            [api_name, Onebusaway::Converter.dump(target, val)]
          end
        end
      end.to_h
    ...
    def self.try_strict_coerce(value)
      ...
      known_fields.each_value do |field|
        ...
        in [_, true]
          ...
          case Onebusaway::Converter.try_strict_coerce(target, item)
          in [true, coerced, score]
            tally += score
    ...
    #
    # @param data [Hash{Symbol=>Object}, Onebusaway::BaseModel]
    #
    def initialize(data = {})
      case (coerced = Onebusaway::Util.coerce_hash(data))
      in Hash
        @data = coerced.transform_keys(&:to_sym)
      else
        raise ArgumentError.new("Expected a #{Hash} or #{Onebusaway::BaseModel}, got #{data.inspect}")
      end
    end
