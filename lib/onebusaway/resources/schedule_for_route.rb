...
module Onebusaway
  module Resources
    class ScheduleForRoute
      ...
      #
      # @param params [Onebusaway::Models::ScheduleForRouteRetrieveParams, Hash{Symbol=>Object}] .
      #
      ...
      #
      # @return [Onebusaway::Models::ScheduleForRouteRetrieveResponse]
      #
      def retrieve(route_id, params = {})
        parsed, options = Onebusaway::Models::ScheduleForRouteRetrieveParams.dump_request(params)
        @client.request(
          method: :get,
          path: ["api/where/schedule-for-route/%0s.json", route_id],
          query: parsed,
          model: Onebusaway::Models::ScheduleForRouteRetrieveResponse,
          options: options
        )
      end
