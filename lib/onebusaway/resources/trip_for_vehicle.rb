...
module Onebusaway
  module Resources
    class TripForVehicle
      ...
      #
      # @param params [Onebusaway::Models::TripForVehicleRetrieveParams, Hash{Symbol=>Object}] .
      #
      ...
      #
      # @return [Onebusaway::Models::TripForVehicleRetrieveResponse]
      #
      def retrieve(vehicle_id, params = {})
        parsed, options = Onebusaway::Models::TripForVehicleRetrieveParams.dump_request(params)
        @client.request(
          method: :get,
          path: ["api/where/trip-for-vehicle/%0s.json", vehicle_id],
          query: parsed,
          model: Onebusaway::Models::TripForVehicleRetrieveResponse,
          options: options
        )
      end
