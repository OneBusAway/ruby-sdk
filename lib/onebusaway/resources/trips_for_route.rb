...
module Onebusaway
  module Resources
    class TripsForRoute
      ...
      #
      # @param params [Onebusaway::Models::TripsForRouteListParams, Hash{Symbol=>Object}] .
      #
      ...
      #
      # @return [Onebusaway::Models::TripsForRouteListResponse]
      #
      def list(route_id, params = {})
        parsed, options = Onebusaway::Models::TripsForRouteListParams.dump_request(params)
        @client.request(
          method: :get,
          path: ["api/where/trips-for-route/%0s.json", route_id],
          query: parsed,
          model: Onebusaway::Models::TripsForRouteListResponse,
          options: options
        )
      end
