...
module Onebusaway
  module Resources
    class RoutesForLocation
      # routes-for-location
      #
      # @param params [Onebusaway::Models::RoutesForLocationListParams, Hash{Symbol=>Object}] .
      #
      ...
      #
      # @return [Onebusaway::Models::RoutesForLocationListResponse]
      #
      def list(params)
        parsed, options = Onebusaway::Models::RoutesForLocationListParams.dump_request(params)
        @client.request(
          method: :get,
          path: "api/where/routes-for-location.json",
          query: parsed,
          model: Onebusaway::Models::RoutesForLocationListResponse,
          options: options
        )
      end
