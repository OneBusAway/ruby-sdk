...
module Onebusaway
  module Resources
    class StopsForRoute
      ...
      #
      # @param params [Onebusaway::Models::StopsForRouteListParams, Hash{Symbol=>Object}] .
      #
      ...
      #
      # @return [Onebusaway::Models::StopsForRouteListResponse]
      #
      def list(route_id, params = {})
        parsed, options = Onebusaway::Models::StopsForRouteListParams.dump_request(params)
        @client.request(
          method: :get,
          path: ["api/where/stops-for-route/%0s.json", route_id],
          query: parsed,
          model: Onebusaway::Models::StopsForRouteListResponse,
          options: options
        )
      end
