...
module Onebusaway
  module Resources
    class ReportProblemWithTrip
      ...
      #
      # @param params [Onebusaway::Models::ReportProblemWithTripRetrieveParams, Hash{Symbol=>Object}] .
      #
      #   @option params [Symbol, Onebusaway::Models::ReportProblemWithTripRetrieveParams::Code] :code A string code identifying the nature of the problem
      #
      ...
      def retrieve(trip_id, params = {})
        parsed, options = Onebusaway::Models::ReportProblemWithTripRetrieveParams.dump_request(params)
        @client.request(
          method: :get,
