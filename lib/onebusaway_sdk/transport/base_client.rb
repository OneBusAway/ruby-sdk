...
module OnebusawaySDK
  module Transport
    ...
    class BaseClient
      ...
      # @api private
      # @return [OnebusawaySDK::Transport::PooledNetRequester]
      ...
      def initialize(
        ...
        @requester = OnebusawaySDK::Transport::PooledNetRequester.new
      ...
      #
      #   @option req [OnebusawaySDK::Type::Converter, Class, nil] :model
      #
      ...
      def request(req)
        ...
        in { page: Class => page }
          ...
          OnebusawaySDK::Type::Converter.coerce(model, unwrapped)
        end
      end
