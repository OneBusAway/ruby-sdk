    ...
    module Transport
      ...
      class BaseClient
          ...
          def follow_redirect(request, status:, response_headers:)
            ...
            location =
              Kernel.then do
                ...
                raise OnebusawaySDK::Errors::APIConnectionError.new(url: url, message: message)
              end
        ...
        def initialize(
          ...
          @base_url = OnebusawaySDK::Internal::Util.parse_uri(base_url)
        ...
        private def build_request(req, opts)
          ...
          {
            method: method,
            url: OnebusawaySDK::Internal::Util.join_parsed_uri(@base_url, {**req, path: path, query: query}),
            headers: headers,
            body: encoded,
        ...
        private def send_request(request, redirect_count:, retry_count:, send_retry_header:)
          ...
          in (400..) if retry_count >= max_retries || !self.class.should_retry?(status, headers: response)
            decoded = Kernel.then do
              OnebusawaySDK::Internal::Util.decode_content(response, stream: stream, suppress_error: true)
            ensure
              self.class.reap_connection!(status, stream: stream)
            end
        ...
        def inspect
          ...
          base_url = OnebusawaySDK::Internal::Util.unparse_uri(@base_url)
