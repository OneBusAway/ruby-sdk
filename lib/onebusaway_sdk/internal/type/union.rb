  ...
  module Internal
    module Type
      ...
      module Union
        ...
        private def resolve_variant(value)
          ...
          in [Symbol, Hash]
            key = value.fetch(@discriminator) do
              value.fetch(@discriminator.to_s, OnebusawaySDK::Internal::Util::OMIT)
            end

            return nil if key == OnebusawaySDK::Internal::Util::OMIT
        ...
        def dump(value)
          if (target = resolve_variant(value))
            return OnebusawaySDK::Internal::Type::Converter.dump(target, value)
          end

          known_variants.each do
            target = _2.call
            return OnebusawaySDK::Internal::Type::Converter.dump(target, value) if target === value
          end
