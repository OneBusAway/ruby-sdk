    ...
    module Type
      ...
      module Enum
        ...
        def ==(other)
          ...
          other.is_a?(Module) && other.singleton_class <= OnebusawaySDK::Internal::Type::Enum && other.values.to_set == values.to_set
        ...
        def inspect(depth: 0)
          ...
          "#{name}[#{values.map { OnebusawaySDK::Internal::Type::Converter.inspect(_1, depth: depth.succ) }.join(' | ')}]"
          # rubocop:enable Layout/LineLength
        end
      end
    end
