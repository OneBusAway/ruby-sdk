...
module OpenTransit
  module Models
    # @see OpenTransit::Resources::Config#retrieve
    class ConfigRetrieveResponse < OpenTransit::Models::ResponseWrapper
      ...
      class Data < OpenTransit::Internal::Type::BaseModel
        ...
        # @see OpenTransit::Models::ConfigRetrieveResponse::Data#entry
        class Entry < OpenTransit::Internal::Type::BaseModel
          ...
          # @see OpenTransit::Models::ConfigRetrieveResponse::Data::Entry#git_properties
