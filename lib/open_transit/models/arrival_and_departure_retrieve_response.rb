...
module OpenTransit
  module Models
    ...
    class ArrivalAndDepartureRetrieveResponse < OpenTransit::Models::ResponseWrapper
      # @!attribute data
      #
      #   @return [OpenTransit::Models::ArrivalAndDepartureRetrieveResponse::Data]
      required :data, -> { OpenTransit::Models::ArrivalAndDepartureRetrieveResponse::Data }

      # @!method initialize(data:)
      #   @param data [OpenTransit::Models::ArrivalAndDepartureRetrieveResponse::Data]

      class Data < OpenTransit::Internal::Type::BaseModel
        # @!attribute entry
        #
        #   @return [OpenTransit::Models::ArrivalAndDepartureRetrieveResponse::Data::Entry]
        required :entry, -> { OpenTransit::Models::ArrivalAndDepartureRetrieveResponse::Data::Entry }
        ...
        #   @param entry [OpenTransit::Models::ArrivalAndDepartureRetrieveResponse::Data::Entry]
        #   @param references [OpenTransit::References]

        # @see OpenTransit::Models::ArrivalAndDepartureRetrieveResponse::Data#entry
        class Entry < OpenTransit::Internal::Type::BaseModel
          ...
          #
          #   @return [OpenTransit::Models::ArrivalAndDepartureRetrieveResponse::Data::Entry::TripStatus, nil]
          optional :trip_status,
                   -> { OpenTransit::Models::ArrivalAndDepartureRetrieveResponse::Data::Entry::TripStatus },
                   api_name: :tripStatus
          ...
          #   {OpenTransit::Models::ArrivalAndDepartureRetrieveResponse::Data::Entry} for more
          #   details.
          #
          ...
          #
          #   @param trip_status [OpenTransit::Models::ArrivalAndDepartureRetrieveResponse::Data::Entry::TripStatus] Trip-specific status for the arriving transit vehicle.

          # @see OpenTransit::Models::ArrivalAndDepartureRetrieveResponse::Data::Entry#trip_status
          class TripStatus < OpenTransit::Internal::Type::BaseModel
            ...
            #
            #   @return [OpenTransit::Models::ArrivalAndDepartureRetrieveResponse::Data::Entry::TripStatus::LastKnownLocation, nil]
            optional :last_known_location,
                     -> { OpenTransit::Models::ArrivalAndDepartureRetrieveResponse::Data::Entry::TripStatus::LastKnownLocation },
            ...
            #
            #   @return [OpenTransit::Models::ArrivalAndDepartureRetrieveResponse::Data::Entry::TripStatus::Position, nil]
            optional :position,
                     -> { OpenTransit::Models::ArrivalAndDepartureRetrieveResponse::Data::Entry::TripStatus::Position }
            ...
            #   @param frequency [String] Information about frequency-based scheduling, if applicable to the trip.
            #
            #   @param last_known_location [OpenTransit::Models::ArrivalAndDepartureRetrieveResponse::Data::Entry::TripStatus::LastKnownLocation] Last known location of the transit vehicle.
            #
            ...
            #
            #   @param position [OpenTransit::Models::ArrivalAndDepartureRetrieveResponse::Data::Entry::TripStatus::Position] Current position of the transit vehicle.
            #
            ...
            # @see OpenTransit::Models::ArrivalAndDepartureRetrieveResponse::Data::Entry::TripStatus#last_known_location
            ...
            # @see OpenTransit::Models::ArrivalAndDepartureRetrieveResponse::Data::Entry::TripStatus#position
