...
module OpenTransit
  module Models
    ...
    class TripDetailRetrieveResponse < OpenTransit::Models::ResponseWrapper
      # @!attribute data
      #
      #   @return [OpenTransit::Models::TripDetailRetrieveResponse::Data]
      required :data, -> { OpenTransit::Models::TripDetailRetrieveResponse::Data }

      # @!method initialize(data:)
      #   @param data [OpenTransit::Models::TripDetailRetrieveResponse::Data]

      class Data < OpenTransit::Internal::Type::BaseModel
        # @!attribute entry
        #
        #   @return [OpenTransit::Models::TripDetailRetrieveResponse::Data::Entry]
        required :entry, -> { OpenTransit::Models::TripDetailRetrieveResponse::Data::Entry }
        ...
        #   @param entry [OpenTransit::Models::TripDetailRetrieveResponse::Data::Entry]
        #   @param references [OpenTransit::References]

        # @see OpenTransit::Models::TripDetailRetrieveResponse::Data#entry
        class Entry < OpenTransit::Internal::Type::BaseModel
          ...
          # @!attribute schedule
          #
          #   @return [OpenTransit::Models::TripDetailRetrieveResponse::Data::Entry::Schedule, nil]
          optional :schedule, -> { OpenTransit::Models::TripDetailRetrieveResponse::Data::Entry::Schedule }
          ...
          # @!attribute status
          #
          #   @return [OpenTransit::Models::TripDetailRetrieveResponse::Data::Entry::Status, nil]
          optional :status, -> { OpenTransit::Models::TripDetailRetrieveResponse::Data::Entry::Status }
          ...
          #   @param schedule [OpenTransit::Models::TripDetailRetrieveResponse::Data::Entry::Schedule]
          #   @param service_date [Integer]
          #   @param situation_ids [Array<String>]
          #   @param status [OpenTransit::Models::TripDetailRetrieveResponse::Data::Entry::Status]

          # @see OpenTransit::Models::TripDetailRetrieveResponse::Data::Entry#schedule
          class Schedule < OpenTransit::Internal::Type::BaseModel
            ...
            #
            #   @return [Array<OpenTransit::Models::TripDetailRetrieveResponse::Data::Entry::Schedule::StopTime>]
            required :stop_times,
                     -> { OpenTransit::Internal::Type::ArrayOf[OpenTransit::Models::TripDetailRetrieveResponse::Data::Entry::Schedule::StopTime] },
                     api_name: :stopTimes
            ...
            #   @param stop_times [Array<OpenTransit::Models::TripDetailRetrieveResponse::Data::Entry::Schedule::StopTime>]
          ...
          # @see OpenTransit::Models::TripDetailRetrieveResponse::Data::Entry#status
          class Status < OpenTransit::Internal::Type::BaseModel
            ...
            #
            #   @return [OpenTransit::Models::TripDetailRetrieveResponse::Data::Entry::Status::LastKnownLocation, nil]
            ...
            #
            #   @return [OpenTransit::Models::TripDetailRetrieveResponse::Data::Entry::Status::Position, nil]
            optional :position, -> { OpenTransit::Models::TripDetailRetrieveResponse::Data::Entry::Status::Position }
            ...
            #   {OpenTransit::Models::TripDetailRetrieveResponse::Data::Entry::Status} for more
            #   details.
            #
            ...
            #
            #   @param last_known_location [OpenTransit::Models::TripDetailRetrieveResponse::Data::Entry::Status::LastKnownLocation] Last known location of the transit vehicle.
            #
            ...
            #
            #   @param position [OpenTransit::Models::TripDetailRetrieveResponse::Data::Entry::Status::Position] Current position of the transit vehicle.
            #
            ...
            # @see OpenTransit::Models::TripDetailRetrieveResponse::Data::Entry::Status#last_known_location
            ...
            # @see OpenTransit::Models::TripDetailRetrieveResponse::Data::Entry::Status#position
