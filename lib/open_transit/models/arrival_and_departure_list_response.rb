...
module OpenTransit
  module Models
    ...
    class ArrivalAndDepartureListResponse < OpenTransit::Models::ResponseWrapper
      # @!attribute data
      #
      #   @return [OpenTransit::Models::ArrivalAndDepartureListResponse::Data]
      required :data, -> { OpenTransit::Models::ArrivalAndDepartureListResponse::Data }

      # @!method initialize(data:)
      #   @param data [OpenTransit::Models::ArrivalAndDepartureListResponse::Data]

      class Data < OpenTransit::Internal::Type::BaseModel
        # @!attribute entry
        #
        #   @return [OpenTransit::Models::ArrivalAndDepartureListResponse::Data::Entry]
        required :entry, -> { OpenTransit::Models::ArrivalAndDepartureListResponse::Data::Entry }
        ...
        #   @param entry [OpenTransit::Models::ArrivalAndDepartureListResponse::Data::Entry]
        #   @param references [OpenTransit::References]

        # @see OpenTransit::Models::ArrivalAndDepartureListResponse::Data#entry
        class Entry < OpenTransit::Internal::Type::BaseModel
          # @!attribute arrivals_and_departures
          #
          #   @return [Array<OpenTransit::Models::ArrivalAndDepartureListResponse::Data::Entry::ArrivalsAndDeparture>]
          required :arrivals_and_departures,
                   -> { OpenTransit::Internal::Type::ArrayOf[OpenTransit::Models::ArrivalAndDepartureListResponse::Data::Entry::ArrivalsAndDeparture] },
                   api_name: :arrivalsAndDepartures

          # @!method initialize(arrivals_and_departures:)
          #   @param arrivals_and_departures [Array<OpenTransit::Models::ArrivalAndDepartureListResponse::Data::Entry::ArrivalsAndDeparture>]
          ...
          class ArrivalsAndDeparture < OpenTransit::Internal::Type::BaseModel
            ...
            #
            #   @return [Boolean, nil]
            optional :predicted, OpenTransit::Internal::Type::Boolean
            ...
            #
            #   @return [OpenTransit::Models::ArrivalAndDepartureListResponse::Data::Entry::ArrivalsAndDeparture::TripStatus, nil]
            ...
            #   {OpenTransit::Models::ArrivalAndDepartureListResponse::Data::Entry::ArrivalsAndDeparture}
            #   for more details.
            #
            ...
            #
            #   @param trip_status [OpenTransit::Models::ArrivalAndDepartureListResponse::Data::Entry::ArrivalsAndDeparture::TripStatus] Trip-specific status for the arriving transit vehicle.

            # @see OpenTransit::Models::ArrivalAndDepartureListResponse::Data::Entry::ArrivalsAndDeparture#trip_status
            class TripStatus < OpenTransit::Internal::Type::BaseModel
              ...
              #
              #   @return [OpenTransit::Models::ArrivalAndDepartureListResponse::Data::Entry::ArrivalsAndDeparture::TripStatus::LastKnownLocation, nil]
              ...
              #
              #   @return [OpenTransit::Models::ArrivalAndDepartureListResponse::Data::Entry::ArrivalsAndDeparture::TripStatus::Position, nil]
              optional :position,
              ...
              #   @param frequency [String] Information about frequency-based scheduling, if applicable to the trip.
              #
              #   @param last_known_location [OpenTransit::Models::ArrivalAndDepartureListResponse::Data::Entry::ArrivalsAndDeparture::TripStatus::LastKnownLocation] Last known location of the transit vehicle.
              #
              ...
              #
              #   @param position [OpenTransit::Models::ArrivalAndDepartureListResponse::Data::Entry::ArrivalsAndDeparture::TripStatus::Position] Current position of the transit vehicle.
              #
              ...
              # @see OpenTransit::Models::ArrivalAndDepartureListResponse::Data::Entry::ArrivalsAndDeparture::TripStatus#last_known_location
              ...
              # @see OpenTransit::Models::ArrivalAndDepartureListResponse::Data::Entry::ArrivalsAndDeparture::TripStatus#position
