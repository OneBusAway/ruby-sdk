...
module OpenTransit
  module Models
    # @see OpenTransit::Resources::ReportProblemWithTrip#retrieve
    class ReportProblemWithTripRetrieveParams < OpenTransit::Internal::Type::BaseModel
      ...
      #
      #   @return [Symbol, OpenTransit::ReportProblemWithTripRetrieveParams::Code, nil]
      optional :code, enum: -> { OpenTransit::ReportProblemWithTripRetrieveParams::Code }
      ...
      #
      #   @return [Boolean, nil]
      optional :user_on_vehicle, OpenTransit::Internal::Type::Boolean
      ...
      #   @param code [Symbol, OpenTransit::ReportProblemWithTripRetrieveParams::Code] A string code identifying the nature of the problem
      #
