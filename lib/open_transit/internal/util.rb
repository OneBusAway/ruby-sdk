    ...
    module Util
      ...
      class << self
        ...
        def coerce_hash!(input)
          ...
          in Hash | nil => coerced
            ...
            message = "Expected a #{Hash} or #{OpenTransit::Internal::Type::BaseModel}, got #{data.inspect}"
      ...
      class << self
        ...
        private def write_multipart_chunk(y, boundary:, key:, val:, closing:)
          ...
          case val
          in OpenTransit::FilePart unless val.filename.nil?
        ...
        def encode_content(headers, body)
          ...
          in [OpenTransit::Internal::Util::JSON_CONTENT, Hash | Array | -> { primitive?(_1) }]
            [headers, JSON.generate(body)]
          in [OpenTransit::Internal::Util::JSONL_CONTENT, Enumerable] unless body.is_a?(OpenTransit::Internal::Type::FileInput)
            [headers, body.lazy.map { JSON.generate(_1) }]
          in [%r{^multipart/form-data}, Hash | OpenTransit::Internal::Type::FileInput]
        ...
        def decode_content(headers, stream:, suppress_error: false)
          ...
          in OpenTransit::Internal::Util::JSON_CONTENT
          ...
          in OpenTransit::Internal::Util::JSONL_CONTENT
