    ...
    module Type
      ...
      module Converter
        ...
        def dump(value, state:)
          case value
          in Array
            value.map { OpenTransit::Internal::Type::Unknown.dump(_1, state: state) }
          in Hash
            value.transform_values { OpenTransit::Internal::Type::Unknown.dump(_1, state: state) }
          ...
          in Pathname | IO
            ...
            OpenTransit::FilePart.new(value)
          in OpenTransit::FilePart
        ...
        class << self
          ...
          def type_info(spec)
            ...
            in OpenTransit::Internal::Type::Converter | Class | Symbol
              -> { spec }
          ...
          #
          # @param target [OpenTransit::Internal::Type::Converter, Class]
          #
          # @param value [Object]
          #
          ...
          def coerce(
            ...
            case target
            in OpenTransit::Internal::Type::Converter
          ...
          def dump(target, value, state: {can_retry: true})
            ...
            in OpenTransit::Internal::Type::Converter
              ...
              OpenTransit::Internal::Type::Unknown.dump(value, state: state)
            end
          end
        ...
        define_sorbet_constant!(:Input) do
          T.type_alias { T.any(OpenTransit::Internal::Type::Converter, T::Class[T.anything]) }
        end
