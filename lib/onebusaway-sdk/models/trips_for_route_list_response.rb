...
module OnebusawaySDK
  module Models
    class TripsForRouteListResponse < OnebusawaySDK::Models::ResponseWrapper
      # @!attribute data
      #
      #   @return [OnebusawaySDK::Models::TripsForRouteListResponse::Data]
      required :data, -> { OnebusawaySDK::Models::TripsForRouteListResponse::Data }

      # @!parse
      #   # @param data [OnebusawaySDK::Models::TripsForRouteListResponse::Data]
      #   #
      ...
      #   list: -> { OnebusawaySDK::ArrayOf[OnebusawaySDK::Models::TripsForRouteListResponse::Data::List] === _1 },
      ...
      class Data < OnebusawaySDK::BaseModel
        ...
        # @!attribute list
        #
        #   @return [Array<OnebusawaySDK::Models::TripsForRouteListResponse::Data::List>]
        required :list,
                 -> { OnebusawaySDK::ArrayOf[OnebusawaySDK::Models::TripsForRouteListResponse::Data::List] }
        ...
        class List < OnebusawaySDK::BaseModel
          ...
          #   stop_times: -> { OnebusawaySDK::ArrayOf[OnebusawaySDK::Models::TripsForRouteListResponse::Data::List::Schedule::StopTime] === _1 },
          #   time_zone: String,
          #   frequency: String
          # }
          # ```
          ...
          class Status < OnebusawaySDK::BaseModel
            ...
            # @!parse
            #   # @return [OnebusawaySDK::Models::TripsForRouteListResponse::Data::List::Status::LastKnownLocation]
            ...
            #   # @param last_known_location [OnebusawaySDK::Models::TripsForRouteListResponse::Data::List::Status::LastKnownLocation]
            #   # @param last_known_orientation [Float]
            #   # @param next_stop [String]
            #   # @param next_stop_time_offset [Integer]
            #   # @param orientation [Float]
            #   # @param position [OnebusawaySDK::Models::TripsForRouteListResponse::Data::List::Status::Position]
