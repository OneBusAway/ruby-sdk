...
module OnebusawaySDK
  ...
  module RequestParameters
    ...
    def self.included(mod)
      ...
      mod.extend(OnebusawaySDK::RequestParameters::Converter)
  ...
  class RequestOptions < OnebusawaySDK::BaseModel
    # @api private
    #
    # @param opts [OnebusawaySDK::RequestOptions, Hash{Symbol=>Object}]
    #
    # @raise [ArgumentError]
    ...
    optional :extra_query, OnebusawaySDK::HashOf[OnebusawaySDK::ArrayOf[String]]
    ...
    optional :extra_headers, OnebusawaySDK::HashOf[String, nil?: true]
    ...
    #
    #   @return [Object, nil]
    optional :extra_body, OnebusawaySDK::HashOf[OnebusawaySDK::Unknown]
