    ...
    module Converter
      ...
      class << self
        ...
        def type_info(spec)
          ...
          in OnebusawaySDK::Type::Converter | Class | Symbol
            -> { spec }
        ...
        #
        # @param target [OnebusawaySDK::Type::Converter, Class]
        #
        # @param value [Object]
        #
        ...
        def coerce(
          ...
          case target
          in OnebusawaySDK::Type::Converter
        ...
        def dump(target, value)
          target.is_a?(OnebusawaySDK::Type::Converter) ? target.dump(value) : OnebusawaySDK::Unknown.dump(value)
        end
      end
    end
