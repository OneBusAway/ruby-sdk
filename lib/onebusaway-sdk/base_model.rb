...
module OnebusawaySDK
  ...
  module Converter
    ...
    class << self
      ...
      def type_info(spec)
        ...
        in Proc
          spec
        in OnebusawaySDK::Converter | Module | Symbol
          -> { spec }
        in true | false
  ...
  module Enum
    ...
    # @return [Boolean]
    def ==(other)
      other.is_a?(Module) && other.singleton_class.ancestors.include?(OnebusawaySDK::Enum) && other.values.to_set == values.to_set
    end
  ...
  module Union
    ...
    private def variant(key, spec = nil)
      variant_info =
        ...
        in Proc | OnebusawaySDK::Converter | Module | Hash
    ...
    # @return [Boolean]
    def ==(other)
      other.is_a?(Module) && other.singleton_class.ancestors.include?(OnebusawaySDK::Union) && other.derefed_variants == derefed_variants
    end
  ...
  class BaseModel
    ...
    class << self
      ...
      def reverse_map
        @reverse_map ||= (self < OnebusawaySDK::BaseModel ? superclass.reverse_map.dup : {})
      end
      ...
      private def add_field(name_sym, required:, type_info:, spec:)
        type_fn, info =
          case type_info
          in Proc | Module | OnebusawaySDK::Converter
    ...
    def initialize(data = {})
      ...
      in Hash => coerced
        @data = coerced.to_h do |key, value|
          ...
          stored =
            case [type, value]
            in [Module, Hash] if type <= OnebusawaySDK::BaseModel
              type.new(value)
            in [OnebusawaySDK::ArrayOf, Array] | [OnebusawaySDK::HashOf, Hash]
              type.coerce(value)
            else
              value
            end
