...
module OnebusawaySDK
  ...
  module Converter
    ...
    class << self
      ...
      def dump(target, value)
        target.is_a?(OnebusawaySDK::Converter) ? target.dump(value) : OnebusawaySDK::Unknown.dump(value)
      end
    end
  end
  ...
  module Enum
    ...
    # @return [Boolean]
    def ==(other)
      other.is_a?(Module) && other.singleton_class <= OnebusawaySDK::Enum && other.values.to_set == values.to_set
    end
  ...
  module Union
    ...
    private def resolve_variant(value)
      ...
      in [Symbol, Hash]
        key = value.fetch(@discriminator) do
          value.fetch(@discriminator.to_s, OnebusawaySDK::Util::OMIT)
        end

        return nil if key == OnebusawaySDK::Util::OMIT
    ...
    # @return [Boolean]
    def ==(other)
      other.is_a?(Module) && other.singleton_class <= OnebusawaySDK::Union && other.derefed_variants == derefed_variants
    end
    ...
    def coerce(value, state:)
      if (target = resolve_variant(value))
        return OnebusawaySDK::Converter.coerce(target, value, state: state)
      end
      ...
      known_variants.each do |_, variant_fn|
        ...
        coerced = OnebusawaySDK::Converter.coerce(target, value, state: state)
    ...
    def dump(value)
      if (target = resolve_variant(value))
        return OnebusawaySDK::Converter.dump(target, value)
      end

      known_variants.each do
        target = _2.call
        return OnebusawaySDK::Converter.dump(target, value) if target === value
      end
  ...
  class ArrayOf
      ...
      value
        .map do |item|
          ...
          in [true, nil]
            ...
            OnebusawaySDK::Converter.coerce(target, item, state: state)
          end
        end
    end
    ...
    def dump(value)
      target = item_type
      value.is_a?(Array) ? value.map { OnebusawaySDK::Converter.dump(target, _1) } : super
    end
  ...
  class HashOf
    ...
    #
    # @return [Boolean]
    def ==(other) = other.is_a?(OnebusawaySDK::HashOf) && other.nilable? == nilable? && other.item_type == item_type
        ...
        .to_h do |key, val|
          ...
          v =
            ...
            in [true, nil]
              ...
              OnebusawaySDK::Converter.coerce(target, val, state: state)
            end
    ...
    def dump(value)
      target = item_type
      value.is_a?(Hash) ? value.transform_values { OnebusawaySDK::Converter.dump(target, _1) } : super
    end
  ...
  class BaseModel
    ...
    class << self
      ...
      private def add_field(name_sym, required:, type_info:, spec:)
        type_fn, info =
          case type_info
          in Proc | OnebusawaySDK::Converter | Class
        ...
        define_method(name_sym) do
          target = type_fn.call
          value = @data.fetch(name_sym) { const == OnebusawaySDK::Util::OMIT ? nil : const }
          state = {strictness: :strong, exactness: {yes: 0, no: 0, maybe: 0}, branched: 0}
          if (nilable || !required) && value.nil?
            nil
          else
            OnebusawaySDK::Converter.coerce(
              target,
              value,
              state: state
            )
      ...
      #
      # @return [Boolean]
      def ==(other) = other.is_a?(Class) && other <= OnebusawaySDK::BaseModel && other.fields == fields
    end
    ...
    class << self
      ...
      def coerce(value, state:)
        ...
        unless (val = OnebusawaySDK::Util.coerce_hash(value)).is_a?(Hash)
          exactness[:no] += 1
          return value
        end
        exactness[:yes] += 1
        ...
        fields.each do |name, field|
          ...
          converted =
            if item.nil? && (nilable || !required)
              ...
              coerced = OnebusawaySDK::Converter.coerce(target, item, state: state)
              case target
              in OnebusawaySDK::Converter | Symbol
                coerced
              else
                item
              end
      ...
      def dump(value)
        ...
        coerced.each do |key, val|
          ...
          in nil
            ...
            in :coerce
              ...
              target = type_fn.call
              acc.store(api_name, OnebusawaySDK::Converter.dump(target, val))
            end
          end
        end
        ...
        known_fields.each_value do |field|
          ...
          next if mode == :coerce || acc.key?(api_name) || const == OnebusawaySDK::Util::OMIT
    ...
    def inspect
      ...
      rescue OnebusawaySDK::ConversionError
        "#{_1}=#{@data.fetch(_1)}"
      end
