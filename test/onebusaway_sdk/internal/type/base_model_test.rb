...
class OnebusawaySDK::Test::PrimitiveModelTest < Minitest::Test
  ...
  def test_typing
    ...
    converters.each do |conv|
      assert_pattern do
        conv => OnebusawaySDK::Internal::Type::Converter
      end
    end
  end
  ...
  def test_coerce
    ...
    cases.each do |lhs, rhs|
      ...
      assert_pattern do
        OnebusawaySDK::Internal::Type::Converter.coerce(target, input, state: state) => ^expect
  ...
  def test_dump
    cases = {
      ...
      [String, Pathname(__FILE__)] => OnebusawaySDK::Internal::Util::SerializationAdapter
    }
    ...
    cases.each do
      ...
      expect = _2
      assert_pattern do
        OnebusawaySDK::Internal::Type::Converter.dump(target, input) => ^expect
      end
    end
  end
  ...
  def test_coerce_errors
    ...
    cases.each do
      ...
      assert_raises(_2) do
        OnebusawaySDK::Internal::Type::Converter.coerce(target, input, state: state)
      end
    end
  end
  ...
  def test_dump_retry
    ...
    Pathname(__FILE__).open do |fd|
      ...
      types.product(cases).each do |target, input|
        ...
        OnebusawaySDK::Internal::Type::Converter.dump(target, input, state: state)
...
class OnebusawaySDK::Test::EnumModelTest < Minitest::Test
  class E0
    include OnebusawaySDK::Internal::Type::Enum
    attr_reader :values
...
class OnebusawaySDK::Test::UnionTest < Minitest::Test
  class U0
    include OnebusawaySDK::Internal::Type::Union
