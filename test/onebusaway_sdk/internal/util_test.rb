...
class OnebusawaySDK::Test::UtilDataHandlingTest < Minitest::Test
  def test_left_map
    assert_pattern do
      OnebusawaySDK::Internal::Util.deep_merge({a: 1}, nil) => nil
    end
  end

  def test_right_map
    assert_pattern do
      OnebusawaySDK::Internal::Util.deep_merge(nil, {a: 1}) => {a: 1}
    end
  end

  def test_disjoint_maps
    assert_pattern do
      OnebusawaySDK::Internal::Util.deep_merge({b: 2}, {a: 1}) => {a: 1, b: 2}
    end
  end

  def test_overlapping_maps
    assert_pattern do
      OnebusawaySDK::Internal::Util.deep_merge({b: 2, c: 3}, {a: 1, c: 4}) => {a: 1, b: 2, c: 4}
    end
  end

  def test_nested
    assert_pattern do
      OnebusawaySDK::Internal::Util.deep_merge({b: {b2: 1}}, {b: {b2: 2}}) => {b: {b2: 2}}
    end
  end

  def test_nested_left_map
    assert_pattern do
      OnebusawaySDK::Internal::Util.deep_merge({b: {b2: 1}}, {b: 6}) => {b: 6}
    end
  end
  ...
  def test_dig
    assert_pattern do
      OnebusawaySDK::Internal::Util.dig(1, nil) => 1
      OnebusawaySDK::Internal::Util.dig({a: 1}, :b) => nil
      OnebusawaySDK::Internal::Util.dig({a: 1}, :a) => 1
      OnebusawaySDK::Internal::Util.dig({a: {b: 1}}, [:a, :b]) => 1

      OnebusawaySDK::Internal::Util.dig([], 1) => nil
      OnebusawaySDK::Internal::Util.dig([nil, [nil, 1]], [1, 1]) => 1
      OnebusawaySDK::Internal::Util.dig({a: [nil, 1]}, [:a, 1]) => 1
...
class OnebusawaySDK::Test::UtilUriHandlingTest < Minitest::Test
  def test_parsing
    %w[
      http://example.com
      https://example.com/
      ...
      parsed = OnebusawaySDK::Internal::Util.parse_uri(url)
      unparsed = OnebusawaySDK::Internal::Util.unparse_uri(parsed).to_s

      assert_equal(url, unparsed)
      assert_equal(parsed, OnebusawaySDK::Internal::Util.parse_uri(unparsed))
    end
  end
  ...
  def test_joining
    cases = [
      [
        "h://a.b/c?d=e",
        "h://nope/ignored",
        OnebusawaySDK::Internal::Util.parse_uri("h://a.b/c?d=e")
      ],
      [
        "h://a.b/c?d=e",
        "h://nope",
    ...
    cases.each do |expect, lhs, rhs|
      assert_equal(
        URI.parse(expect),
        OnebusawaySDK::Internal::Util.join_parsed_uri(
          OnebusawaySDK::Internal::Util.parse_uri(lhs),
          rhs
        )
      )
    end
  ...
  def test_joining_queries
    ...
    cases.each do |path, expected|
      assert_equal(
        URI.parse(expected),
        OnebusawaySDK::Internal::Util.join_parsed_uri(
          OnebusawaySDK::Internal::Util.parse_uri(base_url),
          {path: path}
        )
      )
    end
...
class OnebusawaySDK::Test::RegexMatchTest < Minitest::Test
  ...
  def test_jsonl_content
    ...
    cases.each do |header, verdict|
      assert_pattern do
        OnebusawaySDK::Internal::Util::JSONL_CONTENT.match?(header) => ^verdict
      end
    end
  end
end

class OnebusawaySDK::Test::UtilFormDataEncodingTest < Minitest::Test
  class FakeCGI < CGI
    def initialize(headers, io)
      encoded = io.to_a
      @ctype = headers["content-type"]
      # rubocop:disable Lint/EmptyBlock
      @io = OnebusawaySDK::Internal::Util::ReadIOAdapter.new(encoded.to_enum) {}
  ...
  def test_encoding_length
    headers, = OnebusawaySDK::Internal::Util.encode_content(
  ...
  def test_file_encode
    ...
    fileinput = OnebusawaySDK::Internal::Type::Converter.dump(OnebusawaySDK::Internal::Type::FileInput, "abc")
    ...
    cases = {
      ...
      file => [file.basename.to_path, /^class OnebusawaySDK/],
      OnebusawaySDK::FilePart.new(file, filename: "d o g") => ["d%20o%20g", /^class OnebusawaySDK/]
    }
  ...
  def test_hash_encode
    ...
    cases = {
      ...
      {pathname: OnebusawaySDK::FilePart.new(Pathname(__FILE__))} => {"pathname" => -> { _1.read in /^class OnebusawaySDK/ }}
    }
    cases.each do |body, testcase|
      encoded = OnebusawaySDK::Internal::Util.encode_content(headers, body)
      cgi = FakeCGI.new(*encoded)
...
class OnebusawaySDK::Test::UtilIOAdapterTest < Minitest::Test
  def test_copy_read
    ...
    cases.each do |input, expected|
      io = StringIO.new
      # rubocop:disable Lint/EmptyBlock
      adapter = OnebusawaySDK::Internal::Util::ReadIOAdapter.new(input) {}
      # rubocop:enable Lint/EmptyBlock
  ...
  def test_copy_write
    ...
    cases.each do |input, expected|
      enum = OnebusawaySDK::Internal::Util.writable_enum do |y|
...
class OnebusawaySDK::Test::UtilFusedEnumTest < Minitest::Test
  def test_rewind_closing
    ...
    fused = OnebusawaySDK::Internal::Util.fused_enum(enum, external: true) do
      touched = true
      loop { enum.next }
    end
    OnebusawaySDK::Internal::Util.close_fused!(fused)
  ...
  def test_thread_interrupts
    ...
    fused_1 = OnebusawaySDK::Internal::Util.fused_enum(enum, external: true) { loop { enum.next } }
    fused_2 = OnebusawaySDK::Internal::Util.chain_fused(fused_1) { fused_1.each(&_1) }
    fused_3 = OnebusawaySDK::Internal::Util.chain_fused(fused_2) { fused_2.each(&_1) }
  ...
  def test_closing
    arr = [1, 2, 3]
    once = 0
    fused = OnebusawaySDK::Internal::Util.fused_enum(arr.to_enum) do
      once = once.succ
    end
  ...
  def test_rewind_chain
    once = 0
    fused = OnebusawaySDK::Internal::Util.fused_enum([1, 2, 3].to_enum) do
      once = once.succ
    end
      .lazy
      .map(&:succ)
  ...
  def test_external_iteration
    iter = [1, 2, 3].to_enum
    first = iter.next
    fused = OnebusawaySDK::Internal::Util.fused_enum(iter, external: true)
  ...
  def test_closed_fused_extern_iteration
    ...
    fused = OnebusawaySDK::Internal::Util.fused_enum(enum)
    first = fused.next
  ...
  def test_close_fused_sse_chain
    ...
    fused_1 = OnebusawaySDK::Internal::Util.fused_enum(enum)
    fused_2 = OnebusawaySDK::Internal::Util.decode_lines(fused_1)
    fused_3 = OnebusawaySDK::Internal::Util.decode_sse(fused_2)

    assert_equal(0, taken)
    OnebusawaySDK::Internal::Util.close_fused!(fused_3)
    assert_equal(0, taken)
  end
end

class OnebusawaySDK::Test::UtilContentDecodingTest < Minitest::Test
  def test_charset
    cases = {
    ...
    cases.each do |content_type, encoding|
      OnebusawaySDK::Internal::Util.force_charset!(content_type, text: text)
...
class OnebusawaySDK::Test::UtilSseTest < Minitest::Test
  def test_decode_lines
    ...
    cases.each do |enum, expected|
      eols.each do |eol|
        lines = OnebusawaySDK::Internal::Util.decode_lines(enum.map { _1.gsub("\n", eol) })
  ...
  def test_mixed_decode_lines
    ...
    cases.each do |enum, expected|
      lines = OnebusawaySDK::Internal::Util.decode_lines(enum)
  ...
  def test_decode_sse
    ...
    cases.each do |name, test_cases|
      test_cases.each do |input, expected|
        actual = OnebusawaySDK::Internal::Util.decode_sse(input).map(&:compact)
