...
class OnebusawaySDK::Test::SingletonClient < OnebusawaySDK::Client
  include Singleton

  TEST_API_BASE_URL = ENV.fetch("TEST_API_BASE_URL", "http://localhost:4010")

  def initialize
    super(base_url: OnebusawaySDK::Test::SingletonClient::TEST_API_BASE_URL, api_key: "My API Key")
  end
end
...
class OnebusawaySDK::Test::ResourceTest < Minitest::Test
  def async?
  ...
  def before_all
    super
    @onebusaway_sdk = OnebusawaySDK::Test::SingletonClient.instance
  end
