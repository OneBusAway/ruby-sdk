...
class OpenTransitTest < Minitest::Test
  ...
  def test_client_default_request_default_retry_attempts
    onebusaway_sdk = OpenTransit::Client.new(base_url: "http://localhost:4010", api_key: "My API Key")
    requester = MockRequester.new(500, {}, {})
    onebusaway_sdk.requester = requester

    assert_raises(OpenTransit::InternalServerError) do
  ...
  def test_client_redirect_307
    ...
    assert_raises(OpenTransit::APIConnectionError) do
