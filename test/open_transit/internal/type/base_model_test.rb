...
class OpenTransit::Test::PrimitiveModelTest < Minitest::Test
  A = OpenTransit::Internal::Type::ArrayOf[-> { Integer }]
  H = OpenTransit::Internal::Type::HashOf[-> { Integer }, nil?: true]
  ...
  module U
    extend OpenTransit::Internal::Type::Union
  end

  class B < OpenTransit::Internal::Type::BaseModel
    optional :a, Integer
    optional :b, B
  end
  ...
  def test_typing
    converters = [
      OpenTransit::Internal::Type::Unknown,
      OpenTransit::Internal::Type::Boolean,
      A,
      H,
      E,
      U,
    ...
    converters.each do |conv|
      assert_pattern do
        conv => OpenTransit::Internal::Type::Converter
      end
    end
  end
  ...
  def test_coerce
    cases = {
      [OpenTransit::Internal::Type::Unknown, :a] => [{yes: 1}, :a],
      [NilClass, :a] => [{maybe: 1}, nil],
      [NilClass, nil] => [{yes: 1}, nil],
      [OpenTransit::Internal::Type::Boolean, true] => [{yes: 1}, true],
      [OpenTransit::Internal::Type::Boolean, "true"] => [{no: 1}, "true"],
      [Integer, 1] => [{yes: 1}, 1],
    ...
    cases.each do |lhs, rhs|
      ...
      assert_pattern do
        OpenTransit::Internal::Type::Converter.coerce(target, input, state: state) => ^expect
  ...
  def test_dump
    cases = {
      [OpenTransit::Internal::Type::Unknown, B.new(a: "one", b: B.new(a: 1.0))] => {a: "one", b: {a: 1}},
      ...
      [OpenTransit::Internal::Type::Boolean, true] => true,
      [OpenTransit::Internal::Type::Boolean, "true"] => "true",
      [Integer, "1"] => "1",
      [Float, 1] => 1,
      [String, "one"] => "one",
      ...
      [String, Pathname(__FILE__)] => OpenTransit::FilePart
    }
    ...
    cases.each do
      ...
      expect = _2
      assert_pattern do
        OpenTransit::Internal::Type::Converter.dump(target, input) => ^expect
      end
    end
  end
  ...
  def test_coerce_errors
    ...
    cases.each do
      ...
      assert_raises(_2) do
        OpenTransit::Internal::Type::Converter.coerce(target, input, state: state)
      end
    end
  end
  ...
  def test_dump_retry
    ...
    Pathname(__FILE__).open do |fd|
      ...
      types.product(cases).each do |target, input|
        ...
        OpenTransit::Internal::Type::Converter.dump(target, input, state: state)
...
class OpenTransit::Test::EnumModelTest < Minitest::Test
  class E0
    include OpenTransit::Internal::Type::Enum
    attr_reader :values
...
class OpenTransit::Test::CollectionModelTest < Minitest::Test
  A1 = OpenTransit::Internal::Type::ArrayOf[-> { Integer }]
  H1 = OpenTransit::Internal::Type::HashOf[Integer]

  A2 = OpenTransit::Internal::Type::ArrayOf[H1]
  H2 = OpenTransit::Internal::Type::HashOf[-> { A1 }]

  A3 = OpenTransit::Internal::Type::ArrayOf[Integer, nil?: true]
  H3 = OpenTransit::Internal::Type::HashOf[Integer, nil?: true]
...
class OpenTransit::Test::BaseModelTest < Minitest::Test
  class M1 < OpenTransit::Internal::Type::BaseModel
    required :a, Integer
  end
  ...
  class M3 < OpenTransit::Internal::Type::BaseModel
    optional :c, const: :c
    required :d, const: :d
  end
  ...
  class M5 < OpenTransit::Internal::Type::BaseModel
    request_only do
      required :c, const: :c
    end
  ...
  class M6 < M1
    required :a, OpenTransit::Internal::Type::ArrayOf[M6]
  end
  ...
  def test_coerce
    ...
    cases.each do |lhs, rhs|
      ...
      state = {strictness: true, exactness: {yes: 0, no: 0, maybe: 0}, branched: 0}
      assert_pattern do
        coerced = OpenTransit::Internal::Type::Converter.coerce(target, input, state: state)
        assert_equal(coerced, coerced)
        if coerced.is_a?(OpenTransit::Internal::Type::BaseModel)
          coerced.to_h => ^expect
        else
          coerced => ^expect
        end
      ...
      _2.each do |accessor, expect|
        ...
        in Class if expect <= StandardError
          tap do
            ...
            flunk
          rescue OpenTransit::Errors::ConversionError => e
...
class OpenTransit::Test::UnionTest < Minitest::Test
  class U0
    include OpenTransit::Internal::Type::Union
  ...
  class M2 < OpenTransit::Internal::Type::BaseModel
  ...
  class M4 < OpenTransit::Internal::Type::BaseModel
    optional :recur, -> { U5 }
    required :a, OpenTransit::Internal::Type::ArrayOf[-> { U5 }]
  end

  class M5 < OpenTransit::Internal::Type::BaseModel
    optional :recur, -> { U5 }
    required :b, OpenTransit::Internal::Type::ArrayOf[-> { U5 }]
  end
...
class OpenTransit::Test::BaseModelQoLTest < Minitest::Test
  class E0
    include OpenTransit::Internal::Type::Enum
    attr_reader :values
  ...
  def test_equality
    cases = {
      [OpenTransit::Internal::Type::Unknown, OpenTransit::Internal::Type::Unknown] => true,
      [OpenTransit::Internal::Type::Boolean, OpenTransit::Internal::Type::Boolean] => true,
      [OpenTransit::Internal::Type::Unknown, OpenTransit::Internal::Type::Boolean] => false,
