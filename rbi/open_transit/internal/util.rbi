      ...
      class << self
        ...
        sig do
          params(url: T.any(URI::Generic, String)).returns(
            OpenTransit::Internal::Util::ParsedUri
          )
        end
        def parse_uri(url)
        end
        ...
        # @api private
        sig do
          params(parsed: OpenTransit::Internal::Util::ParsedUri).returns(
            URI::Generic
          )
        end
        ...
        sig do
          params(
            lhs: OpenTransit::Internal::Util::ParsedUri,
            rhs: OpenTransit::Internal::Util::ParsedUri
          ).returns(URI::Generic)
        end
      ...
      class << self
        ...
        sig do
          params(lines: T::Enumerable[String]).returns(
            T::Enumerable[OpenTransit::Internal::Util::ServerSentEvent]
          )
        end
