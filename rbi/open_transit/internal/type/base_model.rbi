    ...
    module Type
      class BaseModel
          ...
          sig do
            returns(
              T::Hash[
                Symbol,
                T.all(
                  OpenTransit::Internal::Type::BaseModel::KnownField,
                  {
                    type_fn:
                      T.proc.returns(
                        OpenTransit::Internal::Type::Converter::Input
                      )
                  }
                )
              ]
          ...
          sig do
            returns(
              T::Hash[
                ...
                T.all(
                  OpenTransit::Internal::Type::BaseModel::KnownField,
                  { type: OpenTransit::Internal::Type::Converter::Input }
                )
              ]
            )
          end
            ...
            params(
              ...
              type_info:
                T.any(
                  ...
                  T.proc.returns(OpenTransit::Internal::Type::Converter::Input),
                  OpenTransit::Internal::Type::Converter::Input
                ),
              spec: OpenTransit::Internal::AnyHash
            ).void
          end
          ...
          sig do
            override
              .params(
                ...
                state: OpenTransit::Internal::Type::Converter::CoerceState
              )
          ...
          sig do
            override
              .params(
                ...
                state: OpenTransit::Internal::Type::Converter::DumpState
              )
        ...
        class << self
          ...
          sig do
            params(
              model: OpenTransit::Internal::Type::BaseModel,
              convert: T::Boolean
            ).returns(OpenTransit::Internal::AnyHash)
          end
        ...
        sig { overridable.returns(OpenTransit::Internal::AnyHash) }
        def to_h
        end
