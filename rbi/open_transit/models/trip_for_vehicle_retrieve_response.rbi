  ...
  module Models
    class TripForVehicleRetrieveResponse < OpenTransit::Models::ResponseWrapper
      OrHash =
        T.type_alias do
          T.any(
            OpenTransit::Models::TripForVehicleRetrieveResponse,
      ...
      sig do
        params(
          data:
            OpenTransit::Models::TripForVehicleRetrieveResponse::Data::OrHash
        ).void
      end
      attr_writer :data
      ...
      sig do
        override.returns(
          { data: OpenTransit::Models::TripForVehicleRetrieveResponse::Data }
        )
      end
      def to_hash
      end
      ...
      class Data < OpenTransit::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              OpenTransit::Models::TripForVehicleRetrieveResponse::Data,
              OpenTransit::Internal::AnyHash
            )
          end
        ...
        sig do
          returns(
            OpenTransit::Models::TripForVehicleRetrieveResponse::Data::Entry
          )
        end
        attr_reader :entry
        ...
        sig do
          params(
            entry:
              OpenTransit::Models::TripForVehicleRetrieveResponse::Data::Entry::OrHash
          ).void
        end
        attr_writer :entry
        ...
        class Entry < OpenTransit::Internal::Type::BaseModel
          ...
          sig do
            params(
              schedule:
                OpenTransit::Models::TripForVehicleRetrieveResponse::Data::Entry::Schedule::OrHash
            ).void
          end
          ...
          sig do
            returns(
              T.nilable(
                OpenTransit::Models::TripForVehicleRetrieveResponse::Data::Entry::Status
              )
            )
          end
          attr_reader :status
          ...
          sig do
            params(
              status:
                OpenTransit::Models::TripForVehicleRetrieveResponse::Data::Entry::Status::OrHash
            ).void
          end
          attr_writer :status
          ...
          class Schedule < OpenTransit::Internal::Type::BaseModel
            ...
            sig do
              returns(
                T::Array[
                  OpenTransit::Models::TripForVehicleRetrieveResponse::Data::Entry::Schedule::StopTime
                ]
              )
            end
            ...
            sig do
              params(
                ...
                stop_times:
                  T::Array[
                    OpenTransit::Models::TripForVehicleRetrieveResponse::Data::Entry::Schedule::StopTime::OrHash
                  ],
                time_zone: String,
                frequency: T.nilable(String)
              ).returns(T.attached_class)
          ...
          class Status < OpenTransit::Internal::Type::BaseModel
            ...
            sig do
              params(
                last_known_location:
                  OpenTransit::Models::TripForVehicleRetrieveResponse::Data::Entry::Status::LastKnownLocation::OrHash
              ).void
            end
            ...
            sig do
              params(
                position:
                  OpenTransit::Models::TripForVehicleRetrieveResponse::Data::Entry::Status::Position::OrHash
              ).void
            end
