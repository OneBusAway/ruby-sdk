  ...
  module Models
    class StopsForAgencyListResponse < OpenTransit::Models::ResponseWrapper
      OrHash =
        T.type_alias do
          T.any(
            OpenTransit::Models::StopsForAgencyListResponse,
      ...
      sig do
        returns(T::Array[OpenTransit::Models::StopsForAgencyListResponse::List])
      end
      attr_accessor :list
      ...
      sig do
        params(
          ...
          list:
            T::Array[
              OpenTransit::Models::StopsForAgencyListResponse::List::OrHash
            ],
        ...
        override.returns(
          {
            limit_exceeded: T::Boolean,
            list:
              T::Array[OpenTransit::Models::StopsForAgencyListResponse::List],
      ...
      class List < OpenTransit::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              OpenTransit::Models::StopsForAgencyListResponse::List,
              OpenTransit::Internal::AnyHash
            )
          end
