  ...
  module Models
    class SearchForRouteListResponse < OpenTransit::Models::ResponseWrapper
      OrHash =
        T.type_alias do
          T.any(
            OpenTransit::Models::SearchForRouteListResponse,
      ...
      sig do
        returns(
          T.nilable(OpenTransit::Models::SearchForRouteListResponse::Data)
        )
      end
      attr_reader :data
      ...
      sig do
        params(
          data: OpenTransit::Models::SearchForRouteListResponse::Data::OrHash
        ).void
      end
      attr_writer :data
      ...
      sig do
        override.returns(
          { data: OpenTransit::Models::SearchForRouteListResponse::Data }
        )
      end
      def to_hash
      end
      ...
      class Data < OpenTransit::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              OpenTransit::Models::SearchForRouteListResponse::Data,
              OpenTransit::Internal::AnyHash
            )
          end
        ...
        sig do
          returns(
            T::Array[
              OpenTransit::Models::SearchForRouteListResponse::Data::List
            ]
          )
        end
        attr_accessor :list
        ...
        sig do
          params(
            ...
            list:
              T::Array[
                OpenTransit::Models::SearchForRouteListResponse::Data::List::OrHash
              ],
