  ...
  module Models
    class ArrivalAndDepartureListResponse < OpenTransit::Models::ResponseWrapper
      OrHash =
        T.type_alias do
          T.any(
            OpenTransit::Models::ArrivalAndDepartureListResponse,
            OpenTransit::Internal::AnyHash
          )
        end

      sig do
        returns(OpenTransit::Models::ArrivalAndDepartureListResponse::Data)
      end
      attr_reader :data
      ...
      sig do
        params(
          data:
            OpenTransit::Models::ArrivalAndDepartureListResponse::Data::OrHash
        ).void
      end
      attr_writer :data
      ...
      class Data < OpenTransit::Internal::Type::BaseModel
        ...
        sig do
          returns(
            OpenTransit::Models::ArrivalAndDepartureListResponse::Data::Entry
          )
        end
        attr_reader :entry
        ...
        sig do
          params(
            entry:
              OpenTransit::Models::ArrivalAndDepartureListResponse::Data::Entry::OrHash
          ).void
        end
        attr_writer :entry
        ...
        class Entry < OpenTransit::Internal::Type::BaseModel
          ...
          sig do
            params(
              arrivals_and_departures:
                T::Array[
                  OpenTransit::Models::ArrivalAndDepartureListResponse::Data::Entry::ArrivalsAndDeparture::OrHash
                ]
            ).returns(T.attached_class)
          end
          ...
          class ArrivalsAndDeparture < OpenTransit::Internal::Type::BaseModel
            ...
            sig do
              params(
                trip_status:
                  OpenTransit::Models::ArrivalAndDepartureListResponse::Data::Entry::ArrivalsAndDeparture::TripStatus::OrHash
              ).void
            end
            ...
            class TripStatus < OpenTransit::Internal::Type::BaseModel
              ...
              sig do
                params(
                  last_known_location:
                    OpenTransit::Models::ArrivalAndDepartureListResponse::Data::Entry::ArrivalsAndDeparture::TripStatus::LastKnownLocation::OrHash
                ).void
              end
              ...
              sig do
                params(
                  position:
                    OpenTransit::Models::ArrivalAndDepartureListResponse::Data::Entry::ArrivalsAndDeparture::TripStatus::Position::OrHash
                ).void
              end
