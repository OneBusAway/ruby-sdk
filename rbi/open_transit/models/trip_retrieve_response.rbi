  ...
  module Models
    class TripRetrieveResponse < OpenTransit::Models::ResponseWrapper
      OrHash =
        T.type_alias do
          T.any(
            OpenTransit::Models::TripRetrieveResponse,
      ...
      sig do
        params(
          data: OpenTransit::Models::TripRetrieveResponse::Data::OrHash
        ).void
      end
      attr_writer :data
      ...
      sig do
        override.returns(
          { data: OpenTransit::Models::TripRetrieveResponse::Data }
        )
      end
      def to_hash
      end
      ...
      class Data < OpenTransit::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              OpenTransit::Models::TripRetrieveResponse::Data,
              OpenTransit::Internal::AnyHash
            )
          end
        ...
        sig do
          params(
            entry:
              OpenTransit::Models::TripRetrieveResponse::Data::Entry::OrHash
          ).void
        end
        attr_writer :entry
        ...
        class Entry < OpenTransit::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                OpenTransit::Models::TripRetrieveResponse::Data::Entry,
                OpenTransit::Internal::AnyHash
              )
            end
