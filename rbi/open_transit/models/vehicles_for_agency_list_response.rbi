  ...
  module Models
    class VehiclesForAgencyListResponse < OpenTransit::Models::ResponseWrapper
      OrHash =
        T.type_alias do
          T.any(
            OpenTransit::Models::VehiclesForAgencyListResponse,
      ...
      sig do
        params(
          data: OpenTransit::Models::VehiclesForAgencyListResponse::Data::OrHash
        ).void
      end
      attr_writer :data
      ...
      sig do
        override.returns(
          { data: OpenTransit::Models::VehiclesForAgencyListResponse::Data }
        )
      end
      def to_hash
      end
      ...
      class Data < OpenTransit::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              OpenTransit::Models::VehiclesForAgencyListResponse::Data,
              OpenTransit::Internal::AnyHash
            )
          end
        ...
        sig do
          returns(
            T::Array[
              OpenTransit::Models::VehiclesForAgencyListResponse::Data::List
            ]
          )
        end
        attr_accessor :list
        ...
        sig do
          params(
            ...
            list:
              T::Array[
                OpenTransit::Models::VehiclesForAgencyListResponse::Data::List::OrHash
              ],
        ...
        class List < OpenTransit::Internal::Type::BaseModel
          ...
          sig do
            returns(
              OpenTransit::Models::VehiclesForAgencyListResponse::Data::List::Location
            )
          end
          ...
          sig do
            params(
              location:
                OpenTransit::Models::VehiclesForAgencyListResponse::Data::List::Location::OrHash
            ).void
          end
          ...
          sig do
            params(
              trip_status:
                OpenTransit::Models::VehiclesForAgencyListResponse::Data::List::TripStatus::OrHash
            ).void
          end
          ...
          class TripStatus < OpenTransit::Internal::Type::BaseModel
            ...
            sig do
              params(
                last_known_location:
                  OpenTransit::Models::VehiclesForAgencyListResponse::Data::List::TripStatus::LastKnownLocation::OrHash
              ).void
            end
            ...
            sig do
              params(
                position:
                  OpenTransit::Models::VehiclesForAgencyListResponse::Data::List::TripStatus::Position::OrHash
              ).void
            end
