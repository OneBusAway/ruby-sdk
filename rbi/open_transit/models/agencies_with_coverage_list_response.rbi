...
module OpenTransit
  module Models
    class AgenciesWithCoverageListResponse < OpenTransit::Models::ResponseWrapper
      ...
      sig do
        returns(OpenTransit::Models::AgenciesWithCoverageListResponse::Data)
      end
      attr_reader :data
      ...
      sig do
        params(
          data:
            OpenTransit::Models::AgenciesWithCoverageListResponse::Data::OrHash
        ).void
      end
      attr_writer :data
      ...
      sig do
        override.returns(
          { data: OpenTransit::Models::AgenciesWithCoverageListResponse::Data }
        )
      end
      def to_hash
      end
      ...
      class Data < OpenTransit::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              OpenTransit::Models::AgenciesWithCoverageListResponse::Data,
              OpenTransit::Internal::AnyHash
            )
          end
        ...
        sig do
          returns(
            T::Array[
              OpenTransit::Models::AgenciesWithCoverageListResponse::Data::List
            ]
          )
        end
        attr_accessor :list
        ...
        sig do
          params(
            ...
            list:
              T::Array[
                OpenTransit::Models::AgenciesWithCoverageListResponse::Data::List::OrHash
              ],
