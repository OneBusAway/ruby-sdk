  ...
  module Models
    class ArrivalAndDepartureRetrieveResponse < OpenTransit::Models::ResponseWrapper
      OrHash =
        T.type_alias do
          T.any(
            OpenTransit::Models::ArrivalAndDepartureRetrieveResponse,
            OpenTransit::Internal::AnyHash
          )
        end

      sig do
        returns(OpenTransit::Models::ArrivalAndDepartureRetrieveResponse::Data)
      end
      attr_reader :data
      ...
      sig do
        params(
          data:
            OpenTransit::Models::ArrivalAndDepartureRetrieveResponse::Data::OrHash
        ).void
      end
      attr_writer :data
      ...
      sig do
        override.returns(
          {
            data: OpenTransit::Models::ArrivalAndDepartureRetrieveResponse::Data
          }
        )
      end
      def to_hash
      ...
      class Data < OpenTransit::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              OpenTransit::Models::ArrivalAndDepartureRetrieveResponse::Data,
              OpenTransit::Internal::AnyHash
            )
          end
        ...
        sig do
          returns(
            OpenTransit::Models::ArrivalAndDepartureRetrieveResponse::Data::Entry
          )
        end
        attr_reader :entry
        ...
        sig do
          params(
            entry:
              OpenTransit::Models::ArrivalAndDepartureRetrieveResponse::Data::Entry::OrHash
          ).void
        end
        attr_writer :entry
        ...
        class Entry < OpenTransit::Internal::Type::BaseModel
          ...
          sig do
            params(
              trip_status:
                OpenTransit::Models::ArrivalAndDepartureRetrieveResponse::Data::Entry::TripStatus::OrHash
            ).void
          end
          ...
          class TripStatus < OpenTransit::Internal::Type::BaseModel
            ...
            sig do
              params(
                last_known_location:
                  OpenTransit::Models::ArrivalAndDepartureRetrieveResponse::Data::Entry::TripStatus::LastKnownLocation::OrHash
              ).void
            end
            ...
            sig do
              params(
                position:
                  OpenTransit::Models::ArrivalAndDepartureRetrieveResponse::Data::Entry::TripStatus::Position::OrHash
              ).void
            end
