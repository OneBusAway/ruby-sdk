...
module OpenTransit
  module Models
    class ConfigRetrieveResponse < OpenTransit::Models::ResponseWrapper
      ...
      sig do
        params(
          data: OpenTransit::Models::ConfigRetrieveResponse::Data::OrHash
        ).void
      end
      attr_writer :data
      ...
      sig do
        override.returns(
          { data: OpenTransit::Models::ConfigRetrieveResponse::Data }
        )
      end
      def to_hash
      end
      ...
      class Data < OpenTransit::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              OpenTransit::Models::ConfigRetrieveResponse::Data,
              OpenTransit::Internal::AnyHash
            )
          end

        sig do
          returns(OpenTransit::Models::ConfigRetrieveResponse::Data::Entry)
        end
        attr_reader :entry
        ...
        sig do
          params(
            entry:
              OpenTransit::Models::ConfigRetrieveResponse::Data::Entry::OrHash
          ).void
        end
        attr_writer :entry
        ...
        class Entry < OpenTransit::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                OpenTransit::Models::ConfigRetrieveResponse::Data::Entry,
                OpenTransit::Internal::AnyHash
              )
            end
          ...
          sig do
            params(
              git_properties:
                OpenTransit::Models::ConfigRetrieveResponse::Data::Entry::GitProperties::OrHash
            ).void
          end
          ...
          class GitProperties < OpenTransit::Internal::Type::BaseModel
            OrHash =
              T.type_alias do
                T.any(
                  OpenTransit::Models::ConfigRetrieveResponse::Data::Entry::GitProperties,
