  ...
  module Models
    class ScheduleForRouteRetrieveResponse < OpenTransit::Models::ResponseWrapper
      OrHash =
        T.type_alias do
          T.any(
            OpenTransit::Models::ScheduleForRouteRetrieveResponse,
            OpenTransit::Internal::AnyHash
          )
        end

      sig do
        returns(OpenTransit::Models::ScheduleForRouteRetrieveResponse::Data)
      end
      attr_reader :data
      ...
      sig do
        params(
          data:
            OpenTransit::Models::ScheduleForRouteRetrieveResponse::Data::OrHash
        ).void
      end
      attr_writer :data
      ...
      sig do
        override.returns(
          { data: OpenTransit::Models::ScheduleForRouteRetrieveResponse::Data }
        )
      end
      def to_hash
      end
      ...
      class Data < OpenTransit::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              OpenTransit::Models::ScheduleForRouteRetrieveResponse::Data,
              OpenTransit::Internal::AnyHash
            )
          end
        ...
        sig do
          returns(
            OpenTransit::Models::ScheduleForRouteRetrieveResponse::Data::Entry
          )
        end
        attr_reader :entry
        ...
        sig do
          params(
            entry:
              OpenTransit::Models::ScheduleForRouteRetrieveResponse::Data::Entry::OrHash
          ).void
        end
        attr_writer :entry
        ...
        class Entry < OpenTransit::Internal::Type::BaseModel
          ...
          sig do
            returns(
              T::Array[
                OpenTransit::Models::ScheduleForRouteRetrieveResponse::Data::Entry::Stop
              ]
            )
          end
          attr_accessor :stops
          ...
          sig do
            returns(
              T::Array[
                OpenTransit::Models::ScheduleForRouteRetrieveResponse::Data::Entry::StopTripGrouping
              ]
            )
          end
          ...
          sig do
            returns(
              T::Array[
                OpenTransit::Models::ScheduleForRouteRetrieveResponse::Data::Entry::Trip
              ]
            )
          end
          attr_accessor :trips
          ...
          sig do
            params(
              ...
              stops:
                T::Array[
                  OpenTransit::Models::ScheduleForRouteRetrieveResponse::Data::Entry::Stop::OrHash
                ],
              stop_trip_groupings:
                T::Array[
                  OpenTransit::Models::ScheduleForRouteRetrieveResponse::Data::Entry::StopTripGrouping::OrHash
                ],
              trips:
                T::Array[
                  OpenTransit::Models::ScheduleForRouteRetrieveResponse::Data::Entry::Trip::OrHash
                ]
            ).returns(T.attached_class)
          end
          def self.new(
          ...
          class StopTripGrouping < OpenTransit::Internal::Type::BaseModel
            ...
            sig do
              returns(
                T.nilable(
                  T::Array[
                    OpenTransit::Models::ScheduleForRouteRetrieveResponse::Data::Entry::StopTripGrouping::TripsWithStopTime
                  ]
                )
              )
            end
            ...
            sig do
              params(
                trips_with_stop_times:
                  T::Array[
                    OpenTransit::Models::ScheduleForRouteRetrieveResponse::Data::Entry::StopTripGrouping::TripsWithStopTime::OrHash
                  ]
              ).void
            end
            ...
            class TripsWithStopTime < OpenTransit::Internal::Type::BaseModel
              ...
              sig do
                params(
                  stop_times:
                    T::Array[
                      OpenTransit::Models::ScheduleForRouteRetrieveResponse::Data::Entry::StopTripGrouping::TripsWithStopTime::StopTime::OrHash
                    ],
                  trip_id: String
                ).returns(T.attached_class)
              end
