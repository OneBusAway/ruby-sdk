  ...
  module Models
    class AgencyRetrieveResponse < OpenTransit::Models::ResponseWrapper
      OrHash =
        T.type_alias do
          T.any(
            OpenTransit::Models::AgencyRetrieveResponse,
      ...
      sig do
        params(
          data: OpenTransit::Models::AgencyRetrieveResponse::Data::OrHash
        ).void
      end
      attr_writer :data
      ...
      sig do
        override.returns(
          { data: OpenTransit::Models::AgencyRetrieveResponse::Data }
        )
      end
      def to_hash
      end
      ...
      class Data < OpenTransit::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              OpenTransit::Models::AgencyRetrieveResponse::Data,
              OpenTransit::Internal::AnyHash
            )
          end

        sig do
          returns(OpenTransit::Models::AgencyRetrieveResponse::Data::Entry)
        end
        attr_reader :entry
        ...
        sig do
          params(
            entry:
              OpenTransit::Models::AgencyRetrieveResponse::Data::Entry::OrHash
          ).void
        end
        attr_writer :entry
        ...
        class Entry < OpenTransit::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                OpenTransit::Models::AgencyRetrieveResponse::Data::Entry,
                OpenTransit::Internal::AnyHash
              )
            end
