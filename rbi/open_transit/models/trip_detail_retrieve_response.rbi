  ...
  module Models
    class TripDetailRetrieveResponse < OpenTransit::Models::ResponseWrapper
      OrHash =
        T.type_alias do
          T.any(
            OpenTransit::Models::TripDetailRetrieveResponse,
      ...
      sig do
        params(
          data: OpenTransit::Models::TripDetailRetrieveResponse::Data::OrHash
        ).void
      end
      attr_writer :data
      ...
      class Data < OpenTransit::Internal::Type::BaseModel
        ...
        sig do
          returns(OpenTransit::Models::TripDetailRetrieveResponse::Data::Entry)
        end
        attr_reader :entry
        ...
        sig do
          params(
            entry:
              OpenTransit::Models::TripDetailRetrieveResponse::Data::Entry::OrHash
          ).void
        end
        attr_writer :entry
        ...
        sig do
          override.returns(
            {
              entry:
                OpenTransit::Models::TripDetailRetrieveResponse::Data::Entry,
        ...
        class Entry < OpenTransit::Internal::Type::BaseModel
          ...
          sig do
            params(
              schedule:
                OpenTransit::Models::TripDetailRetrieveResponse::Data::Entry::Schedule::OrHash
            ).void
          end
          ...
          sig do
            params(
              status:
                OpenTransit::Models::TripDetailRetrieveResponse::Data::Entry::Status::OrHash
            ).void
          end
          attr_writer :status
          ...
          class Schedule < OpenTransit::Internal::Type::BaseModel
            ...
            sig do
              returns(
                T::Array[
                  OpenTransit::Models::TripDetailRetrieveResponse::Data::Entry::Schedule::StopTime
                ]
              )
            end
            ...
            sig do
              params(
                ...
                stop_times:
                  T::Array[
                    OpenTransit::Models::TripDetailRetrieveResponse::Data::Entry::Schedule::StopTime::OrHash
                  ],
                time_zone: String,
                frequency: T.nilable(String)
              ).returns(T.attached_class)
          ...
          class Status < OpenTransit::Internal::Type::BaseModel
            ...
            sig do
              params(
                last_known_location:
                  OpenTransit::Models::TripDetailRetrieveResponse::Data::Entry::Status::LastKnownLocation::OrHash
              ).void
            end
            ...
            sig do
              params(
                position:
                  OpenTransit::Models::TripDetailRetrieveResponse::Data::Entry::Status::Position::OrHash
              ).void
            end
