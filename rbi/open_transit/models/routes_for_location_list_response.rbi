  ...
  module Models
    class RoutesForLocationListResponse < OpenTransit::Models::ResponseWrapper
      OrHash =
        T.type_alias do
          T.any(
            OpenTransit::Models::RoutesForLocationListResponse,
      ...
      sig do
        params(
          data: OpenTransit::Models::RoutesForLocationListResponse::Data::OrHash
        ).void
      end
      attr_writer :data
      ...
      sig do
        override.returns(
          { data: OpenTransit::Models::RoutesForLocationListResponse::Data }
        )
      end
      def to_hash
      end
      ...
      class Data < OpenTransit::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              OpenTransit::Models::RoutesForLocationListResponse::Data,
              OpenTransit::Internal::AnyHash
            )
          end
        ...
        sig do
          returns(
            T::Array[
              OpenTransit::Models::RoutesForLocationListResponse::Data::List
            ]
          )
        end
        attr_accessor :list
        ...
        sig do
          params(
            ...
            list:
              T::Array[
                OpenTransit::Models::RoutesForLocationListResponse::Data::List::OrHash
              ],
