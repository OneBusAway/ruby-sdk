  ...
  module Models
    class TripsForRouteListResponse < OpenTransit::Models::ResponseWrapper
      OrHash =
        T.type_alias do
          T.any(
            OpenTransit::Models::TripsForRouteListResponse,
      ...
      sig do
        params(
          data: OpenTransit::Models::TripsForRouteListResponse::Data::OrHash
        ).void
      end
      attr_writer :data
      ...
      sig do
        override.returns(
          { data: OpenTransit::Models::TripsForRouteListResponse::Data }
        )
      end
      def to_hash
      end
      ...
      class Data < OpenTransit::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              OpenTransit::Models::TripsForRouteListResponse::Data,
              OpenTransit::Internal::AnyHash
            )
          end
        ...
        sig do
          returns(
            T::Array[OpenTransit::Models::TripsForRouteListResponse::Data::List]
          )
        end
        attr_accessor :list
        ...
        sig do
          params(
            ...
            list:
              T::Array[
                OpenTransit::Models::TripsForRouteListResponse::Data::List::OrHash
              ],
          ...
          override.returns(
            {
              ...
              list:
                T::Array[
                  OpenTransit::Models::TripsForRouteListResponse::Data::List
                ],
        ...
        class List < OpenTransit::Internal::Type::BaseModel
          ...
          sig do
            returns(
              OpenTransit::Models::TripsForRouteListResponse::Data::List::Schedule
            )
          end
          ...
          sig do
            params(
              schedule:
                OpenTransit::Models::TripsForRouteListResponse::Data::List::Schedule::OrHash
            ).void
          end
          ...
          sig do
            returns(
              OpenTransit::Models::TripsForRouteListResponse::Data::List::Status
            )
          end
          attr_reader :status
          ...
          sig do
            params(
              status:
                OpenTransit::Models::TripsForRouteListResponse::Data::List::Status::OrHash
            ).void
          end
          attr_writer :status
          ...
          class Schedule < OpenTransit::Internal::Type::BaseModel
            ...
            sig do
              returns(
                T::Array[
                  OpenTransit::Models::TripsForRouteListResponse::Data::List::Schedule::StopTime
                ]
              )
            end
            ...
            sig do
              params(
                ...
                stop_times:
                  T::Array[
                    OpenTransit::Models::TripsForRouteListResponse::Data::List::Schedule::StopTime::OrHash
                  ],
                time_zone: String,
                frequency: T.nilable(String)
              ).returns(T.attached_class)
          ...
          class Status < OpenTransit::Internal::Type::BaseModel
            ...
            sig do
              params(
                last_known_location:
                  OpenTransit::Models::TripsForRouteListResponse::Data::List::Status::LastKnownLocation::OrHash
              ).void
            end
            ...
            sig do
              params(
                position:
                  OpenTransit::Models::TripsForRouteListResponse::Data::List::Status::Position::OrHash
              ).void
            end
