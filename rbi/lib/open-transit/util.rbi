...
module OpenTransit
  module Util
    ...
    sig { params(url: T.any(URI::Generic, String)).returns(OpenTransit::Util::ParsedUriShape) }
    def self.parse_uri(url)
    end

    sig { params(parsed: OpenTransit::Util::ParsedUriShape).returns(URI::Generic) }
    def self.unparse_uri(parsed)
    end

    sig do
      params(
        lhs: OpenTransit::Util::ParsedUriShape,
        rhs: OpenTransit::Util::ParsedUriShape
      ).returns(URI::Generic)
    end
