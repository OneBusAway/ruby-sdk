...
module OpenTransit
  class BaseClient
    ...
    RequestShape = T.type_alias do
      {
        ...
        page: T.nilable(T::Class[OpenTransit::BaseModel]),
        model: T.nilable(OpenTransit::Converter::Input),
        options: T.nilable(T.any(OpenTransit::RequestOptions, T::Hash[Symbol, T.anything]))
      }
    end
    ...
    sig { params(req: OpenTransit::BaseClient::RequestShape).void }
    ...
    sig do
      params(
        req: OpenTransit::BaseClient::RequestShape,
        opts: T::Hash[Symbol, T.anything]
      ).returns(OpenTransit::BaseClient::NormalizedRequestShape)
    end
    ...
    sig do
      params(
        request: OpenTransit::BaseClient::NormalizedRequestShape,
        status: Integer,
    ...
    sig { params(req: OpenTransit::BaseClient::RequestShape, response: NilClass).returns(T.anything) }
