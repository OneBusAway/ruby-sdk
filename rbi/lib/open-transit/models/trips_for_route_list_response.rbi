...
module OpenTransit
  module Models
    class TripsForRouteListResponse < OpenTransit::Models::ResponseWrapper
      sig { returns(OpenTransit::Models::TripsForRouteListResponse::Data) }
      attr_accessor :data

      sig { params(data: OpenTransit::Models::TripsForRouteListResponse::Data).void }
      def initialize(data:)
      end

      sig { override.returns({data: OpenTransit::Models::TripsForRouteListResponse::Data}) }
      def to_hash
      end
      ...
      class Data < OpenTransit::BaseModel
        ...
        sig { returns(T::Array[OpenTransit::Models::TripsForRouteListResponse::Data::List]) }
        attr_accessor :list
        ...
        sig do
          params(
            ...
            list: T::Array[OpenTransit::Models::TripsForRouteListResponse::Data::List],
        ...
        class List < OpenTransit::BaseModel
          sig { returns(OpenTransit::Models::TripsForRouteListResponse::Data::List::Schedule) }
          attr_accessor :schedule

          sig { returns(OpenTransit::Models::TripsForRouteListResponse::Data::List::Status) }
          ...
          class Schedule < OpenTransit::BaseModel
            ...
            sig do
              returns(T::Array[OpenTransit::Models::TripsForRouteListResponse::Data::List::Schedule::StopTime])
            end
            ...
            sig do
              params(
                ...
                stop_times: T::Array[OpenTransit::Models::TripsForRouteListResponse::Data::List::Schedule::StopTime],
                time_zone: String,
                frequency: T.nilable(String)
              ).void
            end
          ...
          class Status < OpenTransit::BaseModel
            ...
            sig do
              returns(T.nilable(OpenTransit::Models::TripsForRouteListResponse::Data::List::Status::LastKnownLocation))
            end
            attr_reader :last_known_location

            sig do
              params(
                last_known_location: OpenTransit::Models::TripsForRouteListResponse::Data::List::Status::LastKnownLocation
              ).void
            end
            ...
            sig do
              returns(T.nilable(OpenTransit::Models::TripsForRouteListResponse::Data::List::Status::Position))
            end
            attr_reader :position

            sig do
              params(position: OpenTransit::Models::TripsForRouteListResponse::Data::List::Status::Position).void
            end
            ...
            sig do
              params(
                ...
                orientation: Float,
                position: OpenTransit::Models::TripsForRouteListResponse::Data::List::Status::Position,
