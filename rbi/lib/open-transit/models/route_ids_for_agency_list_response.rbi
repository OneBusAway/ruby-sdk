...
module OpenTransit
  module Models
    class RouteIDsForAgencyListResponse < OpenTransit::Models::ResponseWrapper
      ...
      sig { params(data: OpenTransit::Models::RouteIDsForAgencyListResponse::Data).void }
      def initialize(data:)
      end

      sig { override.returns({data: OpenTransit::Models::RouteIDsForAgencyListResponse::Data}) }
      def to_hash
      end
