...
module OpenTransit
  module Models
    class TripDetailRetrieveResponse < OpenTransit::Models::ResponseWrapper
      sig { returns(OpenTransit::Models::TripDetailRetrieveResponse::Data) }
      attr_accessor :data

      sig { params(data: OpenTransit::Models::TripDetailRetrieveResponse::Data).void }
      def initialize(data:)
      end

      sig { override.returns({data: OpenTransit::Models::TripDetailRetrieveResponse::Data}) }
      def to_hash
      end

      class Data < OpenTransit::BaseModel
        sig { returns(OpenTransit::Models::TripDetailRetrieveResponse::Data::Entry) }
        attr_accessor :entry
        ...
        class Entry < OpenTransit::BaseModel
          ...
          sig { returns(T.nilable(OpenTransit::Models::TripDetailRetrieveResponse::Data::Entry::Schedule)) }
          attr_reader :schedule

          sig do
            params(schedule: OpenTransit::Models::TripDetailRetrieveResponse::Data::Entry::Schedule).void
          end
          ...
          sig { returns(T.nilable(OpenTransit::Models::TripDetailRetrieveResponse::Data::Entry::Status)) }
          attr_reader :status

          sig { params(status: OpenTransit::Models::TripDetailRetrieveResponse::Data::Entry::Status).void }
          attr_writer :status
          ...
          class Schedule < OpenTransit::BaseModel
            ...
            sig do
              returns(T::Array[OpenTransit::Models::TripDetailRetrieveResponse::Data::Entry::Schedule::StopTime])
            end
            ...
            sig do
              params(
                ...
                stop_times: T::Array[OpenTransit::Models::TripDetailRetrieveResponse::Data::Entry::Schedule::StopTime],
                time_zone: String,
                frequency: T.nilable(String)
              ).void
            end
          ...
          class Status < OpenTransit::BaseModel
            ...
            sig do
              returns(T.nilable(OpenTransit::Models::TripDetailRetrieveResponse::Data::Entry::Status::LastKnownLocation))
            end
            ...
            sig do
              returns(T.nilable(OpenTransit::Models::TripDetailRetrieveResponse::Data::Entry::Status::Position))
            end
            attr_reader :position

            sig do
              params(position: OpenTransit::Models::TripDetailRetrieveResponse::Data::Entry::Status::Position).void
            end
