...
module OpenTransit
  module Models
    class TripForVehicleRetrieveResponse < OpenTransit::Models::ResponseWrapper
      sig { returns(OpenTransit::Models::TripForVehicleRetrieveResponse::Data) }
      attr_accessor :data

      sig { params(data: OpenTransit::Models::TripForVehicleRetrieveResponse::Data).void }
      def initialize(data:)
      end

      sig { override.returns({data: OpenTransit::Models::TripForVehicleRetrieveResponse::Data}) }
      def to_hash
      end

      class Data < OpenTransit::BaseModel
        sig { returns(OpenTransit::Models::TripForVehicleRetrieveResponse::Data::Entry) }
        attr_accessor :entry
        ...
        class Entry < OpenTransit::BaseModel
          ...
          sig do
            returns(T.nilable(OpenTransit::Models::TripForVehicleRetrieveResponse::Data::Entry::Schedule))
          end
          attr_reader :schedule

          sig do
            params(schedule: OpenTransit::Models::TripForVehicleRetrieveResponse::Data::Entry::Schedule).void
          end
          ...
          sig { returns(T.nilable(OpenTransit::Models::TripForVehicleRetrieveResponse::Data::Entry::Status)) }
          attr_reader :status

          sig do
            params(status: OpenTransit::Models::TripForVehicleRetrieveResponse::Data::Entry::Status).void
          end
          attr_writer :status
          ...
          sig do
            params(
              ...
              status: OpenTransit::Models::TripForVehicleRetrieveResponse::Data::Entry::Status
            ).void
          end
          def initialize(
            trip_id:,
          ...
          class Schedule < OpenTransit::BaseModel
            ...
            sig do
              returns(T::Array[OpenTransit::Models::TripForVehicleRetrieveResponse::Data::Entry::Schedule::StopTime])
            end
            ...
            sig do
              params(
                ...
                stop_times: T::Array[OpenTransit::Models::TripForVehicleRetrieveResponse::Data::Entry::Schedule::StopTime],
                time_zone: String,
                frequency: T.nilable(String)
              ).void
            end
          ...
          class Status < OpenTransit::BaseModel
            ...
            sig do
              returns(T.nilable(OpenTransit::Models::TripForVehicleRetrieveResponse::Data::Entry::Status::LastKnownLocation))
            end
            attr_reader :last_known_location

            sig do
              params(
                last_known_location: OpenTransit::Models::TripForVehicleRetrieveResponse::Data::Entry::Status::LastKnownLocation
              ).void
            end
            ...
            sig do
              returns(T.nilable(OpenTransit::Models::TripForVehicleRetrieveResponse::Data::Entry::Status::Position))
            end
            attr_reader :position

            sig do
              params(position: OpenTransit::Models::TripForVehicleRetrieveResponse::Data::Entry::Status::Position).void
            end
            ...
            sig do
              params(
                ...
                orientation: Float,
                position: OpenTransit::Models::TripForVehicleRetrieveResponse::Data::Entry::Status::Position,
