...
module OpenTransit
  module Models
    class References < OpenTransit::BaseModel
      sig { returns(T::Array[OpenTransit::Models::References::Agency]) }
      attr_accessor :agencies

      sig { returns(T::Array[OpenTransit::Models::References::Route]) }
      attr_accessor :routes

      sig { returns(T::Array[OpenTransit::Models::References::Situation]) }
      attr_accessor :situations

      sig { returns(T::Array[OpenTransit::Models::References::Stop]) }
      attr_accessor :stops

      sig { returns(T::Array[OpenTransit::Models::References::StopTime]) }
      attr_accessor :stop_times

      sig { returns(T::Array[OpenTransit::Models::References::Trip]) }
      attr_accessor :trips

      sig do
        params(
          agencies: T::Array[OpenTransit::Models::References::Agency],
          routes: T::Array[OpenTransit::Models::References::Route],
          situations: T::Array[OpenTransit::Models::References::Situation],
          stops: T::Array[OpenTransit::Models::References::Stop],
          stop_times: T::Array[OpenTransit::Models::References::StopTime],
          trips: T::Array[OpenTransit::Models::References::Trip]
        ).void
      end
      ...
      class Situation < OpenTransit::BaseModel
        ...
        sig { returns(T.nilable(T::Array[OpenTransit::Models::References::Situation::ActiveWindow])) }
        attr_reader :active_windows

        sig do
          params(active_windows: T::Array[OpenTransit::Models::References::Situation::ActiveWindow]).void
        end
        attr_writer :active_windows

        sig { returns(T.nilable(T::Array[OpenTransit::Models::References::Situation::AllAffect])) }
        attr_reader :all_affects

        sig { params(all_affects: T::Array[OpenTransit::Models::References::Situation::AllAffect]).void }
        ...
        sig { returns(T.nilable(T::Array[OpenTransit::Models::References::Situation::Consequence])) }
        attr_reader :consequences

        sig { params(consequences: T::Array[OpenTransit::Models::References::Situation::Consequence]).void }
        attr_writer :consequences

        sig { returns(T.nilable(OpenTransit::Models::References::Situation::Description)) }
        attr_reader :description

        sig { params(description: OpenTransit::Models::References::Situation::Description).void }
        attr_writer :description

        sig { returns(T.nilable(T::Array[OpenTransit::Models::References::Situation::PublicationWindow])) }
        attr_reader :publication_windows

        sig do
          params(publication_windows: T::Array[OpenTransit::Models::References::Situation::PublicationWindow]).void
        end
        ...
        sig { returns(T.nilable(OpenTransit::Models::References::Situation::Summary)) }
        attr_reader :summary

        sig { params(summary: OpenTransit::Models::References::Situation::Summary).void }
        attr_writer :summary

        sig { returns(T.nilable(OpenTransit::Models::References::Situation::URL)) }
        attr_reader :url

        sig { params(url: OpenTransit::Models::References::Situation::URL).void }
        attr_writer :url
        ...
        sig do
          params(
            ...
            active_windows: T::Array[OpenTransit::Models::References::Situation::ActiveWindow],
            all_affects: T::Array[OpenTransit::Models::References::Situation::AllAffect],
            consequence_message: String,
            consequences: T::Array[OpenTransit::Models::References::Situation::Consequence],
            description: OpenTransit::Models::References::Situation::Description,
            publication_windows: T::Array[OpenTransit::Models::References::Situation::PublicationWindow],
            reason: Symbol,
            severity: String,
            summary: OpenTransit::Models::References::Situation::Summary,
            url: OpenTransit::Models::References::Situation::URL
          ).void
        end
        def initialize(
          id:,
        ...
        class Consequence < OpenTransit::BaseModel
          ...
          sig do
            returns(T.nilable(OpenTransit::Models::References::Situation::Consequence::ConditionDetails))
          end
          attr_reader :condition_details

          sig do
            params(condition_details: OpenTransit::Models::References::Situation::Consequence::ConditionDetails).void
          end
          ...
          class ConditionDetails < OpenTransit::BaseModel
            sig do
              returns(T.nilable(OpenTransit::Models::References::Situation::Consequence::ConditionDetails::DiversionPath))
            end
            ...
            sig do
              override.returns(
                {
                  diversion_path: OpenTransit::Models::References::Situation::Consequence::ConditionDetails::DiversionPath, diversion_stop_ids: T::Array[String]
                }
              )
            end
            def to_hash
