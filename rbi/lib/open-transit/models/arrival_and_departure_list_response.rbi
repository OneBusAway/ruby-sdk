...
module OpenTransit
  module Models
    class ArrivalAndDepartureListResponse < OpenTransit::Models::ResponseWrapper
      sig { returns(OpenTransit::Models::ArrivalAndDepartureListResponse::Data) }
      attr_accessor :data

      sig { params(data: OpenTransit::Models::ArrivalAndDepartureListResponse::Data).void }
      def initialize(data:)
      end

      sig { override.returns({data: OpenTransit::Models::ArrivalAndDepartureListResponse::Data}) }
      def to_hash
      end

      class Data < OpenTransit::BaseModel
        sig { returns(OpenTransit::Models::ArrivalAndDepartureListResponse::Data::Entry) }
        attr_accessor :entry
        ...
        class Entry < OpenTransit::BaseModel
          sig do
            returns(T::Array[OpenTransit::Models::ArrivalAndDepartureListResponse::Data::Entry::ArrivalsAndDeparture])
          end
          attr_accessor :arrivals_and_departures

          sig do
            params(
              arrivals_and_departures: T::Array[OpenTransit::Models::ArrivalAndDepartureListResponse::Data::Entry::ArrivalsAndDeparture]
            ).void
          end
          ...
          sig do
            override.returns({arrivals_and_departures: T::Array[OpenTransit::Models::ArrivalAndDepartureListResponse::Data::Entry::ArrivalsAndDeparture]})
          end
          def to_hash
          end
          ...
          class ArrivalsAndDeparture < OpenTransit::BaseModel
            ...
            sig do
              returns(T.nilable(OpenTransit::Models::ArrivalAndDepartureListResponse::Data::Entry::ArrivalsAndDeparture::TripStatus))
            end
            ...
            class TripStatus < OpenTransit::BaseModel
              ...
              sig do
                returns(T.nilable(OpenTransit::Models::ArrivalAndDepartureListResponse::Data::Entry::ArrivalsAndDeparture::TripStatus::LastKnownLocation))
              end
              ...
              sig do
                returns(T.nilable(OpenTransit::Models::ArrivalAndDepartureListResponse::Data::Entry::ArrivalsAndDeparture::TripStatus::Position))
              end
