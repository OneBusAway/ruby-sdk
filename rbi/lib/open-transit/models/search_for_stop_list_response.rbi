...
module OpenTransit
  module Models
    class SearchForStopListResponse < OpenTransit::Models::ResponseWrapper
      sig { returns(T.nilable(OpenTransit::Models::SearchForStopListResponse::Data)) }
      attr_reader :data

      sig { params(data: OpenTransit::Models::SearchForStopListResponse::Data).void }
      attr_writer :data
      ...
      sig { override.returns({data: OpenTransit::Models::SearchForStopListResponse::Data}) }
      def to_hash
      end
      ...
      class Data < OpenTransit::BaseModel
        ...
        sig { returns(T::Array[OpenTransit::Models::SearchForStopListResponse::Data::List]) }
        attr_accessor :list
        ...
        sig do
          params(
            ...
            list: T::Array[OpenTransit::Models::SearchForStopListResponse::Data::List],
