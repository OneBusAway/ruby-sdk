...
module OpenTransit
  module Models
    class StopsForLocationListResponse < OpenTransit::Models::ResponseWrapper
      ...
      sig { params(data: OpenTransit::Models::StopsForLocationListResponse::Data).void }
      def initialize(data:)
      end

      sig { override.returns({data: OpenTransit::Models::StopsForLocationListResponse::Data}) }
      def to_hash
      end
      ...
      class Data < OpenTransit::BaseModel
        ...
        sig { returns(T::Array[OpenTransit::Models::StopsForLocationListResponse::Data::List]) }
        attr_accessor :list
        ...
        sig do
          params(
            ...
            list: T::Array[OpenTransit::Models::StopsForLocationListResponse::Data::List],
