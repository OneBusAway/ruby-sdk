...
module OpenTransit
  module Models
    class SearchForRouteListResponse < OpenTransit::Models::ResponseWrapper
      sig { returns(T.nilable(OpenTransit::Models::SearchForRouteListResponse::Data)) }
      attr_reader :data

      sig { params(data: OpenTransit::Models::SearchForRouteListResponse::Data).void }
      attr_writer :data
      ...
      sig { override.returns({data: OpenTransit::Models::SearchForRouteListResponse::Data}) }
      def to_hash
      end
      ...
      class Data < OpenTransit::BaseModel
        ...
        sig { returns(T::Array[OpenTransit::Models::SearchForRouteListResponse::Data::List]) }
        attr_accessor :list
        ...
        sig do
          params(
            ...
            list: T::Array[OpenTransit::Models::SearchForRouteListResponse::Data::List],
