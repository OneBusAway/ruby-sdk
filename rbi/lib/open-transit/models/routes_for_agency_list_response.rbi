...
module OpenTransit
  module Models
    class RoutesForAgencyListResponse < OpenTransit::Models::ResponseWrapper
      ...
      sig { params(data: OpenTransit::Models::RoutesForAgencyListResponse::Data).void }
      def initialize(data:)
      end

      sig { override.returns({data: OpenTransit::Models::RoutesForAgencyListResponse::Data}) }
      def to_hash
      end
      ...
      class Data < OpenTransit::BaseModel
        ...
        sig { returns(T::Array[OpenTransit::Models::RoutesForAgencyListResponse::Data::List]) }
        attr_accessor :list
        ...
        sig do
          params(
            ...
            list: T::Array[OpenTransit::Models::RoutesForAgencyListResponse::Data::List],
