...
module OpenTransit
  module Models
    class ArrivalAndDepartureRetrieveResponse < OpenTransit::Models::ResponseWrapper
      sig { returns(OpenTransit::Models::ArrivalAndDepartureRetrieveResponse::Data) }
      attr_accessor :data

      sig { params(data: OpenTransit::Models::ArrivalAndDepartureRetrieveResponse::Data).void }
      def initialize(data:)
      end

      sig { override.returns({data: OpenTransit::Models::ArrivalAndDepartureRetrieveResponse::Data}) }
      def to_hash
      end

      class Data < OpenTransit::BaseModel
        sig { returns(OpenTransit::Models::ArrivalAndDepartureRetrieveResponse::Data::Entry) }
        attr_accessor :entry
        ...
        class Entry < OpenTransit::BaseModel
          ...
          sig do
            returns(T.nilable(OpenTransit::Models::ArrivalAndDepartureRetrieveResponse::Data::Entry::TripStatus))
          end
          attr_reader :trip_status

          sig do
            params(trip_status: OpenTransit::Models::ArrivalAndDepartureRetrieveResponse::Data::Entry::TripStatus).void
          end
          ...
          sig do
            params(
              ...
              status: String,
              trip_status: OpenTransit::Models::ArrivalAndDepartureRetrieveResponse::Data::Entry::TripStatus
            ).void
          end
          def initialize(
            arrival_enabled:,
          ...
          class TripStatus < OpenTransit::BaseModel
            ...
            sig do
              returns(T.nilable(OpenTransit::Models::ArrivalAndDepartureRetrieveResponse::Data::Entry::TripStatus::LastKnownLocation))
            end
            attr_reader :last_known_location

            sig do
              params(
                last_known_location: OpenTransit::Models::ArrivalAndDepartureRetrieveResponse::Data::Entry::TripStatus::LastKnownLocation
              ).void
            end
            ...
            sig do
              returns(T.nilable(OpenTransit::Models::ArrivalAndDepartureRetrieveResponse::Data::Entry::TripStatus::Position))
            end
            attr_reader :position

            sig do
              params(
                position: OpenTransit::Models::ArrivalAndDepartureRetrieveResponse::Data::Entry::TripStatus::Position
              ).void
            end
