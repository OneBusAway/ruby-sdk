...
module OpenTransit
  module Converter
    ...
    Input = T.type_alias { T.any(OpenTransit::Converter, T::Class[T.anything]) }
        ...
        spec: T.any(
          {
            ...
            enum: T.nilable(T.proc.returns(OpenTransit::Converter::Input)),
            union: T.nilable(T.proc.returns(OpenTransit::Converter::Input))
          },
          T.proc.returns(OpenTransit::Converter::Input),
          OpenTransit::Converter::Input
        )
    ...
    sig { params(target: OpenTransit::Converter::Input, value: T.anything).returns(T.anything) }
  ...
  class Union
    ...
    sig { params(value: T.anything).returns(T.nilable(OpenTransit::Converter::Input)) }
  ...
  class ArrayOf
    ...
    sig { returns(OpenTransit::Converter::Input) }
  ...
  class BaseModel
    ...
    sig do
      returns(
        T::Hash[Symbol,
                T.all(
                  OpenTransit::BaseModel::KnownFieldShape,
                  {type_fn: T.proc.returns(OpenTransit::Converter::Input)}
                )]
      )
    end
    ...
    sig do
      returns(
        T::Hash[Symbol,
                T.all(OpenTransit::BaseModel::KnownFieldShape, {type: OpenTransit::Converter::Input})]
      )
    end
    def self.fields
    end
