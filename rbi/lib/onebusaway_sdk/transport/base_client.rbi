...
module OnebusawaySDK
  module Transport
    ...
    class BaseClient
        ...
        T.type_alias do
          {
            ...
            page: T.nilable(T::Class[OnebusawaySDK::Type::BasePage[OnebusawaySDK::BaseModel]]),
            stream: T.nilable(T::Class[T.anything]),
            model: T.nilable(OnebusawaySDK::Type::Converter::Input),
      ...
      class << self
        # @api private
        sig { params(req: OnebusawaySDK::Transport::BaseClient::RequestComponentsShape).void }
        def validate!(req)
        end
        ...
        sig do
          params(
            request: OnebusawaySDK::Transport::BaseClient::RequestInputShape,
            status: Integer,
            response_headers: T.any(T::Hash[String, String], Net::HTTPHeader)
          )
            .returns(OnebusawaySDK::Transport::BaseClient::RequestInputShape)
        end
      ...
      # @api private
      sig { returns(OnebusawaySDK::Transport::PooledNetRequester) }
      ...
      sig do
        overridable
          .params(
            req: OnebusawaySDK::Transport::BaseClient::RequestComponentsShape,
            opts: OnebusawaySDK::Util::AnyHash
          )
          .returns(OnebusawaySDK::Transport::BaseClient::RequestInputShape)
      end
