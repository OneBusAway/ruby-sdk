...
module OnebusawaySDK
  module Models
    class ShapeRetrieveResponse < OnebusawaySDK::Models::ResponseWrapper
      ...
      sig do
        params(data: T.any(OnebusawaySDK::Models::ShapeRetrieveResponse::Data, OnebusawaySDK::Internal::AnyHash))
          .void
      end
      attr_writer :data
      ...
      class Data < OnebusawaySDK::Internal::Type::BaseModel
        ...
        sig do
          params(
            entry: T.any(OnebusawaySDK::Models::ShapeRetrieveResponse::Data::Entry, OnebusawaySDK::Internal::AnyHash)
          )
            .void
        end
        attr_writer :entry
