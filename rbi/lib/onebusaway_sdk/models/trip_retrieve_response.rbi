...
module OnebusawaySDK
  module Models
    class TripRetrieveResponse < OnebusawaySDK::Models::ResponseWrapper
      ...
      sig do
        params(
          data: T.any(OnebusawaySDK::Models::TripRetrieveResponse::Data, OnebusawaySDK::Internal::Util::AnyHash)
        )
          .void
      end
      attr_writer :data
      ...
      class Data < OnebusawaySDK::BaseModel
        ...
        sig do
          params(
            entry: T.any(OnebusawaySDK::Models::TripRetrieveResponse::Data::Entry, OnebusawaySDK::Internal::Util::AnyHash)
          )
            .void
        end
        attr_writer :entry
