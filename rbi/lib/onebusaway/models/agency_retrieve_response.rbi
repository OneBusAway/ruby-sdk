...
module Onebusaway
  module Models
    class AgencyRetrieveResponse < Onebusaway::Models::ResponseWrapper
      sig { returns(Onebusaway::Models::AgencyRetrieveResponse::Data) }
      attr_accessor :data

      sig { params(data: Onebusaway::Models::AgencyRetrieveResponse::Data).void }
      def initialize(data:)
      end

      sig { override.returns({data: Onebusaway::Models::AgencyRetrieveResponse::Data}) }
      def to_hash
      end

      class Data < Onebusaway::BaseModel
        sig { returns(Onebusaway::Models::AgencyRetrieveResponse::Data::Entry) }
        attr_accessor :entry
