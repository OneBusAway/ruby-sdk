...
module Onebusaway
  module Models
    class ConfigRetrieveResponse < Onebusaway::Models::ResponseWrapper
      sig { returns(Onebusaway::Models::ConfigRetrieveResponse::Data) }
      attr_accessor :data

      sig { params(data: Onebusaway::Models::ConfigRetrieveResponse::Data).void }
      def initialize(data:)
      end

      sig { override.returns({data: Onebusaway::Models::ConfigRetrieveResponse::Data}) }
      def to_hash
      end

      class Data < Onebusaway::BaseModel
        sig { returns(Onebusaway::Models::ConfigRetrieveResponse::Data::Entry) }
        attr_accessor :entry
        ...
        class Entry < Onebusaway::BaseModel
          ...
          sig { returns(T.nilable(Onebusaway::Models::ConfigRetrieveResponse::Data::Entry::GitProperties)) }
          attr_reader :git_properties

          sig do
            params(git_properties: Onebusaway::Models::ConfigRetrieveResponse::Data::Entry::GitProperties).void
          end
