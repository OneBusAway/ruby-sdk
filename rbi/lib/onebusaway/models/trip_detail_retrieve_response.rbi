...
module Onebusaway
  module Models
    class TripDetailRetrieveResponse < Onebusaway::Models::ResponseWrapper
      sig { returns(Onebusaway::Models::TripDetailRetrieveResponse::Data) }
      attr_accessor :data

      sig { params(data: Onebusaway::Models::TripDetailRetrieveResponse::Data).void }
      def initialize(data:)
      end

      sig { override.returns({data: Onebusaway::Models::TripDetailRetrieveResponse::Data}) }
      def to_hash
      end

      class Data < Onebusaway::BaseModel
        sig { returns(Onebusaway::Models::TripDetailRetrieveResponse::Data::Entry) }
        attr_accessor :entry
        ...
        class Entry < Onebusaway::BaseModel
          ...
          sig { returns(T.nilable(Onebusaway::Models::TripDetailRetrieveResponse::Data::Entry::Schedule)) }
          attr_reader :schedule

          sig { params(schedule: Onebusaway::Models::TripDetailRetrieveResponse::Data::Entry::Schedule).void }
          ...
          sig { returns(T.nilable(Onebusaway::Models::TripDetailRetrieveResponse::Data::Entry::Status)) }
          attr_reader :status

          sig { params(status: Onebusaway::Models::TripDetailRetrieveResponse::Data::Entry::Status).void }
          attr_writer :status
          ...
          sig do
            params(
              ...
              status: Onebusaway::Models::TripDetailRetrieveResponse::Data::Entry::Status
            ).void
          end
          def initialize(
            trip_id:,
          ...
          class Schedule < Onebusaway::BaseModel
            ...
            sig do
              returns(T::Array[Onebusaway::Models::TripDetailRetrieveResponse::Data::Entry::Schedule::StopTime])
            end
            ...
            sig do
              params(
                ...
                stop_times: T::Array[Onebusaway::Models::TripDetailRetrieveResponse::Data::Entry::Schedule::StopTime],
                time_zone: String,
                frequency: T.nilable(String)
              ).void
            end
          ...
          class Status < Onebusaway::BaseModel
            ...
            sig do
              returns(T.nilable(Onebusaway::Models::TripDetailRetrieveResponse::Data::Entry::Status::LastKnownLocation))
            end
            attr_reader :last_known_location

            sig do
              params(
                last_known_location: Onebusaway::Models::TripDetailRetrieveResponse::Data::Entry::Status::LastKnownLocation
              ).void
            end
            ...
            sig do
              returns(T.nilable(Onebusaway::Models::TripDetailRetrieveResponse::Data::Entry::Status::Position))
            end
            attr_reader :position

            sig do
              params(position: Onebusaway::Models::TripDetailRetrieveResponse::Data::Entry::Status::Position).void
            end
            ...
            sig do
              params(
                ...
                orientation: Float,
                position: Onebusaway::Models::TripDetailRetrieveResponse::Data::Entry::Status::Position,
