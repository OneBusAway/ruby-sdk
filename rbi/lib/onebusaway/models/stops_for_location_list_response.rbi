...
module Onebusaway
  module Models
    class StopsForLocationListResponse < Onebusaway::Models::ResponseWrapper
      sig { returns(Onebusaway::Models::StopsForLocationListResponse::Data) }
      attr_accessor :data

      sig { params(data: Onebusaway::Models::StopsForLocationListResponse::Data).void }
      def initialize(data:)
      end

      sig { override.returns({data: Onebusaway::Models::StopsForLocationListResponse::Data}) }
      def to_hash
      end
      ...
      class Data < Onebusaway::BaseModel
        ...
        sig { returns(T::Array[Onebusaway::Models::StopsForLocationListResponse::Data::List]) }
        attr_accessor :list
        ...
        sig do
          params(
            ...
            list: T::Array[Onebusaway::Models::StopsForLocationListResponse::Data::List],
