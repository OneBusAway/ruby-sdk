...
module Onebusaway
  module Models
    class SearchForRouteListResponse < Onebusaway::Models::ResponseWrapper
      sig { returns(T.nilable(Onebusaway::Models::SearchForRouteListResponse::Data)) }
      attr_reader :data

      sig { params(data: Onebusaway::Models::SearchForRouteListResponse::Data).void }
      attr_writer :data
      ...
      sig { override.returns({data: Onebusaway::Models::SearchForRouteListResponse::Data}) }
      def to_hash
      end
      ...
      class Data < Onebusaway::BaseModel
        ...
        sig { returns(T::Array[Onebusaway::Models::SearchForRouteListResponse::Data::List]) }
        attr_accessor :list
        ...
        sig do
          params(
            ...
            list: T::Array[Onebusaway::Models::SearchForRouteListResponse::Data::List],
