...
module Onebusaway
  module Models
    class TripsForRouteListResponse < Onebusaway::Models::ResponseWrapper
      sig { returns(Onebusaway::Models::TripsForRouteListResponse::Data) }
      attr_accessor :data

      sig { params(data: Onebusaway::Models::TripsForRouteListResponse::Data).void }
      def initialize(data:)
      end

      sig { override.returns({data: Onebusaway::Models::TripsForRouteListResponse::Data}) }
      def to_hash
      end
      ...
      class Data < Onebusaway::BaseModel
        ...
        sig { returns(T::Array[Onebusaway::Models::TripsForRouteListResponse::Data::List]) }
        attr_accessor :list
        ...
        sig do
          params(
            ...
            list: T::Array[Onebusaway::Models::TripsForRouteListResponse::Data::List],
        ...
        class List < Onebusaway::BaseModel
          sig { returns(Onebusaway::Models::TripsForRouteListResponse::Data::List::Schedule) }
          attr_accessor :schedule

          sig { returns(Onebusaway::Models::TripsForRouteListResponse::Data::List::Status) }
          ...
          class Schedule < Onebusaway::BaseModel
            ...
            sig do
              returns(T::Array[Onebusaway::Models::TripsForRouteListResponse::Data::List::Schedule::StopTime])
            end
            ...
            sig do
              params(
                ...
                stop_times: T::Array[Onebusaway::Models::TripsForRouteListResponse::Data::List::Schedule::StopTime],
                time_zone: String,
                frequency: T.nilable(String)
              ).void
            end
          ...
          class Status < Onebusaway::BaseModel
            ...
            sig do
              returns(T.nilable(Onebusaway::Models::TripsForRouteListResponse::Data::List::Status::LastKnownLocation))
            end
            attr_reader :last_known_location

            sig do
              params(
                last_known_location: Onebusaway::Models::TripsForRouteListResponse::Data::List::Status::LastKnownLocation
              ).void
            end
            ...
            sig do
              returns(T.nilable(Onebusaway::Models::TripsForRouteListResponse::Data::List::Status::Position))
            end
            attr_reader :position

            sig do
              params(position: Onebusaway::Models::TripsForRouteListResponse::Data::List::Status::Position).void
            end
            ...
            sig do
              params(
                ...
                orientation: Float,
                position: Onebusaway::Models::TripsForRouteListResponse::Data::List::Status::Position,
