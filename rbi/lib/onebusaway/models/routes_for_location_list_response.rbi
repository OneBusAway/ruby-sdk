...
module Onebusaway
  module Models
    class RoutesForLocationListResponse < Onebusaway::Models::ResponseWrapper
      sig { returns(Onebusaway::Models::RoutesForLocationListResponse::Data) }
      attr_accessor :data

      sig { params(data: Onebusaway::Models::RoutesForLocationListResponse::Data).void }
      def initialize(data:)
      end

      sig { override.returns({data: Onebusaway::Models::RoutesForLocationListResponse::Data}) }
      def to_hash
      end
      ...
      class Data < Onebusaway::BaseModel
        ...
        sig { returns(T::Array[Onebusaway::Models::RoutesForLocationListResponse::Data::List]) }
        attr_accessor :list
        ...
        sig do
          params(
            ...
            list: T::Array[Onebusaway::Models::RoutesForLocationListResponse::Data::List],
