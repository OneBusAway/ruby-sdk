...
module Onebusaway
  module Models
    class RoutesForAgencyListResponse < Onebusaway::Models::ResponseWrapper
      sig { returns(Onebusaway::Models::RoutesForAgencyListResponse::Data) }
      attr_accessor :data

      sig { params(data: Onebusaway::Models::RoutesForAgencyListResponse::Data).void }
      def initialize(data:)
      end

      sig { override.returns({data: Onebusaway::Models::RoutesForAgencyListResponse::Data}) }
      def to_hash
      end
      ...
      class Data < Onebusaway::BaseModel
        ...
        sig { returns(T::Array[Onebusaway::Models::RoutesForAgencyListResponse::Data::List]) }
        attr_accessor :list
        ...
        sig do
          params(
            ...
            list: T::Array[Onebusaway::Models::RoutesForAgencyListResponse::Data::List],
