...
module Onebusaway
  module Models
    class BlockRetrieveResponse < Onebusaway::Models::ResponseWrapper
      sig { returns(Onebusaway::Models::BlockRetrieveResponse::Data) }
      attr_accessor :data

      sig { params(data: Onebusaway::Models::BlockRetrieveResponse::Data).void }
      def initialize(data:)
      end

      sig { override.returns({data: Onebusaway::Models::BlockRetrieveResponse::Data}) }
      def to_hash
      end

      class Data < Onebusaway::BaseModel
        sig { returns(Onebusaway::Models::BlockRetrieveResponse::Data::Entry) }
        attr_accessor :entry
        ...
        class Entry < Onebusaway::BaseModel
          ...
          sig { returns(T::Array[Onebusaway::Models::BlockRetrieveResponse::Data::Entry::Configuration]) }
          attr_accessor :configurations

          sig do
            params(
              id: String,
              configurations: T::Array[Onebusaway::Models::BlockRetrieveResponse::Data::Entry::Configuration]
            ).void
          end
          ...
          class Configuration < Onebusaway::BaseModel
            ...
            sig do
              returns(T::Array[Onebusaway::Models::BlockRetrieveResponse::Data::Entry::Configuration::Trip])
            end
            attr_accessor :trips
            ...
            sig do
              params(
                ...
                trips: T::Array[Onebusaway::Models::BlockRetrieveResponse::Data::Entry::Configuration::Trip],
            ...
            class Trip < Onebusaway::BaseModel
              ...
              sig do
                returns(T::Array[Onebusaway::Models::BlockRetrieveResponse::Data::Entry::Configuration::Trip::BlockStopTime])
              end
              ...
              sig do
                params(
                  ...
                  block_stop_times: T::Array[Onebusaway::Models::BlockRetrieveResponse::Data::Entry::Configuration::Trip::BlockStopTime],
              ...
              class BlockStopTime < Onebusaway::BaseModel
                ...
                sig do
                  returns(Onebusaway::Models::BlockRetrieveResponse::Data::Entry::Configuration::Trip::BlockStopTime::StopTime)
                end
