...
module Onebusaway
  module Models
    class TripRetrieveResponse < Onebusaway::Models::ResponseWrapper
      sig { returns(Onebusaway::Models::TripRetrieveResponse::Data) }
      attr_accessor :data

      sig { params(data: Onebusaway::Models::TripRetrieveResponse::Data).void }
      def initialize(data:)
      end

      sig { override.returns({data: Onebusaway::Models::TripRetrieveResponse::Data}) }
      def to_hash
      end

      class Data < Onebusaway::BaseModel
        sig { returns(Onebusaway::Models::TripRetrieveResponse::Data::Entry) }
        attr_accessor :entry
