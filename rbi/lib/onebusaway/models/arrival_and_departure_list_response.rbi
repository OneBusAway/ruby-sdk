...
module Onebusaway
  module Models
    class ArrivalAndDepartureListResponse < Onebusaway::Models::ResponseWrapper
      sig { returns(Onebusaway::Models::ArrivalAndDepartureListResponse::Data) }
      attr_accessor :data

      sig { params(data: Onebusaway::Models::ArrivalAndDepartureListResponse::Data).void }
      def initialize(data:)
      end

      sig { override.returns({data: Onebusaway::Models::ArrivalAndDepartureListResponse::Data}) }
      def to_hash
      end

      class Data < Onebusaway::BaseModel
        sig { returns(Onebusaway::Models::ArrivalAndDepartureListResponse::Data::Entry) }
        attr_accessor :entry
        ...
        class Entry < Onebusaway::BaseModel
          sig do
            returns(T::Array[Onebusaway::Models::ArrivalAndDepartureListResponse::Data::Entry::ArrivalsAndDeparture])
          end
          attr_accessor :arrivals_and_departures

          sig do
            params(
              arrivals_and_departures: T::Array[Onebusaway::Models::ArrivalAndDepartureListResponse::Data::Entry::ArrivalsAndDeparture]
            ).void
          end
          ...
          sig do
            override.returns({arrivals_and_departures: T::Array[Onebusaway::Models::ArrivalAndDepartureListResponse::Data::Entry::ArrivalsAndDeparture]})
          end
          def to_hash
          end
          ...
          class ArrivalsAndDeparture < Onebusaway::BaseModel
            ...
            sig do
              returns(T.nilable(Onebusaway::Models::ArrivalAndDepartureListResponse::Data::Entry::ArrivalsAndDeparture::TripStatus))
            end
            attr_reader :trip_status

            sig do
              params(
                trip_status: Onebusaway::Models::ArrivalAndDepartureListResponse::Data::Entry::ArrivalsAndDeparture::TripStatus
              ).void
            end
            ...
            class TripStatus < Onebusaway::BaseModel
              ...
              sig do
                returns(T.nilable(Onebusaway::Models::ArrivalAndDepartureListResponse::Data::Entry::ArrivalsAndDeparture::TripStatus::LastKnownLocation))
              end
              attr_reader :last_known_location

              sig do
                params(
                  last_known_location: Onebusaway::Models::ArrivalAndDepartureListResponse::Data::Entry::ArrivalsAndDeparture::TripStatus::LastKnownLocation
                ).void
              end
              ...
              sig do
                returns(T.nilable(Onebusaway::Models::ArrivalAndDepartureListResponse::Data::Entry::ArrivalsAndDeparture::TripStatus::Position))
              end
              attr_reader :position

              sig do
                params(
                  position: Onebusaway::Models::ArrivalAndDepartureListResponse::Data::Entry::ArrivalsAndDeparture::TripStatus::Position
                ).void
              end
