...
module Onebusaway
  module Models
    class ArrivalAndDepartureRetrieveResponse < Onebusaway::Models::ResponseWrapper
      sig { returns(Onebusaway::Models::ArrivalAndDepartureRetrieveResponse::Data) }
      attr_accessor :data

      sig { params(data: Onebusaway::Models::ArrivalAndDepartureRetrieveResponse::Data).void }
      def initialize(data:)
      end

      sig { override.returns({data: Onebusaway::Models::ArrivalAndDepartureRetrieveResponse::Data}) }
      def to_hash
      end

      class Data < Onebusaway::BaseModel
        sig { returns(Onebusaway::Models::ArrivalAndDepartureRetrieveResponse::Data::Entry) }
        attr_accessor :entry
        ...
        class Entry < Onebusaway::BaseModel
          ...
          sig do
            returns(T.nilable(Onebusaway::Models::ArrivalAndDepartureRetrieveResponse::Data::Entry::TripStatus))
          end
          attr_reader :trip_status

          sig do
            params(trip_status: Onebusaway::Models::ArrivalAndDepartureRetrieveResponse::Data::Entry::TripStatus).void
          end
          ...
          sig do
            params(
              ...
              status: String,
              trip_status: Onebusaway::Models::ArrivalAndDepartureRetrieveResponse::Data::Entry::TripStatus
            ).void
          end
          def initialize(
            arrival_enabled:,
          ...
          class TripStatus < Onebusaway::BaseModel
            ...
            sig do
              returns(T.nilable(Onebusaway::Models::ArrivalAndDepartureRetrieveResponse::Data::Entry::TripStatus::LastKnownLocation))
            end
            attr_reader :last_known_location

            sig do
              params(
                last_known_location: Onebusaway::Models::ArrivalAndDepartureRetrieveResponse::Data::Entry::TripStatus::LastKnownLocation
              ).void
            end
            ...
            sig do
              returns(T.nilable(Onebusaway::Models::ArrivalAndDepartureRetrieveResponse::Data::Entry::TripStatus::Position))
            end
            attr_reader :position

            sig do
              params(
                position: Onebusaway::Models::ArrivalAndDepartureRetrieveResponse::Data::Entry::TripStatus::Position
              ).void
            end
