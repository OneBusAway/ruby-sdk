...
module Onebusaway
  module Models
    class SearchForStopListResponse < Onebusaway::Models::ResponseWrapper
      sig { returns(T.nilable(Onebusaway::Models::SearchForStopListResponse::Data)) }
      attr_reader :data

      sig { params(data: Onebusaway::Models::SearchForStopListResponse::Data).void }
      attr_writer :data
      ...
      sig { override.returns({data: Onebusaway::Models::SearchForStopListResponse::Data}) }
      def to_hash
      end
      ...
      class Data < Onebusaway::BaseModel
        ...
        sig { returns(T::Array[Onebusaway::Models::SearchForStopListResponse::Data::List]) }
        attr_accessor :list
        ...
        sig do
          params(
            ...
            list: T::Array[Onebusaway::Models::SearchForStopListResponse::Data::List],
