...
module Onebusaway
  module Models
    class RouteRetrieveResponse < Onebusaway::Models::ResponseWrapper
      sig { returns(Onebusaway::Models::RouteRetrieveResponse::Data) }
      attr_accessor :data

      sig { params(data: Onebusaway::Models::RouteRetrieveResponse::Data).void }
      def initialize(data:)
      end

      sig { override.returns({data: Onebusaway::Models::RouteRetrieveResponse::Data}) }
      def to_hash
      end

      class Data < Onebusaway::BaseModel
        sig { returns(Onebusaway::Models::RouteRetrieveResponse::Data::Entry) }
        attr_accessor :entry
