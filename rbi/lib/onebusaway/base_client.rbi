...
module Onebusaway
  class BaseClient
    ...
    RequestShape = T.type_alias do
      {
        ...
        page: T.nilable(T::Class[Onebusaway::BaseModel]),
        model: T.nilable(Onebusaway::Converter::Input),
        options: T.nilable(T.any(Onebusaway::RequestOptions, T::Hash[Symbol, T.anything]))
      }
    end
    ...
    sig { params(req: Onebusaway::BaseClient::RequestShape).void }
    ...
    sig do
      params(
        req: Onebusaway::BaseClient::RequestShape,
        opts: T::Hash[Symbol, T.anything]
      ).returns(Onebusaway::BaseClient::NormalizedRequestShape)
    end
    ...
    sig do
      params(
        request: Onebusaway::BaseClient::NormalizedRequestShape,
        status: Integer,
    ...
    sig { params(req: Onebusaway::BaseClient::RequestShape, response: NilClass).returns(T.anything) }
