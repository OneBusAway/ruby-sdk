...
module Onebusaway
  module Converter
    ...
    Input = T.type_alias { T.any(Onebusaway::Converter, T::Class[T.anything]) }
        ...
        spec: T.any(
          {
            ...
            enum: T.nilable(T.proc.returns(Onebusaway::Converter::Input)),
            union: T.nilable(T.proc.returns(Onebusaway::Converter::Input))
          },
          T.proc.returns(Onebusaway::Converter::Input),
          Onebusaway::Converter::Input
        )
    ...
    sig { params(target: Onebusaway::Converter::Input, value: T.anything).returns(T.anything) }
  ...
  class Union
    ...
    sig { params(value: T.anything).returns(T.nilable(Onebusaway::Converter::Input)) }
  ...
  class ArrayOf
    ...
    sig { returns(Onebusaway::Converter::Input) }
  ...
  class BaseModel
    ...
    sig do
      returns(
        T::Hash[Symbol,
                T.all(
                  Onebusaway::BaseModel::KnownFieldShape,
                  {type_fn: T.proc.returns(Onebusaway::Converter::Input)}
                )]
      )
    end
    ...
    sig do
      returns(
        T::Hash[Symbol,
                T.all(Onebusaway::BaseModel::KnownFieldShape, {type: Onebusaway::Converter::Input})]
      )
    end
    def self.fields
    end
