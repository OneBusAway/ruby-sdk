...
module Onebusaway
  module Util
    ...
    sig { params(url: T.any(URI::Generic, String)).returns(Onebusaway::Util::ParsedUriShape) }
    def self.parse_uri(url)
    end

    sig { params(parsed: Onebusaway::Util::ParsedUriShape).returns(URI::Generic) }
    def self.unparse_uri(parsed)
    end

    sig do
      params(
        lhs: Onebusaway::Util::ParsedUriShape,
        rhs: Onebusaway::Util::ParsedUriShape
      ).returns(URI::Generic)
    end
