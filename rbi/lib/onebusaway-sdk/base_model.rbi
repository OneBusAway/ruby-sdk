...
module OnebusawaySDK
  ...
  module Converter
    ...
    # @api private
    sig { overridable.params(value: T.anything, state: OnebusawaySDK::Converter::State).returns(T.anything) }
    ...
    class << self
      ...
      sig do
        params(
          target: OnebusawaySDK::Converter::Input,
          value: T.anything,
          state: OnebusawaySDK::Converter::State
        )
          .returns(T.anything)
      end
      def self.coerce(
  ...
  class Unknown
    ...
    class << self
      # @api private
      sig(:final) do
        override.params(value: T.anything, state: OnebusawaySDK::Converter::State).returns(T.anything)
      end
      def coerce(value, state:)
      end
  ...
  class BooleanModel
    ...
    class << self
      ...
      sig(:final) do
        override
          .params(value: T.any(T::Boolean, T.anything), state: OnebusawaySDK::Converter::State)
  ...
  module Enum
    ...
    sig do
      override
        .params(value: T.any(String, Symbol, T.anything), state: OnebusawaySDK::Converter::State)
  ...
  module Union
    ...
    sig { returns(T::Array[[T.nilable(Symbol), T.proc.returns(OnebusawaySDK::Converter::Input)]]) }
    ...
    sig do
      params(
        key: T.any(Symbol, OnebusawaySDK::Util::AnyHash, T.proc.returns(T.anything), T.anything),
        spec: T.any(OnebusawaySDK::Util::AnyHash, T.proc.returns(T.anything), T.anything)
      )
        .void
    end
    ...
    # @api private
    sig { override.params(value: T.anything, state: OnebusawaySDK::Converter::State).returns(T.anything) }
    def coerce(value, state:)
    end
  ...
  class ArrayOf
    ...
    sig(:final) do
      params(
        ...
        spec: OnebusawaySDK::Util::AnyHash
      )
    ...
    sig(:final) do
      override
        .params(value: T.any(T::Enumerable[T.anything], T.anything), state: OnebusawaySDK::Converter::State)
      ...
      override
        .params(value: T.any(
          ...
          T.anything
                ...
                state: OnebusawaySDK::Converter::State)
        .returns(T.any(OnebusawaySDK::Util::AnyHash, T.anything))
    end
    def coerce(value, state:)
    end
  ...
  class BaseModel
    ...
    sig { overridable.returns(OnebusawaySDK::Util::AnyHash) }
    def to_h
    end
    ...
    sig { params(keys: T.nilable(T::Array[Symbol])).returns(OnebusawaySDK::Util::AnyHash) }
