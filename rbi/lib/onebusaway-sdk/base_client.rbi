...
module OnebusawaySDK
  class BaseClient
    ...
    sig do
      params(request: OnebusawaySDK::BaseClient::RequestInputShape, status: Integer, location_header: String)
        .returns(OnebusawaySDK::BaseClient::RequestInputShape)
    end
    ...
    sig do
      params(req: OnebusawaySDK::BaseClient::RequestComponentsShape, response: NilClass).returns(T.anything)
    end
