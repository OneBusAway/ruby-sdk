...
module OnebusawaySDK
  module Models
    class RouteIDsForAgencyListResponse < OnebusawaySDK::Models::ResponseWrapper
      ...
      sig do
        params(_: T.any(OnebusawaySDK::Models::RouteIDsForAgencyListResponse::Data, OnebusawaySDK::Util::AnyHash))
          .returns(T.any(OnebusawaySDK::Models::RouteIDsForAgencyListResponse::Data, OnebusawaySDK::Util::AnyHash))
      end
      def data=(_)
      end
      ...
      sig do
        params(
          data: T.any(OnebusawaySDK::Models::RouteIDsForAgencyListResponse::Data, OnebusawaySDK::Util::AnyHash)
        )
