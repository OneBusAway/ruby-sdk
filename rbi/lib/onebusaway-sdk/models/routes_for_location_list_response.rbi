...
module OnebusawaySDK
  module Models
    class RoutesForLocationListResponse < OnebusawaySDK::Models::ResponseWrapper
      ...
      sig do
        params(_: T.any(OnebusawaySDK::Models::RoutesForLocationListResponse::Data, OnebusawaySDK::Util::AnyHash))
          .returns(T.any(OnebusawaySDK::Models::RoutesForLocationListResponse::Data, OnebusawaySDK::Util::AnyHash))
      end
      def data=(_)
      end
