...
module OnebusawaySDK
  RequestOpts = T.type_alias { T.any(OnebusawaySDK::RequestOptions, OnebusawaySDK::Internal::AnyHash) }
  ...
  class RequestOptions < OnebusawaySDK::Internal::Type::BaseModel
    ...
    sig { params(values: OnebusawaySDK::Internal::AnyHash).returns(T.attached_class) }
