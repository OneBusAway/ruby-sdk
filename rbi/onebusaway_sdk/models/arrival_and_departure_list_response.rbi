  ...
  module Models
    class ArrivalAndDepartureListResponse < OnebusawaySDK::Models::ResponseWrapper
      ...
      sig do
        params(
          data:
            OnebusawaySDK::Models::ArrivalAndDepartureListResponse::Data::OrHash
        ).void
      end
      attr_writer :data
      ...
      class Data < OnebusawaySDK::Internal::Type::BaseModel
        ...
        sig do
          params(
            entry:
              OnebusawaySDK::Models::ArrivalAndDepartureListResponse::Data::Entry::OrHash
          ).void
        end
        attr_writer :entry
        ...
        class Entry < OnebusawaySDK::Internal::Type::BaseModel
          ...
          sig do
            params(
              arrivals_and_departures:
                T::Array[
                  OnebusawaySDK::Models::ArrivalAndDepartureListResponse::Data::Entry::ArrivalsAndDeparture::OrHash
                ]
            ).returns(T.attached_class)
          end
          ...
          class ArrivalsAndDeparture < OnebusawaySDK::Internal::Type::BaseModel
            ...
            sig do
              params(
                trip_status:
                  OnebusawaySDK::Models::ArrivalAndDepartureListResponse::Data::Entry::ArrivalsAndDeparture::TripStatus::OrHash
              ).void
            end
            ...
            class TripStatus < OnebusawaySDK::Internal::Type::BaseModel
              ...
              sig do
                params(
                  position:
                    OnebusawaySDK::Models::ArrivalAndDepartureListResponse::Data::Entry::ArrivalsAndDeparture::TripStatus::Position::OrHash
                ).void
              end
