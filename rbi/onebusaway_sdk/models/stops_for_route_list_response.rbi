  ...
  module Models
    class StopsForRouteListResponse < OnebusawaySDK::Models::ResponseWrapper
      ...
      class Data < OnebusawaySDK::Internal::Type::BaseModel
        ...
        sig do
          returns(OnebusawaySDK::Models::StopsForRouteListResponse::Data::Data)
        end
        attr_reader :data
        ...
        sig do
          params(
            data:
              OnebusawaySDK::Models::StopsForRouteListResponse::Data::Data::OrHash
          ).void
        end
        attr_writer :data
        ...
        sig do
          override.returns(
            {
              data: OnebusawaySDK::Models::StopsForRouteListResponse::Data::Data
            }
          )
        end
        def to_hash
        ...
        class Data < OnebusawaySDK::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                OnebusawaySDK::Models::StopsForRouteListResponse::Data::Data,
                OnebusawaySDK::Internal::AnyHash
              )
            end
          ...
          sig do
            returns(
              OnebusawaySDK::Models::StopsForRouteListResponse::Data::Data::Entry
            )
          end
          attr_reader :entry
          ...
          sig do
            params(
              entry:
                OnebusawaySDK::Models::StopsForRouteListResponse::Data::Data::Entry::OrHash
            ).void
          end
          attr_writer :entry
          ...
          class Entry < OnebusawaySDK::Internal::Type::BaseModel
            ...
            sig do
              returns(
                T.nilable(
                  T::Array[
                    OnebusawaySDK::Models::StopsForRouteListResponse::Data::Data::Entry::Polyline
                  ]
                )
              )
            end
            ...
            sig do
              params(
                polylines:
                  T::Array[
                    OnebusawaySDK::Models::StopsForRouteListResponse::Data::Data::Entry::Polyline::OrHash
                  ]
              ).void
            end
            ...
            sig do
              returns(
                T.nilable(
                  T::Array[
                    OnebusawaySDK::Models::StopsForRouteListResponse::Data::Data::Entry::StopGrouping
                  ]
                )
              )
            end
            ...
            sig do
              params(
                stop_groupings:
                  T::Array[
                    OnebusawaySDK::Models::StopsForRouteListResponse::Data::Data::Entry::StopGrouping::OrHash
                  ]
              ).void
            end
            ...
            class StopGrouping < OnebusawaySDK::Internal::Type::BaseModel
              ...
              sig do
                params(
                  name:
                    OnebusawaySDK::Models::StopsForRouteListResponse::Data::Data::Entry::StopGrouping::Name::OrHash
                ).void
              end
              attr_writer :name
              ...
              sig do
                returns(
                  T.nilable(
                    T::Array[
                      OnebusawaySDK::Models::StopsForRouteListResponse::Data::Data::Entry::StopGrouping::Polyline
                    ]
                  )
                )
              end
              ...
              sig do
                params(
                  polylines:
                    T::Array[
                      OnebusawaySDK::Models::StopsForRouteListResponse::Data::Data::Entry::StopGrouping::Polyline::OrHash
                    ]
                ).void
              end
              attr_writer :polylines
