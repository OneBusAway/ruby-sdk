...
module OnebusawaySDK
  module Models
    class ArrivalsAndDeparturesForLocationListResponse < OnebusawaySDK::Models::ResponseWrapper
      ...
      sig do
        returns(
          OnebusawaySDK::Models::ArrivalsAndDeparturesForLocationListResponse::Data
        )
      end
      attr_reader :data
      ...
      sig do
        params(
          data:
            OnebusawaySDK::Models::ArrivalsAndDeparturesForLocationListResponse::Data::OrHash
        ).void
      end
      attr_writer :data
      ...
      class Data < OnebusawaySDK::Internal::Type::BaseModel
        ...
        sig do
          returns(
            OnebusawaySDK::Models::ArrivalsAndDeparturesForLocationListResponse::Data::Entry
          )
        end
        attr_reader :entry
        ...
        sig do
          params(
            entry:
              OnebusawaySDK::Models::ArrivalsAndDeparturesForLocationListResponse::Data::Entry::OrHash
          ).void
        end
        attr_writer :entry
        ...
        class Entry < OnebusawaySDK::Internal::Type::BaseModel
          ...
          sig do
            params(
              arrivals_and_departures:
                T::Array[
                  OnebusawaySDK::Models::ArrivalsAndDeparturesForLocationListResponse::Data::Entry::ArrivalsAndDeparture::OrHash
                ],
              limit_exceeded: T::Boolean,
              nearby_stop_ids:
                T::Array[
                  OnebusawaySDK::Models::ArrivalsAndDeparturesForLocationListResponse::Data::Entry::NearbyStopID::OrHash
                ],
          ...
          class ArrivalsAndDeparture < OnebusawaySDK::Internal::Type::BaseModel
            ...
            sig do
              params(
                trip_status:
                  OnebusawaySDK::Models::ArrivalsAndDeparturesForLocationListResponse::Data::Entry::ArrivalsAndDeparture::TripStatus::OrHash
              ).void
            end
            ...
            class TripStatus < OnebusawaySDK::Internal::Type::BaseModel
              ...
              sig do
                params(
                  position:
                    OnebusawaySDK::Models::ArrivalsAndDeparturesForLocationListResponse::Data::Entry::ArrivalsAndDeparture::TripStatus::Position::OrHash
                ).void
              end
          ...
          class NearbyStopID < OnebusawaySDK::Internal::Type::BaseModel
            ...
            sig { returns(T.nilable(Float)) }
            attr_reader :distance_from_query

            sig { params(distance_from_query: Float).void }
            attr_writer :distance_from_query
            ...
            sig do
              params(distance_from_query: Float, stop_id: String).returns(
                T.attached_class
              )
            end
            def self.new(distance_from_query: nil, stop_id: nil)
            end

            sig do
              override.returns({ distance_from_query: Float, stop_id: String })
            end
            def to_hash
            end
          end
