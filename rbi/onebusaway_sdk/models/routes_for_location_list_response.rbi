  ...
  module Models
    class RoutesForLocationListResponse < OnebusawaySDK::Models::ResponseWrapper
      ...
      sig do
        params(
          data:
            OnebusawaySDK::Models::RoutesForLocationListResponse::Data::OrHash
        ).void
      end
      attr_writer :data
      ...
      class Data < OnebusawaySDK::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              OnebusawaySDK::Models::RoutesForLocationListResponse::Data,
              OnebusawaySDK::Internal::AnyHash
            )
          end
        ...
        sig do
          params(
            list:
              T::Array[
                OnebusawaySDK::Models::RoutesForLocationListResponse::Data::List::OrHash
              ],
        ...
        def self.new(list:, out_of_range:, references:, limit_exceeded: nil)
        end
