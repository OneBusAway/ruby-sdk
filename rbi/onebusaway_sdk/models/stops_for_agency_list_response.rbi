...
module OnebusawaySDK
  module Models
    class StopsForAgencyListResponse < OnebusawaySDK::Models::ResponseWrapper
      ...
      sig { returns(OnebusawaySDK::Models::StopsForAgencyListResponse::Data) }
      attr_reader :data

      sig do
        params(
          data: OnebusawaySDK::Models::StopsForAgencyListResponse::Data::OrHash
        ).void
      end
      attr_writer :data
      ...
      sig do
        override.returns(
          { data: OnebusawaySDK::Models::StopsForAgencyListResponse::Data }
        )
      end
      def to_hash
      end
      ...
      class Data < OnebusawaySDK::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              OnebusawaySDK::Models::StopsForAgencyListResponse::Data,
              OnebusawaySDK::Internal::AnyHash
            )
          end
        ...
        sig do
          returns(
            T::Array[
              OnebusawaySDK::Models::StopsForAgencyListResponse::Data::List
            ]
          )
        end
        attr_accessor :list
        ...
        sig do
          params(
            ...
            list:
              T::Array[
                OnebusawaySDK::Models::StopsForAgencyListResponse::Data::List::OrHash
              ],
