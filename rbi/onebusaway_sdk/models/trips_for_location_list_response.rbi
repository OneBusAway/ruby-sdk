  ...
  module Models
    class TripsForLocationListResponse < OnebusawaySDK::Models::ResponseWrapper
      ...
      sig do
        params(
          data:
            OnebusawaySDK::Models::TripsForLocationListResponse::Data::OrHash
        ).void
      end
      attr_writer :data
        ...
        class List < OnebusawaySDK::Internal::Type::BaseModel
          ...
          class Schedule < OnebusawaySDK::Internal::Type::BaseModel
            ...
            sig do
              params(
                ...
                stop_times:
                  T::Array[
                    OnebusawaySDK::Models::TripsForLocationListResponse::Data::List::Schedule::StopTime::OrHash
                  ],
                time_zone: String,
                frequency: T.nilable(String)
              ).returns(T.attached_class)
          ...
          class Status < OnebusawaySDK::Internal::Type::BaseModel
            ...
            sig do
              params(
                position:
                  OnebusawaySDK::Models::TripsForLocationListResponse::Data::List::Status::Position::OrHash
              ).void
            end
