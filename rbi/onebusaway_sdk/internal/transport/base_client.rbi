  ...
  module Internal
    module Transport
      ...
      class BaseClient
        ...
        class << self
          # @api private
          sig { params(req: OnebusawaySDK::Internal::Transport::BaseClient::RequestComponentsShape).void }
          ...
          sig do
            params(
              request: OnebusawaySDK::Internal::Transport::BaseClient::RequestInputShape,
              status: Integer,
